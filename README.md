...
Messaging is the primary way to use agents. Open a DM or @-mention an agent in a
channel and it dispatches into its own worktree, thinking, tool calls, and
output streaming back in real time.

- DMs and group channels with threads and @-mentions
...
[Chat with an agent →](https://usectrl.dev/manual/guides/chat-with-agent/) · [Channels and DMs →](https://usectrl.dev/manual/guides/channels/)
...
- 76 typed tools over MCP / JSON-RPC for any client
