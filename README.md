...
forui + Material 3, dio (GitHub, Linear & Google Calendar), tree-sitter, on-device
Whisper transcription with speaker diarization, and an MCP / JSON-RPC tool server.
