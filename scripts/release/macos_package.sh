...
# 1b. Legal notices, INSIDE the bundle so they travel with a copied .app.
#
# Must land before the signing pass below: adding a file to a bundle after it is
# signed invalidates the signature, and notarization would reject it.
