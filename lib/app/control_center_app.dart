...
class ControlCenterApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Same, for the PR-detail repo scope: the route's `:owner/:repo` drive which
    // repo the (number-keyed) PR-review providers resolve against, so a PR→PR
    // link hop re-scopes correctly instead of leaving a stale `initState` pin.
    ref.watch(prDetailRouteScopeSyncProvider);
