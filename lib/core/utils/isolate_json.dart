...
/// are handed to [compute]. The 50 KB threshold mirrors the one Flutter and Dio
/// use for the same trade-off.
library;
...
Future<Map<String, dynamic>?> decodeJsonMapInIsolate(String source) {
  ...
  return compute(_decodeJsonMap, source);
}
...
Future<List<Map<String, dynamic>>> decodeJsonListInIsolate(String source) {
  ...
  return compute(_decodeJsonList, source);
}
