...
class SecureStore {
  ...
  ///
  /// flutter_secure_storage is a battle-tested keychain plugin that works for
  /// any locally-signed build — including open-source contributors with no
  /// specific Apple team — while nativeapi keeps backing the non-secret
  /// [AppPreferences].
