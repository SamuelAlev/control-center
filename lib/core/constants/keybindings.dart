...
enum KeybindingCategory {
  ...
  /// Create new entities (agents, repos, channels).
  creation,

  /// Edit or modify entities.
  editing,

  /// Delete or remove entities.
  deletion,
...
abstract final class KeybindingRegistry {
  ...
  /// Global navigation shortcuts (⌘1–⌘8).
  ...
  static final List<Keybinding> system = [
    ...
    // only takes over when no field is being edited.
    Keybinding.key(
      id: 'sys.undo',
  ...
  /// Channel screen shortcuts (new channel, navigation, send). The `when`
  /// clauses use a regex so they fire on both the channel list (`/channels`)
  /// and a selected channel (`/channels/<id>`).
  static final List<Keybinding> messaging = [
    ...
    Keybinding.key(
      ...
      scope: '/channels',
      key: LogicalKeyboardKey.keyK,
      when: r'route =~ /^\/channels/ && !textInputFocus',
    ),
    Keybinding.key(
      id: 'msg.next-channel',
      category: KeybindingCategory.navigation,
  ...
  /// Peer review shortcuts (approve, request changes).
...
extension KeybindingL10n on Keybinding {
  ...
  String resolvedLabel(AppLocalizations l10n) {
    return switch (id) {
      'nav.inbox' => l10n.keybindingGoToInbox,
      ...
      'nav.meetings' => l10n.keybindingGoToMeetings,
      ...
      'pr.list-focus-search' ||
      'pr.list-focus-search-alt' => l10n.keybindingFocusSearch,
      ...
      'pr.detail-show-file-tree' => l10n.keybindingShowFileList,
      'pr.detail-close-tab' => l10n.ideCloseTab,
      'msg.new-channel' => l10n.keybindingNewChannel,
  ...
  String resolvedDescription(AppLocalizations l10n) {
    return switch (id) {
      'nav.inbox' => l10n.keybindingNavigateToTheInboxDescription,
      'nav.tickets' => l10n.keybindingNavigateToTheTicketsBoardDescription,
      'nav.pull-requests' =>
        l10n.keybindingNavigateToThePullRequestListDescription,
      ...
      'nav.meetings' => l10n.keybindingNavigateToTheMeetingsDescription,
      ...
      'pr.list-merge' => l10n.keybindingMergeTheFocusedPullRequestDescription,
      'pr.list-peek' =>
      ...
      'pr.user-focus-search' || 'pr.user-focus-search-alt' =>
        l10n.keybindingFocusThePullRequestSearchFieldDescription,
      'pr.detail-tab-conv' =>
        l10n.keybindingSwitchToTheConversationTabDescription,
      'pr.detail-tab-files' =>
        l10n.keybindingSwitchToTheFilesChangedTabDescription,
      ...
      'pr.detail-show-file-tree' => l10n.keybindingShowFileListDescription,
      'pr.detail-close-tab' => l10n.ideCloseTab,
      'msg.new-channel' => l10n.keybindingCreateANewChannelDescription,
      ...
      'msg.delete-channel' =>
        l10n.keybindingDeleteTheSelectedChannelDescription,
      ...
      'settings.agents-delete' =>
        l10n.keybindingDeleteTheSelectedAgentDescription,
