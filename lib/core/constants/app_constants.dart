...
/// Storage key for the preferred soundscape output device (libmpv device
/// name). Device-scoped: the id names this machine's hardware.
const String soundscapeOutputDeviceKey = 'soundscape_output_device';
