...
bool _errorReportingEnabled() {
  // Same scoped suite as [NativeKeyValueBackend] — this runs before the
  // provider container exists, so it dials the store directly.
  final prefs = Preferences.createWithScope(appPreferencesScope);
  if (prefs == null) {
    return true;
  }
  try {
