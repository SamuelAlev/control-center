...
/// A registration handle mirroring the desktop seam's (never fires here).
class DesktopUpdaterHandlerRegistration {
  /// An inert registration that owns nothing (mirrors the desktop seam).
  const DesktopUpdaterHandlerRegistration.inert();

  /// Always false off-desktop — nothing dispatches updater outcomes here.
  bool get isActive => false;

  /// Releases the (absent) handlers — a no-op off-desktop.
  void release() {}
}
