...
class AppTheme {
  ...
  /// Also restores accessible line-heights and enables the design system's
  /// global tabular figures ([CcTypography.numeralFeatures]), so the ambient
  /// `DefaultTextStyle` MaterialApp derives from `bodyMedium` carries `tnum`
  /// into every raw `TextStyle` that does not set its own `fontFeatures`.
