...
class AppTheme {
  ...
  /// Light.
  static ThemeData light({String appFontFamily = 'Manrope'}) => _withExtensions(
        _withFontFamily(
          _baseTheme(Brightness.light, DesignSystemTokens.light()),
          appFontFamily,
        ),
  ...
  /// Dark.
  static ThemeData dark({String appFontFamily = 'Manrope'}) => _withExtensions(
        _withFontFamily(
          _baseTheme(Brightness.dark, DesignSystemTokens.dark()),
          appFontFamily,
        ),
  ...
  static ThemeData _baseTheme(Brightness brightness, DesignSystemTokens tokens) {
