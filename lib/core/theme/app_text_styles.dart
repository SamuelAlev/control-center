...
abstract final class AppTextStyles {
  ...
  /// 11.5px monospace — code, JSON, identifiers. The only role here that names
  /// a monospace family, so the only one carrying tabular figures
  /// ([CcTypography.numeralFeatures]); the proportional roles above render
  /// their digits proportionally.
