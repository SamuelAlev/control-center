...
// NOTE: this is a PRESENTATION view-model, not a domain entity — it carries an
// `IconData` and a `VoidCallback`, so it can never live in a domain layer (and
// `cc_domain` could not hold it at all: the shared kernel is Flutter-free).
