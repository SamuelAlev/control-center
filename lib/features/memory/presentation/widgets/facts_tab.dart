      ...
      child: Column(
        children: [
          FTextField(
            ...
            hint: l10n.searchFactsHint,
            prefixBuilder: (context, style, _) => Padding(
              padding: const EdgeInsets.symmetric(horizontal: 8),
              child: Icon(
                LucideIcons.search,
                size: 16,
                color: tokens?.fgQuaternary ?? context.theme.colors.mutedForeground,
              ),
            ),
          ...
          Row(
            children: [
              ...
              FSwitch(
                ...
                onChange: (v) => setState(() => _showSuperseded = v),
              ),
              ...
              Row(
                children: [
                  ...
                  if (fact.isSuperseded) ...[
                    const SizedBox(width: AppSpacing.sm),
                    FTooltip(
                      tipBuilder: (_, _) => Text(l10n.supersededTooltip),
                      child: MemoryMetaChip(
