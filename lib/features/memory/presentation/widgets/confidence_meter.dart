  ...
  Widget build(BuildContext context) {
    ...
    final meter = Row(
      ...
      children: [
        ...
        Text(
          '${(clamped * 100).round()}%',
          style: (compact ? CcTypography.caption : CcTypography.body).copyWith(
            color: (tokens ?? DesignSystemTokens.light()).textTertiary,
    ...
    return CcTooltip(
      message: AppLocalizations.of(context).confidenceTooltip,
      child: meter,
    );
  }
}
