  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(LucideIcons.tag, size: 22, color: tokens.textPrimary),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(LucideIcons.tag, size: 20, color: tokens.textTertiary),
            const SizedBox(width: 8),
            Text(
              topic,
              style: Theme.of(context).textTheme.titleLarge?.copyWith(
    ...
    return Column(
      ...
      children: [
        ...
        if (policy.requiredRole != null)
          Row(
            children: [
              Icon(LucideIcons.user, size: 14, color: tokens.textTertiary),
        ...
        if (onToggle != null) ...[
          ...
          CcButton(
            ...
            size: CcButtonSize.sm,
            icon: policy.active ? LucideIcons.eyeOff : LucideIcons.eye,
