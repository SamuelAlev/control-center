  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _StatRow(icon: AppIcons.lightbulb, label: l10n.facts, value: factCount),
        _StatRow(
      ...
      children: [
          ...
          children: [
            ...
            if (fact.authoredByRole != null)
              Text(
                AppLocalizations.of(
                  context,
                ).authoredByLabel(fact.authoredByRole!.label),
        ...
        AppTimestamp(
          ...
          child: Text(
            AppLocalizations.of(
              context,
            ).createdLabel(_formatDate(fact.createdAt)),
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Flexible(
              child: MemoryMetaChip(label: policy.domain, icon: AppIcons.scale),
            ),
            if (!policy.active) ...[
              const SizedBox(width: 8),
          ...
          Row(
            children: [
              ...
              Text(
                AppLocalizations.of(
                  context,
                ).requiredRoleLabel(policy.requiredRole!.label),
                style: CcTypography.caption.copyWith(
                  color: tokens.textTertiary,
                ),
              ),
