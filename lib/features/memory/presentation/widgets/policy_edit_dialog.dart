        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              CcSelect<AgentRole?>(
                value: _requiredRole,
                label: l10n.requiredRoleOptional,
                options: [
                  CcSelectOption<AgentRole?>(
                    value: null,
                    label: l10n.noneAllRoles,
                  ),
                  for (final r in AgentRole.values)
                    CcSelectOption<AgentRole?>(value: r, label: r.label),
                ],
