...
class _MemoryScreenState extends ConsumerState<MemoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final tabs = [
      (
        label: l10n.memoryTabFacts,
        icon: AppIcons.notebookText,
        count: factCount,
      ),
      (label: l10n.memoryTabPolicies, icon: AppIcons.scale, count: policyCount),
      (label: l10n.memoryTabGraph, icon: AppIcons.workflow, count: null),
    ];
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (tabs[i].count != null && tabs[i].count! > 0) ...[
                          const SizedBox(width: AppSpacing.sm),
                          _TabCount(count: tabs[i].count!, selected: _tab == i),
                        ],
                      ],
                    ),
                  ),
