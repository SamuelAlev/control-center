...
class MeetingDetectionBanner extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      // The gap belongs BELOW the banner: the page header already supplies the
      // space above it, and the banner collapses to nothing when detection is
      // not prompting — so a trailing margin is the one that disappears with it.
