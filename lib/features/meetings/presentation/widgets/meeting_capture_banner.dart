      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: const Icon(AppIcons.audioLines, size: 22, color: Color(0xFF1F1F1F)),
          ),
          ...
          Wrap(
            ...
            children: [
              ...
              _Badge(icon: AppIcons.lock, label: l10n.meetingsCaptureOnDevice),
              _Badge(icon: AppIcons.crosshair, label: l10n.meetingsCaptureNoBot),
            ],
          ),
        ],
      ),
