...
///
/// Code styling (inline chips and fenced blocks) is layered on top of the
/// canonical [githubMarkdownStyleSheet] code fields so code renders identically
/// to PR descriptions, chat, and ticket surfaces, while the bespoke
/// mono-heading / accent-bullet treatment is preserved.
MarkdownStyleSheet _notesStyleSheet(BuildContext context) {
  final theme = Theme.of(context);
  final ds = context.ds;
  final canonical = githubMarkdownStyleSheet(context);
  ...
  return base.copyWith(
    ...
    // Canonical code styling so enhanced notes' code blocks match the rest of
    // the app. The inline chip background and fenced-block shell are drawn by
    // [InlineCodeBuilder] / [CodeBlockBuilder] (registered at the call site).
    code: canonical.code,
    codeblockDecoration: canonical.codeblockDecoration,
    codeblockPadding: canonical.codeblockPadding,
