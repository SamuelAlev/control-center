...
///
/// Read these (or `context.designSystem`) instead of forui's `context.theme
/// .colors` so meetings reads correctly in both themes and stays consistent
...
/// JetBrains-Mono style for the eyebrows, timestamps, counts, and pill labels
