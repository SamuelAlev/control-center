...
/// One avatar chip on a presence surface (the channel header's "who's here"
...
class PresenceAvatarChip extends ConsumerWidget {
  ...
  /// currently typing in this channel.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isTyping =
        channelId != null && participant.typingInChannelId == channelId;
    ...
    final avatar = participant.isAgent
        ...
        : CcAvatar(size: size, initials: avatarInitials(participant.displayName, maxLetters: 1));
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: following ? Border.all(color: t.accent, width: 1.5) : null,
          ),
          child: Stack(
