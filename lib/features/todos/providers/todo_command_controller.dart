...
Future<void> handleTodoSlashCommand({
  ...
  switch (sub) {
    ...
    case 'add':
      ...
      await repo.append(workspaceId, channelId, rest);
    ...
    case 'remove':
      if (rest.isEmpty) {
        ...
        await repo.clear(workspaceId, channelId);
      ...
      await repo.remove(workspaceId, channelId, item.id);
    ...
    case 'import':
      ...
      await repo.replaceAll(workspaceId, channelId, items);
