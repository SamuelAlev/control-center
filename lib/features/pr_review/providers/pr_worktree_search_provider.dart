...
/// Ephemeral UI state of the sidebar "search in files" panel, kept per channel
...
/// Per-channel memento for the search panel; see [WorktreeSearchUiState].
...
/// Server-side content search across a single PR channel's isolated CoW
