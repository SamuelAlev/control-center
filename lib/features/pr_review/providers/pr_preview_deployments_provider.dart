...
final prPreviewDeploymentsProvider = Provider.autoDispose
    .family<List<DeploymentPreview>, int>((ref, prNumber) {
      final statusesAsync = ref.watch(prCommitStatusesProvider(prNumber));
      final comments = ref.watch(prIssueCommentsProvider(prNumber)).value;
      ...
      final texts = <String>[
        if (pr != null && pr.body.isNotEmpty) pr.body,
