...
class PrInlineCommentsController extends Notifier<PrInlineCommentsState> {
  ...
  PrInlineCommentsState build() {
    // Both the repo and the repository come from the PR's own URL pin, never
    // from the active repo: a comment on PR #N must be posted to the repo #N
    // lives in, even mid-navigation or right after a workspace switch.
