...
class ReviewVerdictHeader extends StatelessWidget {
  ...
  /// True while no finalized summary exists yet — the verdict shown is
  /// axis-derived and reviewer consensus has not landed. Labeled honestly
