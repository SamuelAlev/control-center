                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Keyboard-first (PRD 19 §2): ⌘↵ approves, ⌘⇧↵ requests
                      // changes — the shortcuts fire from the review composer,
                      // and the buttons surface them inline so they're
...
Set<String> _activeWorkspaceRepoKeys(WidgetRef ref) {
  ...
  return repos
      .map(
        (r) => '${r.remoteOwner.toLowerCase()}/${r.remoteName.toLowerCase()}',
      )
      .toSet();
}
