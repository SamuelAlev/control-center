  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          if (isTeam)
            GitHubTeamAvatar(name: label, avatarUrl: avatarUrl ?? '', size: 18)
          else
            GitHubUserAvatar(
              login: label,
              avatarUrl: avatarUrl ?? '',
          ...
          GestureDetector(
            onTap: onRemove,
            child: Icon(AppIcons.x, size: 13, color: t.fgQuaternary),
          ),
        ],
      ),
    );
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              if (isTeam)
                GitHubTeamAvatar(name: label, avatarUrl: avatarUrl, size: 22)
              else
                GitHubUserAvatar(
                  login: login,
                  avatarUrl: avatarUrl,
