...
class _GifPickerBodyState extends State<_GifPickerBody> {
  ...
  Widget _buildNoKeyCard(FThemeData theme) {
    return Material(
      elevation: 16,
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.titleSmall?.copyWith(color: theme.colors.foreground),
            ),
  ...
  Widget _buildCard(FThemeData theme, MediaQueryData mediaQuery) {
    return Material(
      elevation: 16,
      borderRadius: BorderRadius.circular(12),
      color: theme.colors.background,
    ...
    if (_gifs.isEmpty) {
      return Center(
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyMedium?.copyWith(color: theme.colors.mutedForeground),
        ),
      );
    }
