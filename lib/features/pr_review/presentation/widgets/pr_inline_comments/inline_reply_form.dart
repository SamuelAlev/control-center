...
class _InboxViewState extends ConsumerState<_InboxView> {
  ...
  Widget build(BuildContext context) {
    ...
    final hasContent =
        topLevelCount > 0 || visible.isNotEmpty;
            ...
            Flexible(
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return _buildThreadRow(context, theme, t);
                },
              ),
            ),
        ],
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            FTooltip(
              tipBuilder: (_, _) => Text(t.resolved ? AppLocalizations.of(context).reopen : AppLocalizations.of(context).resolve),
              child: FButton.icon(
                onPress: () => widget.onToggleResolved(t.id),
                child: Icon(
                  t.resolved
