          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                FTooltip(
                  tipBuilder: (_, _) =>
                      Text(thread.resolved ? AppLocalizations.of(context).reopen : AppLocalizations.of(context).resolve),
                  child: FButton.icon(
          ...
          if (thread.isSuggestion && !thread.resolved) ...[
            ...
            Padding(
              ...
              child: Row(
                children: [
                  FButton(
                    onPress: () => widget.controller.acceptSuggestion(thread.id),
              ...
              Row(
                children: [
                  ...
                  if (_isSuggestionEntry && onEditStart != null) ...[
                    ...
                    FTooltip(
                      tipBuilder: (_, _) =>
                          Text(isEditing ? AppLocalizations.of(context).cancelEdit : AppLocalizations.of(context).editSuggestion),
                      child: FButton.icon(
                        onPress: () {
                          if (isEditing) {
                            onEditCancel?.call();
...
class _SyncBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (onRetry == null) {
      return FTooltip(
        tipBuilder: (_, _) => Text(error ?? label),
        child: pill,
      );
    }

    return FTooltip(
      tipBuilder: (_, _) => Text(error ?? AppLocalizations.of(context).clickToRetry),
      child: MouseRegion(
