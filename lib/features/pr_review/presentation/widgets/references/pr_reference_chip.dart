...
class PrReferenceChip extends ConsumerWidget {
  ...
  /// The chip's link, built in the vocabulary of the forge that actually hosts
  /// the referenced repo — GitLab puts merge requests under `/-/merge_requests/`
  /// and Bitbucket under `/pull-requests/`, so a hardcoded github.com path
  /// would be a dead link on two of the three.
  String _href(WidgetRef ref) => ref
      ...
      .pullRequest(reference.owner, reference.repo, reference.number);
...
class _LoadedContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final textStyle = CcTypography.body.copyWith(color: muted);
