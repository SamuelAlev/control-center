      ...
      builder: (context, child) {
        ...
        return Stack(
          ...
          children: [
            Opacity(
              opacity: 0,
              child: Text(widget.ageText, style: textStyle),
            ),
            Positioned(
...
class FlameTextPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = _upwardLayers; i >= 1; i--) {
      ...
      _glyphPainter(paint).paint(
        canvas,
        Offset(sidePad + sway, textY - p * flameHeight + bob),
      );
    }
    ...
    for (var i = _downwardLayers; i >= 1; i--) {
      ...
      _glyphPainter(paint).paint(
        canvas,
        Offset(sidePad + sway, textY + p * emberDepth + bob),
      );
    }
    ...
    _glyphPainter(Paint()..shader = shader)
