...
class _PrListRowState extends ConsumerState<PrListRow> {
  ...
  Widget build(BuildContext context) {
    ...
    final showCheckbox = !widget.browseOnly && (selecting || selected || _hovered);
        ...
        children: [
          Semantics(
            ...
            child: _RowTappable(
              ...
              hoverColor: tokens?.hover ?? colors.muted,
              selectedColor: tokens?.accentSoft ?? colors.primary.withAlpha(20),
              selected: selected,
...
class _SelectCheckbox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tokens = context.designSystem;
    final colors = context.theme.colors;
    final accent = tokens?.accent ?? colors.primary;
        ...
        child: Padding(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              height: 16,
              decoration: BoxDecoration(
                color: selected ? accent : (tokens?.panel ?? colors.card),
              ...
              child: selected
                  ? Icon(
                      LucideIcons.check,
                      size: 11,
                      color: tokens?.accentOn ?? colors.primaryForeground,
                    )
                  : null,
            ),
          ),
