...
class _PrSearchFieldState extends ConsumerState<PrSearchField> {
  ...
  void _refreshSuggestions() {
    final match = _partialAuthor.firstMatch(_controller.text.substring(0, _caret));
    if (match == null) {
      _removeOverlay();
      return;
    }
    ...
    return SizedBox(
      ...
      child: CompositedTransformTarget(
        ...
        child: FTextField(
          ...
          hint: l10n.searchPullRequestsHint,
          ...
          // clear button (driven by [clearable]) takes the slot instead.
