...
Future<void> confirmAndMergeReadyPrs(
  ...
  final confirmed = await showFDialog<bool>(
    ...
    builder: (ctx, style, animation) => FDialog(
      style: style,
      animation: animation,
      title: Text(l10n.mergeReadyConfirmTitle),
      body: Text(l10n.mergeReadyConfirmBody(ready.length)),
      actions: [
        FButton(
  ...
  messenger.showSnackBar(SnackBar(content: Text(l10n.mergedCountPrs(merged))));
}
...
class PrBatchBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final readyPairs = selectedPairs.where((p) {
      ...
      return classifyDecisionLanes(p.pr, awaitingMe: awaitingMe)
