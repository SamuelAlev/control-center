  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        if (displayReviewers.isEmpty)
          ...
          ...displayReviewers.map(
            (r) => _ReviewerRow(
              reviewer: r,
              pending:
                  editState?.pendingReviewers.contains(r.identity) ?? false,
        ...
        const SizedBox(height: 24),
        _SidebarHeader(icon: AppIcons.shieldCheck, label: l10n.checks),
        const SizedBox(height: 12),
...
class _SidebarHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Icon(icon, size: 14, color: tokens.textTertiary),
...
class _TeamGlyph extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Icon(AppIcons.users, size: 13, color: t.fgQuaternary),
    );
  }
}
