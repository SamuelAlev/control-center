...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(LucideIcons.userPlus, size: 16, color: ds.textPrimary),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              'HIRE PROPOSAL',
          ...
          GestureDetector(
            onTap: onClose,
            child: Icon(LucideIcons.x, size: 18, color: ds.textTertiary),
          ),
        ],
      ),
    );
...
class _StatusBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      case 'approved':
        bg = ds.textPrimary.withValues(alpha: 0.12);
        label = 'Approved · agent hired';
      case 'rejected':
        bg = ds.textErrorPrimary.withValues(alpha: 0.12);
    ...
    return Container(
      ...
      child: Text(
        ...
        style: Theme.of(
          context,
        ).textTheme.labelMedium?.copyWith(color: ds.textPrimary),
      ),
    );
  }
}
