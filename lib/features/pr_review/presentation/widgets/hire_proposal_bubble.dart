...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(AppIcons.userPlus, size: 16, color: ds.textPrimary),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              'HIRE PROPOSAL',
          ...
          GestureDetector(
            onTap: onClose,
            child: Icon(AppIcons.x, size: 18, color: ds.textTertiary),
          ),
        ],
      ),
    );
...
class _StatusBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        label,
        style: CcTypography.caption.copyWith(color: ds.textPrimary),
      ),
    );
  }
}
