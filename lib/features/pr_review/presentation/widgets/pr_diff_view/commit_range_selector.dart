...
class CommitRangeSelector extends ConsumerStatefulWidget {
  const CommitRangeSelector({super.key,
...
class _CommitRangeSelectorState extends ConsumerState<CommitRangeSelector> {
  ...
  Widget build(BuildContext context) {
    ...
    return CompositedTransformTarget(
      ...
      child: FTooltip(
        tipBuilder: (_, _) =>
            Text(AppLocalizations.of(context).scopeDiffToCommits),
        child: InkWell(
          ...
          child: Container(
            decoration: BoxDecoration(
              color: isOpen
                  ...
                  : theme.colors.secondary.withValues(alpha: 0.6),
              borderRadius: BorderRadius.circular(8),
            ),
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            IgnorePointer(
              child: FCheckbox(value: checked, onChange: (_) {}),
            ),
