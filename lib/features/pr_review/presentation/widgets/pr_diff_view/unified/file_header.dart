          ...
          child: Row(
            children: [
                  ...
                  children: [
                    Flexible(
                      child: FileHeaderPath(
                        ...
                        mutedColor: theme.colors.mutedForeground,
                      ),
                    ),
                    const SizedBox(width: 4),
                    FTooltip(
                      tipBuilder: (_, _) =>
                          Text(_copied ? 'Copied!' : 'Copy path'),
                      child: IconButton(
                        icon: Icon(
              ...
              if (widget.onAddFileComment != null) ...[
                ...
                FTooltip(
                  tipBuilder: (_, _) =>
                      Text(AppLocalizations.of(context).commentOnThisFile),
                  child: IconButton(
                    icon: Icon(
              ...
              if (widget.onToggleViewed != null) ...[
                ...
                FTooltip(
                  tipBuilder: (_, _) => Text(
                    widget.isViewed ? 'Mark as not viewed' : 'Mark as viewed',
                  ),
                  child: IconButton(
                    icon: Icon(
                      widget.isViewed
              ...
              FTooltip(
                tipBuilder: (_, _) => Text(widget.expanded
...
class FileHeaderPath extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final renamed = status == PrFileStatus.renamed &&
    ...
    return Row(
      ...
      children: [
        ...
        Padding(
          ...
          child: Icon(LucideIcons.arrowRight, size: 12, color: mutedColor),
        ),
        Flexible(child: LeftTruncatedText(text: filename, style: style)),
      ],
    );
  }
}
