...
enum DiffSlotKind {
  ...
  /// A rendered Markdown preview occupying a file's body in place of the diff
  /// (the per-file "rich diff" toggle). Hosted below the file header; its
  /// measured height is reserved in the document like a comment block.
  preview,
}
