...
class UnifiedDiffViewState extends ConsumerState<UnifiedDiffView> {
  ...
  Widget build(BuildContext context) {
    ...
    // surface rather than [colors.background] or they'd stripe the diff beige.
    final surface = context.designSystem?.bgPrimary ?? colors.background;
      ...
      (context, index) {
        ...
        switch (slot.kind) {
          ...
          case DiffSlotKind.preview:
            ...
            // No ambient Material in the forui shell — wrap so the rendered
...
class _GapRowState extends State<_GapRow> {
  ...
  Widget build(BuildContext context) {
    ...
    final surface = tokens?.bgPrimary ?? colors.background;
    final theme = Theme.of(context);
    return MouseRegion(
