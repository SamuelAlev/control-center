...
class SuggestionComposer extends StatefulWidget {
  ...
  /// Called with `(suggestedCode, comment)` when the suggestion is posted on
  /// its own, right now.
  final void Function(String suggested, String comment) onSubmit;

  /// Queues the suggestion for the next review submission. Null hides the
  /// action.
  final void Function(String suggested, String comment)? onSubmitBatched;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const CcDivider(),
            // Optional comment, then the actions on their own line: with the
            // batched action there are three labelled buttons, which do not fit
            // beside a text field in a narrowed diff panel.
            Padding(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      CcButton(
                        onPressed: () =>
                            widget.onSubmit(_code.text, _comment.text),
                        size: CcButtonSize.sm,
