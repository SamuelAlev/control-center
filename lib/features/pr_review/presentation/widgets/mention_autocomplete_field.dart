...
/// Modifier shortcuts (Cmd+Enter, Cmd+B) are left to ancestor handlers — only
/// the bare navigation keys are intercepted while the menu is open.
class MentionAutocompleteField extends ConsumerStatefulWidget {
  ...
  /// Invoked on the field's submit action. Note the mention menu consumes
  /// Enter while it is open, so accepting a candidate never also submits.
  ...
  Widget build(BuildContext context) {
    ...
    return CompositedTransformTarget(
      ...
      child: OverlayPortal(
        ...
        // Chromeless: the MarkdownEditor box owns the fill, border and ring.
        child: Padding(
