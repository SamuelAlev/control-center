...
class _ReviewAccordionItemState extends ConsumerState<ReviewAccordionItem> {
  ...
  Widget _buildExpandedBody(DesignSystemTokens tokens) {
    ...
    // channel's `main` conversation, joined by this metadata key).
            ...
            if (payload.isDeterministic) ...[
              ...
              CcTooltip(
                message: AppLocalizations.of(
                  context,
                ).reviewHubStaticRuleTooltip(payload.ruleId ?? ''),
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(AppIcons.regex, size: 9, color: tokens.textTertiary),
                      const SizedBox(width: 3),
                      Text(
                        AppLocalizations.of(context).reviewHubStaticRule,
                        style: CcTypography.caption.copyWith(
                          color: tokens.textTertiary,
                          fontSize: 9,
