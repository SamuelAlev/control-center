...
/// rendering (PR descriptions, review comments, chat messages).
///
...
MarkdownCheckboxBuilder prCheckboxBuilder(BuildContext context) =>
    (bool value) => SizedBox(
      height: 22,
      child: FittedBox(
        fit: BoxFit.contain,
...
MarkdownStyleSheet prMarkdownStyleSheet(
...
/// language label and a copy button which places the code on the clipboard
...
class CodeBlockBuilder extends MarkdownElementBuilder {
  ...
  Widget? visitElementAfterWithContext(
    ...
    final fTheme = context.theme;
    final codeStyle = prMarkdownStyleSheet(context).code;
    ...
    return Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Text.rich(TextSpan(text: code, style: codeStyle)),
        ),
      ],
    );
  }
