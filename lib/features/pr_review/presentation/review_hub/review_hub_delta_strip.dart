...
class ReviewHubDeltaStrip extends StatelessWidget {
  /// Creates a [ReviewHubDeltaStrip].
  const ReviewHubDeltaStrip({super.key, required this.delta});
...
class ReviewDelta {
  ...
  ///
  /// This is reached through `ReviewHubSummary ==`, which is what stops a
  /// derived provider from notifying on every unrelated message in the
  /// channel. Without it the fallback is identity, and a freshly-parsed
