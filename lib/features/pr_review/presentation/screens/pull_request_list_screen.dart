  ...
  Widget build(BuildContext context) {
    ...
    return ScopedShortcuts(
      ...
      child: PageWrapper(
        ...
        actions: [
          // Filter and display options read as one cluster, so they keep a
          // tighter gap than the header's standard one by travelling as a
          // single action.
          Row(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Repos the server's credential cannot see (e.g. the GitHub App is
          // not installed on their org): their queues are absent or stale, and
          // without the notice they just look empty.
          RepoAccessBanner(repos: state.inaccessibleRepos),
          if (filters.isActive) ...[
