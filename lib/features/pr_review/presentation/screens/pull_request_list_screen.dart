    ...
    return ScopedShortcuts(
      ...
      child: PageWrapper(
        ...
        actions: [
          ...
          FButton(
            onPress: (isAuthed && hasRepos)
                ? () => GoRouter.of(context).go(pullRequestsComposeRoute)
                : null,
            mainAxisSize: MainAxisSize.min,
            // Trim the default md vertical padding (11) so the button's
            // minHeight:36 floor wins — matching the 36px refresh icon button
            // beside it instead of rendering ~42px tall.
            ...
            prefix: const Icon(LucideIcons.gitPullRequestCreate, size: 16),
