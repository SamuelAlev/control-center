...
/// The PR chat tab: a full channel conversation scoped to the pull request.
///
/// The PR IS a channel (created + provisioned at the PR head on first use via
/// `pr.ensureChannel`), so this reuses [ConversationPane] unchanged — composer,
/// streaming, agent dispatch, approvals, takeover, autonomy, and parallel
/// conversations ("parentheses") all work exactly as in the messaging IDE.
class PrChatTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return channelAsync.when(
          ...
          child: Column(
            ...
            children: [
              ...
              CcButton(
                ...
                onPressed: () => ref.invalidate(prChannelProvider(pr)),
      ...
      data: (channelId) => ConversationPane(channelId: channelId),
    );
  }
}
