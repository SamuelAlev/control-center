...
class _PrDetailBodyState extends ConsumerState<_PrDetailBody> {
  ...
  /// Drops shell titles for terminal tabs no longer anywhere in the tree.
  ...
  Widget _buildBody(
    ...
    return _bodyHost.wrap(
      ...
      buildContent: () => _tabContent(tab, pollingState),
  ...
  Widget _tabContent(EditorTab tab, PrDetailRefreshState pollingState) {
    switch (tab.kind) {
