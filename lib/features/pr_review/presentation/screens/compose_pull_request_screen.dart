...
class _ComposePullRequestScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      breadcrumbActions: [
        FButton(
          onPress: () => GoRouter.of(context).go(pullRequestsRoute),
        ...
        FButton(
          onPress: (!state.canSubmit || state.submitting)
              ? null
        ...
        FButton(
          ...
          mainAxisSize: MainAxisSize.min,
          prefix: state.submitting
              ? const SizedBox(
                  width: 14,
                  height: 14,
                  child: FCircularProgress(),
                )
              : const Icon(LucideIcons.gitPullRequestCreate, size: 16),
