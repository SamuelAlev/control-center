...
/// panel it carries [spaceId], which lets it resolve that conversation's
...
class ComposePullRequestScreen extends ConsumerStatefulWidget {
  ...
  const ComposePullRequestScreen({super.key, this.spaceId});
...
class _ComposePullRequestScreenState
  ...
  void initState() {
    ...
    if (spaceId != null && spaceId.isNotEmpty) {
      ...
      ref.listenManual<AsyncValue<String?>>(
        worktreeBranchProvider(spaceId),
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      subtitle: (spaceId == null || spaceId.isEmpty)
          ? l10n.composePrSubtitle
          : l10n.composePrSubtitleFromSpace,
      breadcrumbActions: [
        CcButton(
