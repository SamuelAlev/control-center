...
///
/// The two halves of server reachability, on one page: which server this
/// client talks to (the connection section), and how this server is exposed to
/// others — mDNS advertisement, tunnel opt-in and relay usage (the sharing
/// section). They used to be separate pages, which split a single question
/// ("can my devices and teammates reach this server?") across two destinations;
/// the sharing page also had no inbound links of its own.
///
...
class ServerConnectionSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SettingsPage(
      ...
      sections: const [ServerConnectionSection(), ServerSharingSection()],
    );
  }
}
