...
import 'package:control_center/features/settings/presentation/widgets/sections/system/audit_trail_section.dart';
import 'package:control_center/features/settings/presentation/widgets/sections/system/policy_templates_section.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SettingsPage(
      ...
      sections: const [
        ...
        WhatIfProbeSection(),
        // The trail sits with the policy that produced it: "what did this
        // rule actually block?" is the question an operator asks next.
        AuditTrailSection(),
