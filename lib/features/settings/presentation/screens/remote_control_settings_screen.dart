...
import 'package:control_center/features/settings/presentation/widgets/sections/integrations/own_devices_section.dart';
import 'package:control_center/features/settings/presentation/widgets/sections/integrations/remote_control_settings.dart';
...
class RemoteControlSettingsScreen extends StatefulWidget {
  /// Creates a [RemoteControlSettingsScreen].
  const RemoteControlSettingsScreen({super.key});

  @override
  State<RemoteControlSettingsScreen> createState() =>
      _RemoteControlSettingsScreenState();
}

class _RemoteControlSettingsScreenState
    extends State<RemoteControlSettingsScreen> {
