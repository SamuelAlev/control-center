            ...
            if (filtered.isEmpty)
              ...
              ...categories.expand((entry) {
                return [
                  ...
                  ...entry.value.map(
                    (b) => _BindingRow(binding: b, platform: platform),
                  ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    // On web, browser-reserved accelerators (⌘T/⌘W/⌘N/⌘1‑9)
                    // never reach the page, so dim the chip and note it below —
                    // otherwise the reference reads as if the shortcut works.
                    Opacity(
                ...
                if (reserved) ...[
                  const SizedBox(height: 4),
                  Text(
                    l10n.shortcutUnavailableInBrowser,
