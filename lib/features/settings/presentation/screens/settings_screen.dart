...
import 'package:control_center/features/settings/presentation/widgets/sections/external_mcp_section.dart';
...
import 'package:control_center/features/settings/presentation/widgets/sections/meeting_templates_section.dart';
...
import 'package:control_center/features/settings/presentation/widgets/sections/remote_control_settings.dart';
import 'package:control_center/features/settings/presentation/widgets/sections/server_connection_section.dart';
...
import 'package:control_center/features/settings/presentation/widgets/sections/voice_profiles_section.dart';
...
/// Settings → Devices: pair and manage the phones that remote-control this app.
class DevicesSettingsScreen extends StatelessWidget {
  /// Creates a [DevicesSettingsScreen].
  ...
  Widget build(BuildContext context) {
    ...
    return _SettingsPage(
      title: l10n.devices,
      subtitle: l10n.devicesSettingsDescription,
      sections: [
        SectionCard(label: l10n.devices, child: const PairedDevicesPanel()),
      ],
    );
  }
}
