...
/// Settings section for GitHub, ticketing and other external accounts.
class AccountsSection extends ConsumerWidget {
  /// Creates an [AccountsSection].
        ...
        children: [
          SettingsRow(
            ...
            subtitleWidget: cliAsync.isLoading
                ...
                : null,
            trailing: CcButton(
              onPressed: () => ref.invalidate(githubCliStatusProvider),
  ...
  String _ghCliSubtitle(
    BuildContext context,
    AsyncValue<GitHubCliStatus> async,
  ) {
    final l10n = AppLocalizations.of(context);
    return async.when(
      data: (s) {
