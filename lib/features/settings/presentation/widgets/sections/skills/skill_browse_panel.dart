  ...
  Widget _buildContent(BuildContext context, AppLocalizations l10n) {
    ...
    return Column(
      ...
      children: [
        ...
        _FieldLabel(text: l10n.skillPreviewVerdictLabel),
        const SizedBox(height: 6),
        Row(
          children: [
            _VerdictBadge(verdict: preview.verdict),
        ...
        const SizedBox(height: 16),
        _FieldLabel(text: l10n.skillPreviewCapabilities),
        const SizedBox(height: 6),
        ...
        const SizedBox(height: 16),
        _FieldLabel(text: l10n.skillPreviewFindings),
        const SizedBox(height: 6),
        if (preview.findings.isEmpty)
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.stretch,
            children: [
              for (final f in preview.findings) _FindingTile(finding: f),
            ],
          ),
        if (_isQuarantine) ...[
          const SizedBox(height: 16),
...
/// verdict is never conveyed by colour alone (WCAG).
...
/// The explicit "install anyway" override for a quarantined skill.
class _QuarantineOverride extends StatelessWidget {
  const _QuarantineOverride({required this.checked, required this.onChanged});
      ...
      child: Column(
        ...
        children: [
          ...
          CcCheckbox(
            value: checked,
            onChanged: onChanged,
            label: Text(l10n.skillInstallAnywayOverride),
          ),
        ],
      ),
    );
...
/// A small field label used for the dialog's sections.
