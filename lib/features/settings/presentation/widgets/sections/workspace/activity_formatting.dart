...
String? _special(AppLocalizations l10n, String action) => switch (action) {
  ...
  'channel_read.markChannelRead' => l10n.activityMarkedChannelRead,
  ...
  'pr.ensureChannel' => l10n.activityOpenedReviewChannel,
  'conversation.ensureMain' => l10n.activityOpenedMainConversation,
...
String _targetNoun(AppLocalizations l10n, String domain) => switch (domain) {
  ...
  'channel_read' || 'channel' || 'channels' => l10n.activityTargetChannel,
  ...
  'pipeline_template' || 'template' || 'templates' =>
    l10n.activityTargetTemplate,
  ...
  'repo' || 'repos' || 'repository' || 'repositories' =>
    l10n.activityTargetRepository,
  'review_channel' => l10n.activityTargetReviewChannel,
