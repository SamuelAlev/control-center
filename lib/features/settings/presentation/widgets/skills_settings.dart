...
import 'package:control_center/features/settings/presentation/widgets/sections/skills/skill_browse_panel.dart';
...
/// skills (view/edit) or the registry browse-and-install surface (PRD 23 §1).
enum _SkillsTab { installed, browse }
...
class _SkillsBodyState extends ConsumerState<_SkillsBody> {
  ...
  Future<void> _openSkillFolder() async {
    ...
    try {
      await ref.read(revealInFileManagerProvider).reveal(dir);
    } on Object catch (_) {
      ...
      children: [
        Padding(
          ...
          child: Align(
            ...
            child: SegmentedToggle<_SkillsTab>(
              value: _tab,
              onChanged: (t) => setState(() => _tab = t),
              segments: [
                (value: _SkillsTab.installed, label: l10n.skillsInstalledTab),
                (value: _SkillsTab.browse, label: l10n.skillsBrowseTab),
              ],
            ),
          ),
        ),
        Expanded(
          child: _tab == _SkillsTab.installed
              ...
              : SkillBrowsePanel(workspaceId: widget.workspaceId),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SectionCard(
      ...
      trailing: Row(
        ...
        children: [
          // Icon-only with a tooltip: two labeled buttons overflow the pane
          ...
          CcIconButton(
            ...
            onPressed: skills.isEmpty || scanning ? null : onScanAll,
            loading: scanning,
          ),
            ...
            Row(
              children: [
                ...
                if (skill.scanVerdict != null) ...[
                  ...
                  SkillVerdictBadge(verdict: skill.scanVerdict!, compact: true),
                ],
              ],
            ),
