        ...
        children: [
          ...
          if (closedAsync != null && closedAsync.hasError)
            Padding(
              ...
              child: CcAlert(
                title: l10n.failedToLoad,
                description: Text(closedAsync.error.toString()),
              ),
            ),
