...
class _UserProfileScreenState extends ConsumerState<UserProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final isRefreshing =
        ...
        ref.watch(userPrCountsProvider(login)).isLoading;
      ...
      actions: [
        RefreshControl(
          ...
          onRefresh: () {
            ...
            ref.invalidate(userClosedPrsProvider(login));
            ref.invalidate(userPrCountsProvider(login));
            ref.invalidate(githubUserProfileProvider(login));
          },
        ),
...
class _MetadataRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              ...
              Text(
                ...
                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                  color: onTap != null ? tokens.textPrimary : tokens.textTertiary,
    ...
    if (profile.company?.isNotEmpty == true) {
      addItem(AppIcons.building2, profile.company!);
    }
              ...
              child: Row(
                ...
                children: [
                  if (org.avatarUrl.isNotEmpty)
                    ...
                    Icon(AppIcons.building2, size: 14,
                        color: tokens.textTertiary),
