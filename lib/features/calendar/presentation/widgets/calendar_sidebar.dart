  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        InkWell(
          onTap: () => showGoogleCalendarConnectDialog(context),
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 8),
            child: Row(
              children: [
                Icon(AppIcons.plus, size: 15, color: t.textSecondary),
        ...
        children: [
          ...
          if (syncing)
            ...
            Tooltip(
              ...
              child: _MiniIconButton(icon: AppIcons.refreshCw, onTap: onSync),
            ),
          Tooltip(
            message: l10n.calendarDisconnect,
            child: _MiniIconButton(icon: AppIcons.unlink, onTap: onDisconnect),
          ),
        ],
      ),
    );
