          ...
          Semantics(
            ...
            child: Tooltip(
              ...
              child: InkWell(
                ...
                onTap: () => context.go(calendarRoute(context.currentWorkspaceId!)),
                child: Padding(
                  padding: const EdgeInsets.all(6),
                  child: Icon(AppIcons.x, size: 16, color: t.textSecondary),
                ),
              ),
            ),
          ),
  ...
  Widget build(BuildContext context) {
    if (linkedMeetingId != null) {
      return CcButton(
        ...
        onPressed: () => context.go(meetingDetailRoute(context.currentWorkspaceId!, linkedMeetingId!)),
