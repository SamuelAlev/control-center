...
import 'package:cc_infra/cc_infra_web.dart' hide googleOAuthTokenEndpoint;
...
class GoogleOAuthService {
  ...
  GoogleOAuthService({
    ...
    required this._awaitRedirect,
    Dio? tokenDio,
    Future<bool> Function(Uri url)? launcher,
    Random? random,
  }) : _tokenDio = tokenDio ?? createDio(),
       _launch = launcher ?? ((url) async => openExternalUrl(url.toString())),
