...
/// A per-signal tone: quiet at zero, warning once the signal actually fired.
ObsTone _signalTone(int count) => count > 0 ? ObsTone.warning : ObsTone.neutral;
