      ...
      children: [
        ObsStatStrip(
          entries: [
            ...
            // Failed and errored only read as bad once they happened —
            // a red "0" claims a problem that is not there.
            ObsStatStripEntry(
              label: l10n.obsBenchmarkFailed,
              value: fmtCount(run.failCount),
              tone: run.failCount > 0 ? ObsTone.danger : ObsTone.neutral,
            ),
            ObsStatStripEntry(
              label: l10n.obsBenchmarkErrors,
              value: fmtCount(run.errorCount),
              tone: run.errorCount > 0 ? ObsTone.warning : ObsTone.neutral,
            ),
            ObsStatStripEntry(
