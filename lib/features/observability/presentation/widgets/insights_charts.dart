  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _Legend(
          entries: [
            (label: l10n.obsLegendRuns, color: runsColor),
            (label: l10n.obsLegendErrors, color: errorsColor),
          ],
        ),
      ],
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: AppSpacing.sm),
        _Legend(entries: [(label: l10n.obsColCost, color: lineColor)]),
      ],
    );
  }
...
/// Series key. Always rendered — the chart never relies on color alone.
