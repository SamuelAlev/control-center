...
/// The observability hub: three tabs over the workspace run-log feed —
/// Insights (time-ranged KPIs, charts, breakdowns, per-agent and per-run
/// rows), Live (roster, quotas, goal, fleet), and Quality (benchmark, evals).
