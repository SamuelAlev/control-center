...
class _TicketListRowState extends ConsumerState<_TicketListRow> {
  ...
  Widget build(BuildContext context) {
    ...
    final showCheckbox = _hovered || selected || anySelected;
    final date =
    ...
    final bg = selected
        ...
        : widget.isOpen
            ? t.bgSecondary
            : (_hovered ? t.bgPrimaryHover : t.bgPrimary);
      ...
      child: GestureDetector(
        ...
        child: Row(
          children: [
            SizedBox(
              width: 24,
              // Centre so the tappable gets loose constraints — otherwise the
              // 24px-wide cell forces the 18px checkbox into a wide rectangle.
              child: showCheckbox
                  ? Center(
                      child: _RowCheckbox(
                        checked: selected,
      ...
      child: Row(
        ...
        children: [
          ...
          FButton(
            ...
            mainAxisSize: MainAxisSize.min,
            onPress: () => _confirmDelete(context, ref, ids),
            prefix: const Icon(LucideIcons.trash2, size: 15),
  ...
  Future<void> _confirmDelete(
    ...
    final confirmed = await showFDialog<bool>(
      ...
      builder: (ctx, style, animation) => FDialog(
        ...
        body: Text(l10n.bulkDeleteMessage(ids.length)),
        actions: [
          SizedBox(
