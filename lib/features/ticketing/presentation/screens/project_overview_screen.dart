        ...
        children: [
          Row(
            children: [
              ...
              CcButton(
                onPressed: () async {
                  final id = await showNewTicketDialog(
                    context,
                  ...
                  if (id != null) {
                    await ref
                        ...
                        .setProject(id, project.id, workspaceId: workspaceId);
                  }
                },
                icon: AppIcons.plus,
...
class _ProjectStatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final variant = switch (status) {
      ProjectStatus.active => CcBadgeVariant.brand,
      ProjectStatus.completed => CcBadgeVariant.success,
      ProjectStatus.archived => CcBadgeVariant.neutral,
    };
    return CcBadge(label: projectStatusLabel(l10n, status), variant: variant);
  }
}
          ...
          child: ClipRRect(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  CcTile(
                    leadingIcon: AppIcons.squarePen,
                  ...
                  CcTile(
                    leadingIcon: AppIcons.circleCheck,
                    title: isCompleted
...
Future<void> _confirmDelete(
  ...
  if (context.mounted) {
    context.go(ticketsRoute(context.currentWorkspaceId!));
  }
}
...
class _ProjectTicketRow extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CcTappable(
      onPressed: () =>
          context.go(ticketDetailRoute(context.currentWorkspaceId!, ticket.id)),
    ...
    return ColoredBox(
      ...
      child: Center(
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(AppIcons.box, size: 40, color: t.fgQuaternary),
            const SizedBox(height: 12),
