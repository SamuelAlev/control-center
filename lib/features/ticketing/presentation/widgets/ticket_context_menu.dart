...
List<_MenuEntry> _buildEntries({
  ...
  final assigneeChildren = <_MenuEntry>[
    ...
    _MenuAction(
      ...
      label: 'You',
      selected: ticket.isAssignedToUser,
      onTap: () {
  ...
  final projectChildren = <_MenuEntry>[
    _MenuAction(
      leading: Icon(AppIcons.circleSlash, size: 16, color: _hintColor(context)),
  ...
  return [
    ...
    _MenuSub(
      leading: Icon(AppIcons.signalHigh, size: 16, color: _hintColor(context)),
      label: l10n.priority,
      children: priorityChildren,
    ),
    _MenuSub(
      leading: Icon(AppIcons.userRound, size: 16, color: _hintColor(context)),
      label: l10n.assignee,
      children: assigneeChildren,
    ),
    _MenuSub(
      leading: Icon(AppIcons.box, size: 16, color: _hintColor(context)),
      label: l10n.project,
    ...
    const _MenuDivider(),
    _MenuAction(
      leading: Icon(AppIcons.clipboard, size: 16, color: _hintColor(context)),
      label: l10n.copyId,
      onTap: () async {
        ...
        if (context.mounted) {
          CcToastScope.of(
            context,
          ).show(l10n.ticketIdCopied, variant: CcToastVariant.success);
        }
      },
    ),
    const _MenuDivider(),
    _MenuAction(
      leading: const Icon(AppIcons.trash2, size: 16, color: Color(0xFFD92D20)),
      label: l10n.delete,
      destructive: true,
      onTap: () async {
        dismiss();
...
Future<void> _confirmDelete(
  ...
  if (context.mounted && ref.read(selectedTicketIdProvider) == ticket.id) {
        ...
        child: Container(
          ...
          child: Row(
            children: [
              ...
              if (widget.selected)
                Icon(AppIcons.check, size: 15, color: t.fgBrandPrimary),
              if (widget.hasChildren)
                Icon(AppIcons.chevronRight, size: 15, color: t.fgQuaternary),
            ],
          ),
        ),
      ),
