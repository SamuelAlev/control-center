  ...
  Widget build(BuildContext context) {
    ...
    return CcTappable(
      ...
      builder: (context, states) => Container(
        // Fixed height so every property chip renders at the same size
        // regardless of its leading content (a 10px status dot vs an 18px
        // assignee avatar would otherwise each set their own height).
        height: 30,
        padding: EdgeInsets.symmetric(horizontal: bordered ? 10 : 8),
        decoration: BoxDecoration(
