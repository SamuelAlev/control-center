...
class _TicketAuditStripState extends ConsumerState<TicketAuditStrip> {
            ...
            GestureDetector(
              ...
              child: Padding(
                ...
                child: Text(
                  ...
                  style: CcTypography.caption.copyWith(color: t.fgBrandPrimary),
                ),
              ),
            ),
        ],
  ...
  String _line(ActivityEntry e) {
    ...
    final actor = e.actorType == 'agent' ? 'agent' : e.actorType;
    final detail = e.details == null || e.details!.isEmpty
        ? ''
        : ' — ${e.details}';
