...
class ProjectGlyph extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Icon(LucideIcons.box, size: size * 0.66, color: c),
    );
  }
}
...
IconData ticketRelationIcon(TicketRelationKind kind) => switch (kind) {
      TicketRelationKind.subIssueOf => LucideIcons.cornerLeftUp,
      TicketRelationKind.parentOf => LucideIcons.cornerLeftDown,
      TicketRelationKind.blockedBy => LucideIcons.circleSlash,
      TicketRelationKind.blocking => LucideIcons.ban,
      TicketRelationKind.relatedTo => LucideIcons.gitCompareArrows,
      TicketRelationKind.duplicateOf => LucideIcons.copy,
      TicketRelationKind.duplicatedBy => LucideIcons.copy,
    };
