...
class TicketCheckoutService {
  ...
  Future<CheckoutResult> checkout({
    ...
    if (ticket.isTerminal) return CheckoutResult.conflict;
    ...
    if (currentRunId == runId) return CheckoutResult.alreadyOwned;
  ...
  Future<void> release(String ticketId, String runId) async {
    ...
    if (ticket.checkoutRunId != runId) return;
  ...
  Future<bool> adoptStaleLock({
    ...
    if (DateTime.now().difference(lockedAt) < _staleLockThreshold) return false;
