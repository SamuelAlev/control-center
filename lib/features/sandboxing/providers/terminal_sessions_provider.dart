...
class TerminalMirror {
  ...
  /// The terminal session identity (channel, workspace, agent binding).
...
class ChannelTerminalsNotifier extends Notifier<List<TerminalMirror>> {
  /// Creates a [ChannelTerminalsNotifier] for [channelId].
  ChannelTerminalsNotifier(this.channelId);
...
/// Live terminal sessions for a conversation (channel id), maintained by the
/// IDE layout.
final channelTerminalsProvider =
    NotifierProvider.family<
      ChannelTerminalsNotifier,
      List<TerminalMirror>,
      String
    >(ChannelTerminalsNotifier.new);
