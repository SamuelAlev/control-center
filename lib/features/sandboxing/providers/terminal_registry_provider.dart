...
//
// The messaging IDE unmounts every `TerminalSessionView` on a channel switch;
...
// app-wide at what a handful of recently-used channels need; the
// least-recently-touched controller NOT claimed by a live tab of the active
// channel is evicted past the cap (its channel respawns a blank shell on next
// visit — today's behaviour for every channel). On-screen tabs are never
...
/// How many shells stay alive app-wide, LRU-evicted among channels not on
...
/// active channel (eviction-protected).
class TerminalRegistryState {
  ...
  /// Session ids claimed by live terminal tabs of the active channel.
