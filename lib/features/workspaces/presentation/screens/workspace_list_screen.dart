...
class _WorkspaceListScreenState extends ConsumerState<WorkspaceListScreen> {
  ...
  Future<void> _save(Workspace w) async {
    ...
    try {
      ...
      _toast(
        kDebugMode ? '$e' : l10n.failedToLoadWorkspaces,
    ...
    return Scaffold(
      ...
      body: ScopedShortcuts(
        ...
        bindings: {
          ...
          if (editing != null) ...{
            'ws.open': () => context.go(dashboardRoute(editing.id)),
              ...
              children: [
                for (final w in workspaces)
                  _WorkspaceRow(
                    ...
                    displayLogoPath: w.id == editingId
                        ? draftLogoPath
                        : w.logoPath,
                    onTap: () => onSelect(w),
                  ),
          ...
          Container(
            ...
            child: CcTappable(
              ...
              builder: (context, states) => Padding(
                ...
                child: Row(
                  children: [
                    Icon(AppIcons.plus, size: 15, color: muted),
                    const SizedBox(width: 12),
                    Text(
                      l10n.addWorkspace,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CcTappable(
      ...
      builder: (context, states) => AnimatedContainer(
        ...
        child: Row(
          children: [
            WorkspaceAvatar(name: name, logoPath: displayLogoPath, size: 34),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Column(
        ...
        children: [
          _PanelHeader(
            title: l10n.identity,
            trailing: CcButton(
              onPressed: () => context.go(dashboardRoute(editing.id)),
              variant: CcButtonVariant.secondary,
