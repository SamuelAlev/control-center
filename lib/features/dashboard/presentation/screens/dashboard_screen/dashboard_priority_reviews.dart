            ...
            builder: (context) {
              ...
              return Column(
                ...
                children: [
                  ...
                  for (final pr in prs)
                    _PrRow(pr: pr, codeFont: codeFont, l10n: l10n),
                ],
              );
            },
          ),
  ...
  Widget build(BuildContext context) {
    ...
    return FTooltip(
      tipBuilder: (context, _) => ConstrainedBox(
        ...
        child: Text(tooltip, style: const TextStyle(fontSize: 12, height: 1.4)),
      ),
      child: MouseRegion(
...
class _PrRow extends StatefulWidget {
  const _PrRow({required this.pr, required this.codeFont, required this.l10n});
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        onTap: () => GoRouter.of(context).go(pullRequestDetailRoute(pr.number)),
            child: Container(
              padding: const EdgeInsets.symmetric(
                horizontal: AppSpacing.xl,
