...
class _CaughtUp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Icon(AppIcons.circleCheck, size: 22, color: ds.success),
...
class _NeedRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final ds = dashTokens(context);
    final spec = _NeedSpec.of(need, ds, l10n, context.currentWorkspaceId!);
    ...
    switch (need) {
      case ReviewsNeed():
        return _NeedSpec(
          ...
          route: pullRequestsRoute(workspaceId),
          go: true,
        );
      case BlockedAgentNeed():
        return _NeedSpec(
          ...
          route: settingsAgentsRoute(workspaceId),
          go: false,
        );
      case FailedPipelineNeed():
        return _NeedSpec(
          ...
          route: pipelineRunRoute(workspaceId, need.runId),
          go: false,
        );
      case StalePrNeed():
        return _NeedSpec(
...
class _NoActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Icon(AppIcons.activity, size: 22, color: ds.muted),
          const SizedBox(height: AppSpacing.md),
          Text(
...
class _ActivityRowState extends State<_ActivityRow> {
  ...
  IconData _iconFor(NotificationCategory category) => switch (category) {
        ...
        NotificationCategory.externalPr => AppIcons.gitPullRequestArrow,
