...
class SecureCredentialsRepository implements CredentialsRepository {
  ...
  Future<void> saveCredentials(ApiCredentials credentials) async {
    ...
    await _prefs.setString(
      ...
      credentials.ticketingProviderId,
    );
  }
  ...
  Future<void> clearCredentials() async {
    ...
    // Drop the pre-Adapters z.ai key too — it moved to the server-side harness
    // provider credential store (Settings → Adapters → Providers & models).
    await _storage.delete(key: legacyZaiApiKeyKey);
