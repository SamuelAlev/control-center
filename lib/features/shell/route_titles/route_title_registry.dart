...
final Map<String, RouteTitleBuilder> routeTitleRegistry = {
  ...
  spacesRoute(workspaceIdParam): (_, _, l10n) => l10n.navConversations,
  '${spacesRoute(workspaceIdParam)}/:spaceId': (_, _, l10n) =>
  ...
  // tab title behind. Pipelines/memory keep their own entries below because
  // they are foreign features that merely live under `/settings`.
...
String? _pullRequestDetailTitle(
  ...
  final pr = ref.watch(prDetailProvider(prRef)).value;
