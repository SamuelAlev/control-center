...
class _ControlCenterLayoutState extends ConsumerState<ControlCenterLayout> {
  ...
  Widget build(BuildContext context) {
    ...
    // the keybinding dispatcher so `route == '/dashboard'` when-clauses gate
        ...
        body: Stack(
          children: [
            Row(
              children: [
                // Primary navigation.
                AppSidebar(location: location, workspaceId: workspaceId),
                // Top bar + content.
                Expanded(
                  child: Column(
                    children: [
  ...
  List<Widget> _buildSettingsGroups(
    ...
    final groups = <CcSidebarGroup?>[
      group(l10n.settingsGroupGeneral, [
        item(AppIcons.paintbrushVertical, l10n.appearance,
            settingsAppearanceRoute(workspaceId)),
        item(AppIcons.bell, l10n.notifications,
            settingsNotificationsRoute(workspaceId)),
        item(AppIcons.keyboard, l10n.keybindings,
            settingsKeybindingsRoute(workspaceId)),
        item(AppIcons.slidersHorizontal, l10n.advanced,
            settingsAdvancedRoute(workspaceId)),
        item(AppIcons.smartphone, l10n.devices,
            settingsDevicesRoute(workspaceId)),
      ]),
      group(l10n.settingsGroupAgents, [
        item(AppIcons.bot, l10n.agentRegistry, settingsAgentsRoute(workspaceId)),
        item(AppIcons.plug, l10n.adapters, settingsAdaptersRoute(workspaceId)),
        item(AppIcons.sparkles, l10n.skills, settingsSkillsRoute(workspaceId)),
        item(AppIcons.workflow, l10n.pipelineTemplatesNav,
            settingsPipelinesRoute(workspaceId),
            exact: false),
        item(AppIcons.shield, l10n.sandboxing,
            settingsSandboxingRoute(workspaceId)),
        item(AppIcons.users, l10n.teamsNav, teamsRoute(workspaceId)),
      ]),
      group(l10n.settingsGroupResources, [
        item(AppIcons.folderGit2, l10n.repositories,
            settingsReposRoute(workspaceId)),
        item(AppIcons.cable, l10n.integrations,
            settingsIntegrationsRoute(workspaceId),
