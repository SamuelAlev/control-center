...
final pipelineTemplateRepositoryProvider = Provider<PipelineTemplateRepository>(
  (ref) {
    return PipelineTemplateRepositoryImpl(
      ...
      // Validate output-schema documents at save time. The body-key registry
      // is intentionally NOT threaded here (it depends on this repository, so
      // it would form a cycle); the runtime body lookup remains the backstop
      // for a typo'd bodyKey.
