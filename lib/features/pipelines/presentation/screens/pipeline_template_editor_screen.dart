...
class _PipelineTemplateEditorScreenState
  ...
  void _deleteNode(String stepId) {
    ...
    setState(() {
      if (_selectedStepId == stepId) _selectedStepId = null;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      actions: [
        ...
        FButton(
          onPress: () => _openRunSettings(draft),
          prefix: const Icon(LucideIcons.slidersHorizontal, size: 14),
        ...
        FButton(
          onPress: _dirty ? _save : null,
          prefix: const Icon(LucideIcons.save, size: 14),
          size: FButtonSizeVariant.sm,
