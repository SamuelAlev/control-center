...
class _PipelinesScreenState extends ConsumerState<PipelinesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      actions: [
        FButton(
          onPress: () => context.go(runPipelineRoute),
          prefix: const Icon(LucideIcons.play, size: 14),
  ...
  Future<void> _deleteRun(PipelineRun run) async {
    ...
    final confirmed = await showFDialog<bool>(
      ...
      builder: (ctx, style, animation) => FDialog(
        style: style,
        animation: animation,
        title: Text(l10n.deletePipelineRun),
        body: Text(l10n.deletePipelineRunConfirm(run.templateId)),
        actions: [
          SizedBox(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.errorDeletingPipelineRun('$e'))),
      );
    }
  }
}
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(LucideIcons.workflow, size: 28, color: tokens.fgQuaternary),
          const SizedBox(height: AppSpacing.md),
          Text(
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(LucideIcons.gitBranch, size: 40, color: tokens.fgQuaternary),
