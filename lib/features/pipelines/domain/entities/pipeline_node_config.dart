...
class PipelineNodeConfig {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (inputKeys.isNotEmpty) json['inputKeys'] = inputKeys;
    if (outputKey != null) json['outputKey'] = outputKey;
    if (label != null) json['label'] = label;
    if (outputSchema != null) json['outputSchema'] = outputSchema;
    if (reducer != null) json['reducer'] = reducer;
    if (retryPolicy != null) json['retryPolicy'] = retryPolicy!.toJson();
    if (continueOnFail) json['continueOnFail'] = true;
    if (timeoutMs != null) json['timeoutMs'] = timeoutMs;
    if (teamId != null) json['teamId'] = teamId;
    if (dispatchMode != null) json['dispatchMode'] = dispatchMode;
    if (extras.isNotEmpty) json['extras'] = extras;
    return json;
  }
