...
/// by the config-dense settings page) the spacing tightens so the
/// form/logs/memory tabs keep their vertical room.
class AgentProfileHeader extends ConsumerWidget {
  ...
  /// Tightens spacing. For surfaces where the
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final nameStyle =
        (compact
                ? CcTypography.title.copyWith(color: tokens.textPrimary)
                : CcTypography.title.copyWith(color: tokens.textPrimary))
