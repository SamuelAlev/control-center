...
class _AgentsRegistryScreenState extends ConsumerState<AgentsRegistryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PageWrapper(
      ...
      actions: [
        ...
        CcButton(
          onPressed: workspaceId == null ? null : () => _openAdd(workspaceId),
  ...
  Widget _buildMasterDetail(List<Agent> agents) {
    final selected = agents.where((a) => a.id == _selectedId).firstOrNull;
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                width: 132,
                child: CcSelect<_AgentSort>(
                  value: sort,
                  options: [
                    CcSelectOption(
                      value: _AgentSort.status,
                      label: l10n.sortByStatus,
                    ),
                    CcSelectOption(
                      value: _AgentSort.name,
