...
class GitHubStatusButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CcPopover(
      ...
      target: _StatusChip(status: status),
    );
  }
}
...
class _StatusChipState extends State<_StatusChip> {
  ...
  Widget build(BuildContext context) {
    ...
    final borderColor =
        tokens.borderSecondary.withValues(alpha: _hover ? 1 : 0.6);
    final fg = tokens.textPrimary;
    final chevron = tokens.textTertiary;
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          ...
          children: [
            ...
            Icon(AppIcons.chevronUp, size: 12, color: chevron),
          ],
        ),
      ),
    );
...
class _StatusFlyout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: 380,
      // Scroll when the component list makes the flyout taller than the
      // viewport cap imposed by [CcOverlayAnchor] (e.g. opening upward from the
      // bottom-anchored chip), instead of being clipped under the top bar.
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            height: 28,
            decoration: BoxDecoration(
              color: _hover ? tokens.bgSecondary : Colors.transparent,
              borderRadius: BorderRadius.circular(8),
            ),
            child: Icon(
              widget.icon,
