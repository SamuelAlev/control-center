// TODO: replace PopupMenuButton with a cc_ui component (CcSelect / CcMenu / CcPopover).
...
/// Localized display support for [ConversationMode].
extension ConversationModeL10n on ConversationMode {
  ...
  String get displayName => switch (this) {
    ...
    ConversationMode.orchestrate => 'Orchestrate',
  };
...
class ModeDropdown extends StatelessWidget {
  ...
  IconData _iconFor(ConversationMode mode) => switch (mode) {
    ...
    ConversationMode.orchestrate => Icons.account_tree,
  };
}
