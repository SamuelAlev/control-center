...
class ModeEnforcementBadge extends ConsumerWidget {
  /// Creates a [ModeEnforcementBadge] for [spaceId].
  ...
  /// The space whose agents' adapter decides what can be enforced.
  final String spaceId;

  /// The space's current conversation mode.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final resolved = ref.watch(spaceAdapterEnforcementProvider(spaceId));
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                // is never the only space (the a11y bar in CLAUDE.md).
