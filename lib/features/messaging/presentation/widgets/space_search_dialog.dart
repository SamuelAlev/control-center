...
class SpaceSearchDialog extends ConsumerStatefulWidget {
  /// Creates the dialog for [spaceId].
  const SpaceSearchDialog({super.key, required this.spaceId});

  /// The space being searched.
  final String spaceId;

  @override
  ConsumerState<SpaceSearchDialog> createState() => _SpaceSearchDialogState();
}

class _SpaceSearchDialogState extends ConsumerState<SpaceSearchDialog> {
  ...
  Widget _results(AppLocalizations l10n, DesignSystemTokens? tokens) {
    ...
    final resultsAsync = ref.watch(
      spaceSearchProvider((spaceId: widget.spaceId, query: _query)),
    );
