...
IconData _toolIcon(String? name) {
  if (name == null) return LucideIcons.wrench;
  final n = name.toLowerCase();
  if (n.contains('read') || n.contains('file')) return LucideIcons.fileText;
  if (n.contains('write') || n.contains('edit')) return LucideIcons.pencil;
...
String _formatDuration(Duration d) {
  if (d.inMilliseconds < 1000) return '<1s';
