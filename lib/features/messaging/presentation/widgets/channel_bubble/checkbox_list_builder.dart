...
/// Builder that renders markdown checkbox lists with FCheckbox.
class FCheckboxListBuilder extends sm.MarkdownWidgetBuilder {
  /// Creates an [FCheckboxListBuilder].
  const FCheckboxListBuilder();
  ...
  Widget _buildListItem(
    ...
    if (item.checked != null) {
      marker = SizedBox(
        ...
        child: FittedBox(
          fit: BoxFit.contain,
          child: FCheckbox(value: item.checked!, enabled: false, onChange: null),
        ),
      );
    } else if (index != null) {
