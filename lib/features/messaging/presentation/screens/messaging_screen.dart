...
class _MessagingScreenState extends ConsumerState<MessagingScreen> {
  ...
  Future<void> _toggleTerminal() async {
    ...
    if (session == null) {
      CcToastScope.of(
        context,
      ).show(l10n.noAgentAssigned, variant: CcToastVariant.neutral);
      return;
    }
    setState(() {
        ...
        builder: (context, constraints) {
          ...
          final regions = <CcResizableRegion>[
            CcResizableRegion(
              ...
              minExtent: 180,
              builder: (context) {
                // The region's SizedBox imposes the current (draggable) extent;
                // read it back so the sidebar tracks the resizable width.
            ...
            children: [
              ...
              Expanded(
                child: ChannelMessageFeed(
                  key: ValueKey('feed-${widget.channelId}'),
