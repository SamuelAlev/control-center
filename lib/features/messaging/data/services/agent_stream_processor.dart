...
import 'package:control_center/features/dispatch/domain/entities/agent_process_event.dart' hide ThinkingEvent;
...
/// Processes agent stream events into channel messages.
...
/// Starts streaming agent events for the given dispatch.
  void processStream({
