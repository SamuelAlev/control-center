...
enum IdeSidebarView {
  ...
  /// The pull request linked to the conversation.
  pullRequests,

  /// The shared per-channel handoff doc.
  notes,
...
/// pinned, so the strip is byte-identical to the old six-tab bar until the
/// operator unpins something.
