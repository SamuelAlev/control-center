    ...
    return ScopedShortcuts(
      ...
      child: PageWrapper(
        ...
        actions: [
          if (totalUnread > 0)
            FTooltip(
              tipBuilder: (_, _) => Text(l10n.markAllRead),
              child: FButton.icon(
                variant: FButtonVariant.ghost,
                onPress: () => ref
                    .read(markAllReadControllerProvider.notifier)
                    .markAllRead(),
                child: const Icon(LucideIcons.checkCheck, size: 16),
              ),
            ),
          FTooltip(
            tipBuilder: (_, _) => Text(l10n.refreshAllFeeds),
            child: FButton.icon(
              variant: FButtonVariant.ghost,
              onPress: refreshing
                  ? null
          ...
          FTooltip(
            tipBuilder: (_, _) => Text(l10n.newsfeedSettingsTitle),
            child: FButton.icon(
              variant: FButtonVariant.ghost,
              onPress: () => context.go(newsfeedSettingsRoute),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
      ...
      return Semantics(
        ...
        child: FTooltip(
          ...
          child: FTappable.static(
            onPress: () => ref.read(newsfeedLayoutProvider.notifier).set(target),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: active
                    ? (tokens?.bgPrimary ?? fColors.background)
                    : Colors.transparent,
                borderRadius: AppRadii.brSm,
                border: Border.all(
                  color: active
                      ? (tokens?.borderSecondary ?? fColors.border)
                      : Colors.transparent,
                ),
              ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: tokens?.borderSecondary ?? fColors.border,
        ),
      ),
      child: Row(
    ...
    return IntrinsicWidth(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: tokens?.bgSecondary ?? fColors.muted,
          borderRadius: AppRadii.brMd,
          border: Border.all(color: tokens?.borderSecondary ?? fColors.border),
        ),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: [
