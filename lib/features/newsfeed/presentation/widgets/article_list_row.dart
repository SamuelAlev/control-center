  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: SizedBox(
        width: 56,
        height: 40,
        // The box is fixed (56x40), so layout never jumps; ProxiedImage fills
        // it with a tiny lightweight preview, then cross-fades the full frame
        // over it as the bytes arrive.
        child: image.isEmpty
            ? fallback
            : ProxiedImage(
                url: image,
