    ...
    return SizedBox(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(LucideIcons.trophy, color: muted, size: 28),
...
class _HeroBodyState extends ConsumerState<_HeroBody> {
  ...
  Widget build(BuildContext context) {
    ...
    final primary = theme.colors.foreground;
              ...
              builder: (context, c) {
                ...
                final header = Row(
                  children: [
                    ...
                    const Spacer(),
                    Icon(LucideIcons.trophy, size: 14, color: muted),
                  ],
                );
                ...
                return Material(
                  ...
                  child: InkWell(
                    borderRadius: BorderRadius.circular(12),
                        onTap: () => context.go(analyticsAgentRoute(widget.top.agentId)),
                    child: Padding(
      ...
      children: [
        Text(
          ...
          style: TextStyle(
            fontSize: 18,
            fontWeight: FontWeight.w700,
            color: tokens?.textPrimary ?? theme.colors.foreground,
            height: 1.0,
          ),
        ),
        const SizedBox(height: 4),
