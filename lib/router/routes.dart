...
/// Settings → Server → Sharing & remote access (mDNS, tunnel opt-in).
String settingsServerSharingRoute(String workspaceId) =>
    '/workspaces/$workspaceId/settings/server/sharing';
...
/// under `/settings` (like teams) so the settings sub-sidebar stays mounted.
