...
class SectionCard extends StatelessWidget {
  ...
  /// How many things the card's body lists, rendered as a quiet badge beside
  /// [label]. "How many are there" belongs on the heading of the list itself,
  /// not in a stat strip above it — a lone count is a fact about the title.
  final int? count;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (child != null) expands ? Expanded(child: child!) : child!,
          ],
        ),
      ),
    );
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Top-aligned: a tall trailing (e.g. a 40px button) must not push the
    // small caps label below the card's top padding — the label anchors the
    // header, the trailing hangs from the same top line.
