...
typedef HoverCardBuilder =
    Widget Function(BuildContext context, String agentId);

/// Avatar for an AI agent. Renders the agent's initial inside a [CcAvatar]
...
class _AgentAvatarState extends State<AgentAvatar> {
  ...
  Widget build(BuildContext context) {
    ...
    final initial = (name != null && name.isNotEmpty)
        ? name[0].toUpperCase()
        : '?';
    final avatar = CcAvatar(size: widget.size, initials: initial);
