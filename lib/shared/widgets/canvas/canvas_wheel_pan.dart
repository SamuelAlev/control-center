...
/// Makes a mouse wheel PAN an `InteractiveViewer` canvas, leaving zoom to ⌘/Ctrl + wheel, a
/// trackpad pinch and the on-screen controls.
/// [beginInteraction] must be wired to the viewer's `onInteractionStart`, which fires
/// BEFORE the viewer mutates the matrix, so the snapshot is the pre-zoom transform; a plain
/// wheel restores it and translates instead.
