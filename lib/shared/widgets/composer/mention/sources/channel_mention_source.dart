...
class ChannelMentionItem {
  /// Creates a [ChannelMentionItem] with the given [id] and [name].
  const ChannelMentionItem({required this.id, required this.name});
...
class ChannelMentionSource extends SyncMentionSource {
  ...
  String? sectionLabel(BuildContext context) =>
      AppLocalizations.of(context).channelsMentionSection;
