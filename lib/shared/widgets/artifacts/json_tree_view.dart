            ...
            builder: (context, states) => Row(
              ...
              children: [
                ...
                if (widget.label != null)
                  // Flexible so a long key at depth cannot overflow the row:
                  // indentation eats the available width as the tree nests.
                  Flexible(
                    child: Text(widget.label!, style: _keyStyle(tokens)),
                  ),
