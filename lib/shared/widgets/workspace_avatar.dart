      ...
      if (url != null) {
        return _logoPlate(
          ...
          Image.network(
            ...
            fit: BoxFit.cover,
            gaplessPlayback: true,
            // `width`/`height` bind the PAINT size; `cacheWidth` is what binds
            // the DECODE. Without it a 1024px logo is decoded and cached at
            // full size to be drawn into a 24px disc.
