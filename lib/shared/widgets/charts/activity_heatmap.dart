...
class _ActivityHeatmapState extends State<ActivityHeatmap> {
  ...
  Widget _buildTooltipOverlay(({int w, int d, String message}) h, bool isDark) {
    ...
    final monthYOffset = widget.showLabels
        ? _monthLabelHeight + widget.cellGap
        : 0;
    ...
    return Positioned(
      ...
      child: FractionalTranslation(
        ...
        child: IgnorePointer(
          child: _FloatingTooltip(message: h.message, isDark: isDark),
        ),
      ),
    );
  }
