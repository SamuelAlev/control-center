...
const Set<String> _lightLangs = {
  'dart', 'json', 'jsonc', 'json5', 'jsonl', 'yaml', 'ini', 'dotenv',
  'diff', 'csv', 'tsv', 'log',
};

const Set<String> _mediumLangs = {
  'markdown', 'mdx', 'html', 'xml', 'xsl', 'css', 'scss', 'sass', 'less',
  'python', 'go', 'rust', 'toml', 'java', 'kotlin', 'ruby', 'php', 'swift',
  'graphql', 'proto', 'make', 'docker', 'cmake', 'gherkin', 'http',
  'codeowners', 'mermaid', 'r', 'julia', 'elm', 'gleam',
};

const Set<String> _extremeLangs = {
  'cpp', 'objective-cpp', 'sql', 'plsql',
};
