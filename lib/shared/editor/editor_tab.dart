...
class EditorTabGroupController extends ChangeNotifier {
  ...
  /// tab with the same key already exists, that tab is replaced and refocused
  ...
  /// Removes and returns the tab at [index], mirroring VS Code's selection
  /// behaviour on close:
  ///   * closing the **active** tab selects the tab just before it;
