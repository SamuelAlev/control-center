    ...
    final cell = KeyedSubtree(
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          // Right-click selects the tab (VS Code parity) then opens its menu.
...
/// selected. Tapping closes the tab — the nested [GestureDetector] wins the tap
        ...
        child: DecoratedBox(
          ...
          child: Center(
            child: Icon(
              AppIcons.x,
              size: 13,
              color: _hovered ? t.fg : widget.color,
            ),
          ),
        ),
      ),
