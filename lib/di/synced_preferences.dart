...
List<SyncedPreference> buildSyncedPreferences() => [
  // Appearance.
  SyncedPreference(themeModeKey, onPulled: (ref) => ref.invalidate(themeModeProvider)),
  SyncedPreference(localeKey, onPulled: (ref) => ref.invalidate(localeProvider)),
  for (final key in const [
    ...
    SyncedPreference(key, onPulled: (ref) => ref.invalidate(fontSettingsProvider)),
