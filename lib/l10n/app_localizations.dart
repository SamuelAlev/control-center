...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Transcription, diarization, voice profiles, and meeting templates.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'API key stored — paste a new one to replace'**
  ...
  /// Locale string for settingsServerSharing
  ///
  /// In en, this message translates to:
  /// **'Sharing & remote access'**
  String get settingsServerSharing;
  ...
  ///
  /// In en, this message translates to:
  /// **'Which server this client talks to, and what it reports.'**
  String get settingsServerConnectionDescription;

  /// Locale string for settingsServerSharingDescription
  ///
  /// In en, this message translates to:
  /// **'Advertise this server on the local network or expose it through a tunnel.'**
