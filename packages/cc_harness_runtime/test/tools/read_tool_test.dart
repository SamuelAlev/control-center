...
void main() {
  ...
  group('ReadTool', () {
    ...
    test('did-you-mean covers the conversation worktrees', () async {
      ...
      final result = await ReadTool(fileSearch: _NoLinkFollowSearch()).execute(
      ...
      expect(result.isError, isTrue);
      expect(result.content, contains('Did you mean'));
      expect(result.content, contains('repos/myrepo/lib/editor_tab_bar.dart'));
    });
