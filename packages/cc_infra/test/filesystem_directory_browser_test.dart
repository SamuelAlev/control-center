...
void main() {
  group('FilesystemDirectoryBrowser', () {
    ...
    test(
      'lists subfolders sorted, flags git repos, hides dot-folders',
      () async {
        final browser = FilesystemDirectoryBrowser(allowedRoots: [root.path]);
    ...
    test('navigating into a subfolder exposes the parent', () async {
      ...
      final listing = await browser.browse(path: p.join(root.path, 'my-app'));
