...
void main() {
  ...
  test('accepts exact hash, validates structure and preserves executable mode', () async {
  ...
  test('embedded and distributed license notices stay byte-identical', () async {
    ...
    expect(installed, distributed);
    expect(sha256.convert(installed).toString(), kIosAutomationLicenseSha256);
