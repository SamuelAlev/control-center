...
/// can drive the supervision state machine. POSIX-only by construction (see
/// the @TestOn above): Windows cannot exec a shebang script, and the runner's
/// PATH `sh`/`bash` is the WSL stub with no distro installed.
