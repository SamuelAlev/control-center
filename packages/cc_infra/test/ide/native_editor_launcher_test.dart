...
import 'package:cc_infra/src/ide/native_editor_launcher.dart';
...
void main() {
  group('NativeEditorLauncher', () {
    ...
    group('macOS', () {
      ...
      test(
        'flags an installed app and leaves the rest not installed',
        () async {
    ...
    group('Linux', () {
      test(
        'detects a binary on PATH and opens it with the directory',
        () async {
          final calls = <List<Object?>>[];
          final launcher = NativeEditorLauncher(
