...
class _GeoIpTable {
  ...
  static _GeoIpTable decode() {
    final raw = gzip.decode(base64.decode(data.geoIpCountryBlob));
    final reader = ByteData.sublistView(Uint8List.fromList(raw));
    var offset = 0;
    ...
    offset += 2;
    final countries = [
      for (var i = 0; i < countryCount; i++) ascii(2),
    ];
