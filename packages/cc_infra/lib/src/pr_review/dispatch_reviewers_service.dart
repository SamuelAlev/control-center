...
class DispatchReviewersService implements DispatchReviewersPort {
  ...
  Future<Map<String, dynamic>> dispatch({
    ...
    final existingAgentIds = existingParticipants.map((p) => p.agentId).toSet();
  ...
  Future<String?> _resolveRepoPath(String workspaceId, String channelId) async {
    try {
      final convDir = await _fs.conversationDir(workspaceId, channelId);
      final repoDir = Directory('$convDir/repo');
