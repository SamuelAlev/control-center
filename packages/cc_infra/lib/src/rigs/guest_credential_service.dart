...
class _RigCredentialGrant {
  ...
  /// The member this rig was opened for; null for background work.
...
class GuestCredentialService {
  ...
  /// [actingUserId] is the member this rig was opened FOR.
  ///
  /// It is what the guest's credentials are minted against, and it matters
