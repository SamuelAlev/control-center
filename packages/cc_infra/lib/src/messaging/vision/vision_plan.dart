...
/// dropped (the newest are always kept) and [VisionPlan.truncatedRegions] is incremented.
library;
...
VisionPlan planArchive({
  ...
  var middleText = sourceText.substring(edgeCap, sourceText.length - edgeCap);
