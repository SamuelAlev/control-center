...
class GitHubGraphQLClient {
  ...
  /// PRs across [repos], using the same chunk/page sizes as
  /// [fetchOpenPullRequestsBatch]. Returns a map keyed by the caller's
  /// repo-input index, then by PR number, containing the raw `StatusState`
  /// string (or null when no checks are configured) and the raw
