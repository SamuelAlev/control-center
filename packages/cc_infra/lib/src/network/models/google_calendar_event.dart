...
/// distinct here — an all-day `date` is parsed as HOST-local midnight and
/// flagged via [isDate]; it must never be treated as a `00:00` timestamp for
/// alerting, and it leaves the host as a bare civil date (never an instant)
/// so a client in another timezone renders it on the same day.
