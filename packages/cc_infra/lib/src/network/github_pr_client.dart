...
class GitHubPrClient {
  ...
  Future<List<GitHubTimelineEvent>> listTimelineEvents(
    ...
    try {
      final response = await _dio.get(
        '$githubApiBaseUrl/repos/$owner/$repo/issues/$number/timeline',
        queryParameters: {'per_page': 100},
        cancelToken: cancelToken,
      );
  ...
  Future<List<GitHubCommitStatus>> listCommitStatuses(
    ...
    try {
      final response = await _dio.get(
        '$githubApiBaseUrl/repos/$owner/$repo/commits/$ref/status',
        queryParameters: {'per_page': 100},
        cancelToken: cancelToken,
      );
      final data = response.data;
  ...
  Future<List<GitHubJobRun>> listWorkflowRunJobs(
    ...
    try {
      final response = await _dio.get(
        '$githubApiBaseUrl/repos/$owner/$repo/actions/runs/$runId/jobs',
        queryParameters: {'per_page': 100},
        cancelToken: cancelToken,
      );
      final data = response.data;
  ...
  Future<GitHubJobRun?> getJobRun(
    ...
    try {
      final response = await _dio.get(
        '$githubApiBaseUrl/repos/$owner/$repo/actions/jobs/$jobId',
        cancelToken: cancelToken,
      );
  ...
  Future<GitHubWorkflowRun?> getWorkflowRun(
    ...
    try {
      final response = await _dio.get(
        '$githubApiBaseUrl/repos/$owner/$repo/actions/runs/$runId',
        cancelToken: cancelToken,
      );
  ...
  Future<({String text, bool truncated})?> getJobLogs(
    ...
    try {
      final head = await _dio.get<ResponseBody>(
        '$githubApiBaseUrl/repos/$owner/$repo/actions/jobs/$jobId/logs',
        options: Options(
      ...
      await for (final chunk in response.data!.stream) {
        ...
        if (buffer.length > maxBytes) {
          buffer.removeRange(0, buffer.length - maxBytes);
        }
      }
      return (
        text: utf8
  ...
  Future<List<String>> listBranches(
    ...
    try {
      while (true) {
        final response = await _dio.get(
          '$githubApiBaseUrl/repos/$owner/$repo/branches',
          queryParameters: {'per_page': 100, 'page': page},
          cancelToken: cancelToken,
        );
        final data = response.data;
  ...
  Future<GitHubBranchComparison> compareBranches(
    ...
    try {
      final response = await _dio.get(
        '$githubApiBaseUrl/repos/$owner/$repo/compare/$base...$head',
        cancelToken: cancelToken,
      );
      final data = response.data;
