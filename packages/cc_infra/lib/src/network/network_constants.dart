...
/// Base URL for the skills.sh registry API (PRD 23 §1). Only `cc_server` dials
/// it — clients reach the registry over the `skills.*` RPC ops.
const String skillsShApiBaseUrl = 'https://skills.sh/api';
...
/// endpoint.
const String slackApiBaseUrl = 'https://slack.com/api';
