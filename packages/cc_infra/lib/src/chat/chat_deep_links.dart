...
class ChatDeepLinks {
  ...
  /// Opens a space's transcript — the full record behind a relayed reply.
  String? space(String workspaceId, String spaceId) =>
      _url('workspaces/$workspaceId/spaces/$spaceId', [workspaceId, spaceId]);

  /// Opens a ticket.
  String? ticket(String workspaceId, String ticketId) => _url(
