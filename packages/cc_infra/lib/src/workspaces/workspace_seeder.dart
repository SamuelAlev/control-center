...
class WorkspaceSeeder {
  ...
  Future<void> seed(
    ...
    try {
      ...
      await seedBuiltInPipelineTemplates(
        ...
        onlyTemplateIds: onlyTemplateIds,
      );
  ...
  Future<void> seedBuiltInPipelineTemplates({
    ...
    for (final seed in builtInTemplateSeeds(
      ...
      // A narrowed reconcile (the public demo keeps exactly two templates)
      // must not re-add everything it skipped at seed time.
      if (!wanted(seed.templateId)) {
        continue;
      }
