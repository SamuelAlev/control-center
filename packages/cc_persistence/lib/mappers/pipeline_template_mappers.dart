...
PipelineDefinition pipelineDefinitionFromRow(PipelineTemplatesTableData row) {
      ...
      PipelineStepDefinition(
        ...
        config: node['config'] is Map<String, dynamic>
            ? PipelineNodeConfig.fromJson(
                node['config'] as Map<String, dynamic>,
              )
  ...
  final inputs = inputsRaw
      .map(
        (raw) => PipelineInput.fromJson((raw as Map).cast<String, dynamic>()),
      )
      .toList();
  ...
  return PipelineDefinition(
    ...
    maxParallelRuns: row.maxParallelRuns,
    version: row.version,
  );
}
...
PipelineTemplatesTableCompanion pipelineDefinitionToCompanion(
  ...
  return PipelineTemplatesTableCompanion(
    ...
    maxParallelRuns: Value(def.maxParallelRuns),
