...
class TicketMapper {
  ...
  TicketsTableCompanion toCompanion(Ticket t) {
    return TicketsTableCompanion(
      ...
      assigneeType: Value(t.assigneeType.wireName),
      createdByType: Value(t.createdByType?.wireName ?? 'system'),
      createdById: Value(t.createdById),
      assignedTeamId: Value(t.assignedTeamId),
      delegatedByAgentId: Value(t.delegatedByAgentId),
      delegationDepth: Value(t.delegationDepth),
      delegationRootTicketId: Value(t.delegationRootTicketId),
  ...
  Ticket fromRow(
    ...
    return Ticket(
      ...
      assigneeType:
          PrincipalType.fromWire(row.assigneeType) ?? PrincipalType.agent,
      createdByType: PrincipalType.fromWire(row.createdByType),
      createdById: row.createdById,
      assignedTeamId: row.assignedTeamId,
      delegatedByAgentId: row.delegatedByAgentId,
      delegationDepth: row.delegationDepth,
      delegationRootTicketId: row.delegationRootTicketId,
      spaceId: row.spaceId,
  ...
  TicketCollaboratorsTableCompanion collaboratorToCompanion(
    ...
    return TicketCollaboratorsTableCompanion(
      ...
      principalId: Value(c.principalId),
      collaboratorType: Value(c.collaboratorType.wireName),
  ...
  TicketCollaborator collaboratorFromRow(TicketCollaboratorsTableData row) {
    return TicketCollaborator(
      ...
      collaboratorType:
          PrincipalType.fromWire(row.collaboratorType) ?? PrincipalType.agent,
