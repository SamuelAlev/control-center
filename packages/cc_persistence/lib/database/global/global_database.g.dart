...
class $$UsersTableTableTableManager
    extends
        RootTableManager<
          ...
          UsersTableData,
          PrefetchHooks Function({bool userPreferencesTableRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({userPreferencesTableRefs = false}) {
...
class $$RssFeedsTableTableTableManager
    extends
        RootTableManager<
          ...
          RssFeedsTableData,
          PrefetchHooks Function({bool rssArticlesTableRefs})
        > {
    ...
    $RssFeedsTableTable table,
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({rssArticlesTableRefs = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [
