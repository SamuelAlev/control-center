...
class MeetingTranscriptSegmentsTable extends Table {
  ...
  /// Speaker space: `me` (microphone) or `them` (system audio).
  ...
  /// [speaker] space is always present; this refines the `them` (or in-person
  ...
  /// `meeting_speakers.display_name`). Set when the user renames a single
  ...
  /// voice-profile enrollment do survive (carried forward by `(space, label)`).
  ...
  @override
  String get tableName => 'meeting_transcript_segments';
