...
class MemoryDomainDao extends DatabaseAccessor<WorkspaceDatabase>
  ...
  Future<MemoryDomainsTableData?> findByName(String workspaceId, String name) =>
      (select(memoryDomainsTable)..where(
