...
class TicketLinkDao extends DatabaseAccessor<WorkspaceDatabase>
  ...
  Future<int> deleteById(String id, String workspaceId) => (delete(
    ticketLinksTable,
  )..where((l) => l.id.equals(id) & l.workspaceId.equals(workspaceId))).go();
