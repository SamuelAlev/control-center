...
/// Data access for per-conversation todo lists. Every read and mutation
/// filters by BOTH `workspaceId` and `conversationId` — an id-only query
/// would leak across conversations or workspaces.
