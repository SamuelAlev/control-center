...
class ActivityLogDao extends DatabaseAccessor<WorkspaceDatabase>
  ...
  /// first, capped at [limit] rows so a long-lived entity's history can't grow
  /// the streamed payload (and the widget rebuilding on it) without bound.
