...
void main() {
  ...
  test('toCompanion writes every kept column', () {
    ...
    expect(companion.spaceId.value, 'chan-1');
  ...
  test('round-trips through the database keeping all fields', () async {
    ...
    expect(restored.spaceId, ticket.spaceId);
  ...
  test('collaborator round-trips', () {
    ...
    expect(companion.principalId.value, 'a1');
    expect(companion.collaboratorType.value, 'agent');
