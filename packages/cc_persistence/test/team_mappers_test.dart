...
void main() {
  ...
  final memberEntityDefault = TeamMember(teamId: 'team-1', agentId: 'agent-99');

  group('teamToCompanion', () {
    test(
      'converts all fields with Value wrappers',
    ...
    test(
      'wraps null description in Value',
      timeout: const Timeout.factor(2),
      () {
  ...
  group('teamFromRow', () {
    test(
      'reconstructs Team from table row',
      timeout: const Timeout.factor(2),
      () {
  ...
  group('teamMemberToCompanion', () {
    test(
      'converts TeamMember with role serialization',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'serializes default member role as "member"',
      timeout: const Timeout.factor(2),
      () {
  ...
  group('teamMemberFromRow', () {
    test(
      'reconstructs TeamMember with role deserialization',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'falls back to member for unknown role strings',
      timeout: const Timeout.factor(2),
      () {
        const row = TeamMembersTableData(
          teamId: 'team-1',
  ...
  group('round-trip', () {
    ...
    test(
      ...
      () async {
        ...
        final original = TeamMember(teamId: 'rt-team', agentId: 'rt-agent-2');
