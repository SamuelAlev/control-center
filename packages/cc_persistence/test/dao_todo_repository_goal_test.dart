...
void main() {
  ...
  setUp(() async {
    ...
    // Seed the channels the goals FK-reference, each into its own workspace's
    // database file.
  ...
  group('DaoTodoRepository goals — setGoal', () {
    ...
    test('a goal in another conversation is invisible', () async {
  ...
  group('DaoTodoRepository goals — clearGoal', () {
    ...
    test('clearing one conversation leaves another intact', () async {
  ...
  group('DaoTodoRepository todo-list methods', () {
    ...
    test('clear removes every item in the conversation', () async {
      await repo.replaceAll('w-1', 'c-1', [
        TodoItem(
          id: 't-1',
          workspaceId: 'w-1',
