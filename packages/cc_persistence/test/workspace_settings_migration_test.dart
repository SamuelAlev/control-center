...
void main() {
  ...
  test('a v4 database reports the new schema version after opening', () async {
    ...
    // The file opens at the current schema, so it reports that — not the `5`
    // this step introduces. Pinned to the constant so appending a later step
    // does not make this a stale literal again.
    expect(
