...
///
/// This is the regression guard for the token pairings that carry the WCAG
/// floors: the functional accent (the brand's burnt orange, `brand850`
/// #B0370C) and the dark-theme `bgBrandPrimary` tint. If a token edit drops a
/// real pairing below its floor, this test fails with the exact ratio.
void main() {
  ...
  void checkTheme(String name, DesignSystemTokens t) {
    ...
    final pairings = <(String, Color, Color, double)>[
      ...
      (
        'white on bgSuccessSolidHover',
        t.textWhite,
        t.bgSuccessSolidHover,
        bodyFloor,
      ),
      (
        'white on bgErrorSolidHover',
        t.textWhite,
        t.bgErrorSolidHover,
        bodyFloor,
      ),
