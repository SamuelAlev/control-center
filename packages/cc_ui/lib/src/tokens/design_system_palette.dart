...
abstract final class DesignSystemPalette {
  ...
  /// 800/900). White on it clears 4.5:1 (5.9:1) and it clears 4.5:1 as colored
  /// text on the near-white canvas — unlike the bright signal brand600
  /// (#fa520f), which is reserved for the bounded brand graphics.
  static const Color brand850 = Color(0xFFB0390C);
  ...
  /// 4.5:1 on the dark field fill; gray500 was 4.2:1).
  ...
  /// 4.5:1 on canvas/surface/panel; gray500 was 3.5:1, sub-AA).
  ...
  /// near-white canvas for warn dots/icons (bright yellow500 was 1.9:1).
