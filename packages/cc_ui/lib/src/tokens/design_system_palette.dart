...
///
/// A few half-step shades (`brand850`, `gray450`, `gray550`, `yellow650`) are
/// accessibility-tuned interstitials added on top of the base scale so the
/// semantic tokens can hit the WCAG contrast floor without changing hue; each
/// documents the pairing it rescues.
abstract final class DesignSystemPalette {
  ...
  // design system; #fa500f is the canonical accent (600). Flame (#fb6224) is
  // the hover warm-up (500); burnt orange (#dc460d) is the pressed state (700);
  // block-edge (#c03e0f) terminates the brand mosaic (800).
  /// Brand 50 — faint orange tint (active-chip / brand-primary background).
  static const Color brand50 = Color(0xFFFEEFEA);

  /// Brand 100 — soft orange tint.
  static const Color brand100 = Color(0xFFFDDDD2);

  /// Brand 200 — light orange.
  static const Color brand200 = Color(0xFFFBC2AC);

  /// Brand 300 — orange.
  static const Color brand300 = Color(0xFFF89C78);

  /// Brand 400 — light flame.
  static const Color brand400 = Color(0xFFFD885C);

  /// Brand 500 — Flame (hover warm-up).
  static const Color brand500 = Color(0xFFFB6224);

  /// Brand 600 — Signal orange (the canonical accent).
  static const Color brand600 = Color(0xFFFA500F);

  /// Brand 700 — burnt orange (pressed / accent-active).
  static const Color brand700 = Color(0xFFDC460D);

  /// Brand 800 — block-edge (brand-mosaic terminus).
  static const Color brand800 = Color(0xFFC03E0F);

  /// Brand 850 — the accessible FUNCTIONAL accent (a11y-tuned step between
  /// 800/900). White on it clears 4.5:1 (6.2:1) and it clears 4.5:1 as colored
  /// text on the near-white canvas — unlike the bright signal brand600
  /// (#fa500f), which is reserved for the bounded brand graphics.
  static const Color brand850 = Color(0xFFB0370C);

  /// Brand 900 — deep burnt orange.
  static const Color brand900 = Color(0xFFA6360C);

  /// Brand 950 — darkest orange.
  static const Color brand950 = Color(0xFF7A2809);

  // Gray — warm-neutral ladder.
  ...
  /// Gray 450 — a11y placeholder/quaternary text on DARK surfaces (clears
  /// 4.5:1 on the dark field fill; gray500 is 4.2:1).
  static const Color gray450 = Color(0xFF9E978A);

  /// Gray 500 — placeholder / quaternary text (≈ idle).
  static const Color gray500 = Color(0xFF8C8578);

  /// Gray 550 — a11y placeholder/quaternary text on LIGHT surfaces (clears
  /// 4.5:1 on canvas/surface/panel; gray500 is 3.5:1, sub-AA).
  static const Color gray550 = Color(0xFF726C5E);
  ...
  /// Yellow 650 — a11y status gold: clears the 3:1 non-text floor on the
  /// near-white canvas for warn dots/icons (bright yellow500 is 1.9:1).
  static const Color yellow650 = Color(0xFFB8780A);
