...
/// Phosphor glyphs used by cc_ui (and gallery/tests). Owns Phosphor Regular
/// directly — no icon package (DDC stack-overflows linking ~1530-member
/// classes on web). Generated by `tool/gen_icon_seams.py`.
@staticIconProvider
