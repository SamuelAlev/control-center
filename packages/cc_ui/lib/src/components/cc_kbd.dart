...
// Static-only by design: a namespace for platform-resolved key GLYPHS, not a
// thing to instantiate. `abstract final` already prevents both construction
// and subclassing, which is exactly what the lint asks you to consider.
