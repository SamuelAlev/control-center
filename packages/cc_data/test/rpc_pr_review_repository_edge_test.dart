...
/// Edge-case coverage for [RpcPrReviewRepository] and [RpcVcsProviderFactory]
...
void main() {
  ...
  group('RpcVcsProviderFactory', () {
    test('reports the GitHub VCS host', () {
      expect(RpcVcsProviderFactory(client).host, VcsHost.github);
    });
