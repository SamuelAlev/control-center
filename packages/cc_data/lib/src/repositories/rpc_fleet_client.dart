...
class FleetWorkerView {
  ...
  factory FleetWorkerView.fromWire(Map<String, dynamic> w) {
    ...
    return FleetWorkerView(
      ...
      status: WorkerStatus.fromWire(w['status'] as String? ?? 'offline'),
  ...
  /// Lifecycle status. Parsed at the wire boundary (an unknown value reads as
  /// [WorkerStatus.offline]) so no UI switches over a raw string.
