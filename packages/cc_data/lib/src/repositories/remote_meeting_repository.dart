import 'package:cc_data/src/repositories/rpc_meeting_repository.dart'
    show RpcMeetingRepository;
...
class RemoteMeetingRepository {
  ...
  /// A single meeting by id (scoped by the `workspace_id` the request carries), or
  ...
  /// title-adoption step).
  Future<void> updateTitle(String meetingId, String title) => _client.call(
    'meeting.updateTitle',
  ...
  Future<void> updateNotes(String meetingId, String notes) => _client.call(
    'meeting.updateNotes',
    {'meeting_id': meetingId, 'notes': notes},
  );
  ...
  Future<void> setActionItemDone({required String id, required bool done}) =>
  ...
  Future<void> updateDecision({required String id, required String content}) =>
