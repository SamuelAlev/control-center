...
class RpcPipelineTemplateRepository implements PipelineTemplateRepository {
  ...
  static PipelineStepDefinition _stepFromDto(Map<String, dynamic> s) =>
      PipelineStepDefinition(
        id: s['id'] as String,
        kind: _stepKindByName[s['kind'] as String?] ?? StepKind.listen,
  ...
  static PipelineTemplateDto _toDto(PipelineDefinition d) =>
      PipelineTemplateDto(
        templateId: d.templateId,
        workspaceId: d.workspaceId,
        name: d.name,
...
final Map<String, StepKind> _stepKindByName = StepKind.values.asNameMap();
