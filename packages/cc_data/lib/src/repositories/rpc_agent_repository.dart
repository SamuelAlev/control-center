...
class RpcAgentRepository implements AgentRepository {
  ...
  static Agent _fromDto(AgentDto d) => Agent(
    ...
    visibility: AgentVisibility.fromStorage(d.visibility),
    lifecycleStatus: AgentLifecycleStatus.fromStorage(d.lifecycleStatus),
    budgetPolicyId: d.budgetPolicyId,
    runtimeProfileId: d.runtimeProfileId,
  ...
  static AgentDto _toDto(Agent a) => AgentDto(
    ...
    lifecycleStatus: a.lifecycleStatus.name,
    budgetPolicyId: a.budgetPolicyId,
    runtimeProfileId: a.runtimeProfileId,
