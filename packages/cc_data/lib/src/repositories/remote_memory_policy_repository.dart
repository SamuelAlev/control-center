...
class RemoteMemoryPolicyRepository {
  ...
  /// A single policy by id (scoped by the `workspace_id` the request carries), or null.
  ...
  Stream<List<MemoryPolicyDto>> watch() => _client
      .subscribe('memory_policy.watchForWorkspace', const {})
      .map(_policies);
