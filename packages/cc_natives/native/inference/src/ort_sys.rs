...
//!
//! ```sh
//! curl -sLO https://raw.githubusercontent.com/microsoft/onnxruntime/v1.27.1/include/onnxruntime/core/session/onnxruntime_c_api.h
//! curl -sLO https://raw.githubusercontent.com/microsoft/onnxruntime/v1.27.1/include/onnxruntime/core/session/onnxruntime_ep_c_api.h
//! curl -sLO https://raw.githubusercontent.com/microsoft/onnxruntime/v1.27.1/include/onnxruntime/core/session/onnxruntime_float16.h
...
//! ```
//!
//! Header version 1.27.1 = the ONNX Runtime STATICALLY LINKED into this cdylib
//! by the sherpa-onnx prebuilt archive (verified: `strings libonnxruntime.a`
//! reports 1.27.1 and `_OrtGetApiBase` is a defined global there). Because the
...
pub enum OrtExternalMemoryHandleType {
    ...
    #[doc = "< Shared HANDLE from vkGetMemoryWin32HandleKHR, non-dedicated allocation"]
    ORT_EXTERNAL_MEMORY_HANDLE_TYPE_VK_MEMORY_WIN32 = 2,
    #[doc = "< File descriptor from vkGetMemoryOpaqueFdKHR, non-dedicated allocation"]
