//! ONNX Runtime C API bindings — GENERATED, DO NOT EDIT BY HAND.
//!
//! Regenerate with (see PROVENANCE.md for the full recipe):
//!
//! ```sh
//! curl -sLO https://raw.githubusercontent.com/microsoft/onnxruntime/v1.28.2/include/onnxruntime/core/session/onnxruntime_c_api.h
//! curl -sLO https://raw.githubusercontent.com/microsoft/onnxruntime/v1.28.2/include/onnxruntime/core/session/onnxruntime_ep_c_api.h
//! curl -sLO https://raw.githubusercontent.com/microsoft/onnxruntime/v1.28.2/include/onnxruntime/core/session/onnxruntime_float16.h
...
//! ```
//!
//! Header version 1.28.2 = the ONNX Runtime STATICALLY LINKED into this cdylib
//! by the sherpa-onnx prebuilt archive (verified: `strings libonnxruntime.a`
//! reports 1.28.2 and `_OrtGetApiBase` is a defined global there). Because the
//! header and the object code come from the same upstream release there is no
//! version skew to reason about — unlike a dynamically loaded runtime, nothing
//! can substitute a different ONNX Runtime underneath us at run time.
//!
//! `OrtApi` is append-only across ONNX Runtime versions, so a future archive
//! bump keeps these offsets valid; regenerate anyway so newly added entry
//! points are reachable and the doc comments stay truthful.
//!
//! GENERATED ON macOS: `CreateSession`'s `model_path` is typed `*const c_char`
//! here, but the C declaration is `const ORTCHAR_T*` — which is `wchar_t*` on
//! Windows. `embed.rs` therefore encodes the path as UTF-16 on Windows and
//! casts the pointer; never pass a Rust `CString` path straight through on that
//! platform. See `embed.rs::model_path_arg`.
...
pub const ORT_API_VERSION: u32 = 28;
#[repr(u32)]
...
pub struct OrtAllocator {
 ...
 \since 1.25*/
    pub Shrink: ::std::option::Option<
        unsafe extern "C" fn(this_: *mut OrtAllocator) -> OrtStatusPtr,
    >,
}
...
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum OrtDeviceEpIncompatibilityReason {
...
pub type OrtThreadWorkerFn = ::std::option::Option<
    unsafe extern "C" fn(ort_worker_fn_param: *mut ::std::os::raw::c_void),
>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type OrtCustomJoinThreadFn = ::std::option::Option<
    unsafe extern "C" fn(ort_custom_thread_handle: OrtCustomThreadHandle),
>;
...
/** \brief External memory handle type for importing GPU resources.
 ...
 \since Version 1.24.*/
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum OrtExternalMemoryHandleType {
...
/** \brief External semaphore type for GPU synchronization.
 ...
 \since Version 1.24.*/
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum OrtExternalSemaphoreType {
...
pub struct OrtApi {
 ...
 \return OrtErrorCode that \p status was created with*/
    pub GetErrorCode: ::std::option::Option<
        unsafe extern "C" fn(status: *const OrtStatus) -> OrtErrorCode,
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    pub EnableTelemetryEvents: ::std::option::Option<
        unsafe extern "C" fn(env: *const OrtEnv) -> OrtStatusPtr,
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    pub DisableTelemetryEvents: ::std::option::Option<
        unsafe extern "C" fn(env: *const OrtEnv) -> OrtStatusPtr,
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    pub CreateRunOptions: ::std::option::Option<
        unsafe extern "C" fn(out: *mut *mut OrtRunOptions) -> OrtStatusPtr,
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    pub RunOptionsSetTerminate: ::std::option::Option<
        unsafe extern "C" fn(options: *mut OrtRunOptions) -> OrtStatusPtr,
    >,
 ...
 @{*/
    pub ReleaseStatus: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtStatus),
    >,
    /** @}
 \name OrtMemoryInfo
 @{*/
    pub ReleaseMemoryInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtMemoryInfo),
    >,
    /** @}
 \name OrtSession
 @{*/
    pub ReleaseSession: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtSession),
    >,
    /** @}
 \name OrtValue
 @{*/
 ...
 @{*/
    pub ReleaseRunOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtRunOptions),
    >,
    /** @}
 \name OrtTypeInfo
 @{*/
    pub ReleaseTypeInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtTypeInfo),
    >,
    /** @}
 \name OrtTensorTypeAndShapeInfo
 @{*/
    pub ReleaseTensorTypeAndShapeInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtTensorTypeAndShapeInfo),
    >,
    /** @}
 \name OrtSessionOptions
 @{*/
    pub ReleaseSessionOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtSessionOptions),
    >,
    /** @}
 \name OrtCustomOpDomain
 @{*/
    pub ReleaseCustomOpDomain: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtCustomOpDomain),
    >,
 ...
 @{*/
    pub ReleaseMapTypeInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtMapTypeInfo),
    >,
    /** @}
 \name OrtSequenceTypeInfo
 @{*/
    pub ReleaseSequenceTypeInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtSequenceTypeInfo),
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    ...
    >,
    pub ReleaseModelMetadata: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtModelMetadata),
    >,
    /** \brief Create an OrtEnv
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    ...
    >,
    pub ReleaseThreadingOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtThreadingOptions),
    >,
    /** \param[in] model_metadata
 \param[in] allocator
...
*/
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    ...
    pub ReleaseAllocator: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtAllocator),
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    ...
    pub ReleaseIoBinding: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtIoBinding),
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    ...
    pub ClearBoundInputs: ::std::option::Option<
        unsafe extern "C" fn(binding_ptr: *mut OrtIoBinding),
    >,
    /// \brief Clears any previously set Outputs for an ::OrtIoBinding
    pub ClearBoundOutputs: ::std::option::Option<
        unsafe extern "C" fn(binding_ptr: *mut OrtIoBinding),
    >,
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value*/
    ...
    >,
    pub ReleaseArenaCfg: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtArenaCfg),
    >,
 ...
 \note instance must not be released until the sessions using it are released*/
    pub ReleasePrepackedWeightsContainer: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtPrepackedWeightsContainer),
    >,
 ...
 \note This is an exception in the naming convention of other Release* functions, as the name of the method does not have the V2 suffix, but the type does*/
    pub ReleaseTensorRTProviderOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtTensorRTProviderOptionsV2),
    >,
 ...
 \since Version 1.11.*/
    pub ReleaseCUDAProviderOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtCUDAProviderOptionsV2),
    >,
...
Number of elements if data represents an array (e.g., ORT_OP_ATTR_INTS). Otherwise, set to 1.
 ...
 \since Version 1.12.*/
    ...
    >,
    pub ReleaseOpAttr: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtOpAttr),
    >,
...
     where op_type is the name of the operation, op_package_path is the path to the op package shared library,
 ...
 \since Version 1.12.*/
    ...
    pub ReleaseKernelInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtKernelInfo),
    >,
    ...
    pub GetTrainingApi: ::std::option::Option<
        unsafe extern "C" fn(version: u32) -> *const OrtTrainingApi,
    >,
 ...
 \since Version 1.13.*/
    pub ReleaseCANNProviderOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtCANNProviderOptions),
    >,
 ...
 \since Version 1.15.*/
    pub ReleaseDnnlProviderOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtDnnlProviderOptions),
    >,
 ...
 \since Version 1.15.*/
    pub GetBuildInfoString: ::std::option::Option<
        unsafe extern "C" fn() -> *const ::std::os::raw::c_char,
    >,
 ...
 \since Version 1.16.*/
    pub ReleaseROCMProviderOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtROCMProviderOptions),
    >,
 ...
 \since Version 1.20.*/
    ...
    pub ReleaseLoraAdapter: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtLoraAdapter),
    >,
 ...
 \since Version 1.22.*/
    pub ReleaseValueInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtValueInfo),
    >,
 ...
 \since Version 1.22.*/
    pub GetModelEditorApi: ::std::option::Option<
        unsafe extern "C" fn() -> *const OrtModelEditorApi,
    >,
 ...
 \since Version 1.22.*/
    pub GetCompileApi: ::std::option::Option<
        unsafe extern "C" fn() -> *const OrtCompileApi,
    >,
 ...
 \since Version 1.22.*/
    pub CreateKeyValuePairs: ::std::option::Option<
        unsafe extern "C" fn(out: *mut *mut OrtKeyValuePairs),
    >,
 ...
 \since Version 1.22.*/
    pub ReleaseKeyValuePairs: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtKeyValuePairs),
    >,
 ...
 \since Version 1.22.*/
    pub HardwareDevice_VendorId: ::std::option::Option<
        unsafe extern "C" fn(device: *const OrtHardwareDevice) -> u32,
    >,
 ...
 \since Version 1.22.*/
    pub HardwareDevice_DeviceId: ::std::option::Option<
        unsafe extern "C" fn(device: *const OrtHardwareDevice) -> u32,
    >,
 ...
 \since Version 1.23*/
    pub MemoryInfoGetVendorId: ::std::option::Option<
        unsafe extern "C" fn(ptr: *const OrtMemoryInfo) -> u32,
    >,
...
Must be freed with OrtApi::ReleaseValue.
 ...
 \since Version 1.23.*/
    pub ReleaseExternalInitializerInfo: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtExternalInitializerInfo),
    >,
 ...
 \since Version 1.23.*/
    pub ExternalInitializerInfo_GetFileOffset: ::std::option::Option<
 ...
 \since Version 1.23*/
    ...
    >,
    pub ReleaseSyncStream: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtSyncStream),
    >,
 ...
 \since Version 1.23.*/
    ...
    pub TensorTypeAndShape_HasShape: ::std::option::Option<
        unsafe extern "C" fn(info: *const OrtTensorTypeAndShapeInfo) -> bool,
    >,
 ...
 \since Version 1.24.*/
    pub GetInteropApi: ::std::option::Option<
        unsafe extern "C" fn() -> *const OrtInteropApi,
    >,
 ...
 \since Version 1.24.*/
    pub ReleaseDeviceEpIncompatibilityDetails: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtDeviceEpIncompatibilityDetails),
    >,
 ...
 \since Version 1.25.*/
    pub RunOptionsDisableProfiling: ::std::option::Option<
        unsafe extern "C" fn(options: *mut OrtRunOptions) -> OrtStatusPtr,
    >,
...
pub struct OrtCustomOp {
    ...
    >,
    pub GetInputTypeCount: ::std::option::Option<
    ...
    >,
    pub GetOutputTypeCount: ::std::option::Option<
        unsafe extern "C" fn(op: *const OrtCustomOp) -> usize,
    >,
    ...
    >,
    pub KernelDestroy: ::std::option::Option<
        unsafe extern "C" fn(op_kernel: *mut ::std::os::raw::c_void),
    >,
...
pub struct OrtModelEditorApi {
 ...
 \snippet{doc} snippets.dox OrtStatus Return Value
 \since Version 1.22.*/
    pub CreateGraph: ::std::option::Option<
        unsafe extern "C" fn(graph: *mut *mut OrtGraph) -> OrtStatusPtr,
    >,
...
pub struct OrtCompileApi {
 ...
 @{*/
    pub ReleaseModelCompilationOptions: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtModelCompilationOptions),
    >,
...
pub struct OrtInteropApi {
 ...
 \since Version 1.24.*/
    pub ReleaseExternalResourceImporter: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtExternalResourceImporter),
    >,
 ...
 \since Version 1.24.*/
    pub ReleaseExternalMemoryHandle: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtExternalMemoryHandle),
    >,
 ...
 \since Version 1.24.*/
    pub ReleaseExternalSemaphoreHandle: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtExternalSemaphoreHandle),
    >,
 ...
 \since Version 1.25.*/
    pub DeinitGraphicsInteropForEpDevice: ::std::option::Option<
        unsafe extern "C" fn(ep_device: *const OrtEpDevice) -> OrtStatusPtr,
    >,
}
#[repr(C)]
#[derive(Debug)]
...
pub struct OrtExternalMemoryHandle {
 ...
 should cast the handle to its derived type and delete it.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(handle: *mut OrtExternalMemoryHandle),
    >,
}
...
pub struct OrtExternalSemaphoreHandle {
 ...
 should cast the handle to its derived type and delete it.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(handle: *mut OrtExternalSemaphoreHandle),
    >,
}
#[repr(C)]
#[derive(Debug)]
...
pub struct OrtDataTransferImpl {
 ...
 \since Version 1.23.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtDataTransferImpl),
    >,
...
pub struct OrtSyncNotificationImpl {
 ...
 \since Version 1.23.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtSyncNotificationImpl),
    >,
...
pub struct OrtSyncStreamImpl {
 ...
 \since Version 1.23.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtSyncStreamImpl),
    >,
...
pub struct OrtExternalResourceImporterImpl {
 ...
 \since Version 1.24.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtExternalResourceImporterImpl),
    >,
}
#[repr(u32)]
/** \brief The event category for profiling events reported by an execution provider.
 ...
 \since Version 1.25.*/
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum OrtProfilingEventCategory {
    ///< Session-level event
...
pub struct OrtEpProfilerImpl {
 ...
 \since Version 1.25.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtEpProfilerImpl),
    >,
...
pub struct OrtKernelImpl {
 ...
 \since Version 1.24.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtKernelImpl),
    >,
...
pub struct OrtLoopKernelHelper {
 ...
 \since Version 1.24.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtLoopKernelHelper),
    >,
...
pub struct OrtScanKernelHelper {
 ...
 \since Version 1.24.*/
    pub Release: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtScanKernelHelper),
    >,
...
pub struct OrtEpApi {
 ...
 \since Version 1.22.*/
    ...
    >,
    pub ReleaseEpDevice: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtEpDevice),
    >,
 ...
 \since Version 1.23.*/
    pub MemoryDevice_AreEqual: ::std::option::Option<
        unsafe extern "C" fn(
            a: *const OrtMemoryDevice,
            b: *const OrtMemoryDevice,
        ) -> bool,
    >,
 ...
 \since Version 1.23.*/
    pub MemoryDevice_GetVendorId: ::std::option::Option<
        unsafe extern "C" fn(memory_device: *const OrtMemoryDevice) -> u32,
    >,
 ...
 \since Version 1.23.*/
    pub MemoryDevice_GetDeviceId: ::std::option::Option<
        unsafe extern "C" fn(memory_device: *const OrtMemoryDevice) -> u32,
    >,
 ...
 \since Version 1.23.*/
    pub SyncStream_GetSyncId: ::std::option::Option<
        unsafe extern "C" fn(stream: *const OrtSyncStream) -> u64,
    >,
 ...
 \since Version 1.24.*/
    ...
    >,
    pub ReleaseHardwareDevice: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtHardwareDevice),
    >,
 ...
 \since Version 1.24.*/
    pub CreateKernelRegistry: ::std::option::Option<
        unsafe extern "C" fn(
            kernel_registry: *mut *mut OrtKernelRegistry,
        ) -> OrtStatusPtr,
    >,
    pub ReleaseKernelRegistry: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtKernelRegistry),
    >,
 ...
 \since Version 1.24.*/
    pub CreateKernelDefBuilder: ::std::option::Option<
        unsafe extern "C" fn(
            kernel_def_builder_out: *mut *mut OrtKernelDefBuilder,
        ) -> OrtStatusPtr,
    >,
    pub ReleaseKernelDefBuilder: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtKernelDefBuilder),
    >,
 ...
 \since Version 1.24.*/
    ...
    >,
    pub ReleaseKernelDef: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtKernelDef),
    >,
 ...
 \since Version 1.24*/
    ...
    >,
    pub ReleaseKernelImpl: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtKernelImpl),
    >,
 ...
 \since Version 1.25.*/
    ...
    >,
    pub ReleaseOpSchema: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtOpSchema),
    >,
 ...
 \since Version 1.25.*/
    pub ReleaseProfilingEvent: ::std::option::Option<
        unsafe extern "C" fn(input: *mut OrtProfilingEvent),
    >,
...
impl OrtEpDataLayout {
    pub const OrtEpDataLayout_Default: OrtEpDataLayout = OrtEpDataLayout::OrtEpDataLayout_NCHW;
}
#[repr(u32)]
...
/** \brief Node assignment policies for graph capture validation.
 ...
 \since Version 1.26.*/
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum OrtGraphCaptureNodeAssignmentPolicy {
...
pub struct OrtEp {
 ...
 \since Version 1.25.*/
    pub Sync: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtEp) -> OrtStatusPtr,
    >,
 ...
 **ORT graph capture/replay summary:**
 ...
 \since Version 1.26.*/
    pub IsGraphCaptureEnabled: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *const OrtEp) -> bool,
    >,
 ...
 \since Version 1.27.*/
    pub OnSessionInitializationEnd: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtEp) -> OrtStatusPtr,
    >,
...
pub struct OrtEpFactory {
 ...
 \since Version 1.22.*/
    pub ReleaseEp: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *mut OrtEpFactory, ep: *mut OrtEp),
    >,
 ...
 \since Version 1.23.*/
    pub GetVendorId: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *const OrtEpFactory) -> u32,
    >,
 ...
 \since Version 1.23.*/
    pub IsStreamAware: ::std::option::Option<
        unsafe extern "C" fn(this_ptr: *const OrtEpFactory) -> bool,
    >,
