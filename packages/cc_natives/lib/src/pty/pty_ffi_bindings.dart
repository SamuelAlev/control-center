...
class PtyBindings {
  PtyBindings(ffi.DynamicLibrary dynamicLibrary)
  ...
  late final Dart_InitializeApiDL =
      _lookup<ffi.NativeFunction<ffi.IntPtr Function(ffi.Pointer<ffi.Void>)>>(
        'Dart_InitializeApiDL',
      ).asFunction<int Function(ffi.Pointer<ffi.Void>)>();

  late final pty_create =
      _lookup<
            ffi.NativeFunction<
