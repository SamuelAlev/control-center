...
abstract class FileSearch {
  ...
  ///
  /// [offset] skips the first N ranked results (page paging). Implementations
  /// that rank over the full set treat it as an exact slice of the ranked
  /// list, so consecutive pages are disjoint and their union is the un-paged
  /// result set.
