...
///   3. query asset                `assets/code_index/queries/<queryId>.scm`
///      (via [queryIdFor], so `tsx` can reuse the `typescript` query).
///
/// Adding a language = add its extensions here + a grammar lib + a `.scm`.
library;
