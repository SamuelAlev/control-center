...
class _RecordingMessaging implements MessagingRepository {
  ...
  final List<({String workspaceId, String channelId, Mode mode})> flips = [];
  ...
  Future<void> setChannelMode(
    ...
    Mode mode,
      ...
      flips.add((workspaceId: workspaceId, channelId: channelId, mode: mode));
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      expect(messaging.flips.single.channelId, 'chan-1');
