...
class ListFeedsTool extends McpTool {
  /// Creates a [ListFeedsTool] backed by [repository] (list all RSS feeds).
...
class ListArticlesTool extends McpTool {
  /// Creates a [ListArticlesTool] backed by [repository] (list RSS articles).
...
class GetArticleTool extends McpTool {
  /// Creates a [GetArticleTool] backed by [repository] (fetch one article).
...
class SetArticleReadTool extends McpTool {
  /// Creates a [SetArticleReadTool] backed by [repository] (mark an article read/unread).
...
class SetArticleSavedTool extends McpTool {
  /// Creates a [SetArticleSavedTool] backed by [repository] (save/unsave an article).
...
class RefreshFeedsTool extends McpTool {
  /// Creates a [RefreshFeedsTool] backed by [repository] (refresh all feeds).
