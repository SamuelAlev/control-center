...
/// (skill matching, concurrency, space participant management) lives in
/// exactly one place.
class DispatchReviewersTool extends McpTool {
  ...
  String get description =>
      'Spawn reviewer subagents in parallel for a review space. Each spec '
  ...
  Map<String, dynamic> get inputSchema => {
    ...
    'required': ['space_id', 'workspace_id', 'reviewers'],
  };
