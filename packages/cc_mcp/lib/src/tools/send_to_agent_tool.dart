...
/// space between the two agents is reused (or created), the message is
...
class SendToAgentTool extends McpTool {
  /// Creates a [SendToAgentTool]. [eventBus] lets a freshly minted DM space
  ...
  String get description =>
      ...
      'is delivered into a shared agent-to-agent DM space and the recipient '
  ...
  Future<CallResult> run(Map<String, dynamic> arguments) async {
    ...
    // means it could not be dispatched now (the message stays in the space).
