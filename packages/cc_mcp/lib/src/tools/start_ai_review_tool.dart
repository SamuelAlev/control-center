...
class StartAiReviewTool extends McpTool {
  ...
  Map<String, dynamic> get inputSchema => {
    ...
    'properties': {
      ...
      'pr_node_id': {'type': 'string', 'description': 'The GitHub PR node ID.'},
    ...
    'required': ['workspace_id', 'pr_node_id', 'pr_number', 'repo_full_name'],
  };
  ...
  Future<CallResult> run(Map<String, dynamic> arguments) async {
    ...
    return CallResult.success(
      jsonEncode({'pipeline_run_id': run.id, 'status': 'started'}),
    );
  }
}
