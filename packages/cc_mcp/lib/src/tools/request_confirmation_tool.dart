...
class RequestConfirmationTool extends McpTool {
  ...
  Map<String, dynamic> get inputSchema => {
    ...
    'properties': {
      'workspace_id': {
        'type': 'string',
        'description': 'The workspace owning the conversation.',
      },
      'channel_id': {
        'type': 'string',
        'description':
    ...
    'required': ['workspace_id', 'channel_id', 'title', 'description'],
  };
  ...
  Future<CallResult> run(Map<String, dynamic> arguments) async {
    ...
    final answer = await _questionPort.ask(
    ...
    return CallResult.success(
      approved ? 'The user APPROVED: $title' : 'The user REJECTED: $title',
    );
  }
}
