...
class ServerIdentityProbe {
  ...
  /// Whether this is a PUBLIC DEMO server: fictional data, scripted agents and
  /// no execution surface.
  ///
  /// Probed BEFORE connecting, which is the point — the client decides whether
  /// to show its demo shell from the same `/healthz` fetch it already makes to
  /// resolve reachability, rather than inventing a second way to ask.
  /// Defaults to false, so every existing server is unaffected.
  final bool demo;
}
