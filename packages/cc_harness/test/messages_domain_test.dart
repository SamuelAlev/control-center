...
void main() {
  ...
  group('HarnessToolUseBlock', () {
    ...
    test('equality is by id + name (input ignored by design)', () {
      // input is deliberately excluded from equality (see source comment).
      const same = HarnessToolUseBlock(id: 'tu1', name: 'search', input: {});
      expect(block, same);
