...
The **MCP client**: Control Center as a _consumer_ of external MCP servers. It
...
> Direction matters: `cc_mcp` is the tool surface CC _exposes_; `cc_mcp_client`
> (this package) is CC _connecting out_ to other servers.
