...
///
/// Id minting lives here so every principal (UI, extraOp, test) shares one
/// chokepoint. Owner membership is recorded by the `workspace.create` RPC
/// handler, not this use case — membership is an identity concern.
