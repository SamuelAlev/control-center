/// Default markdown definition used to seed the built-in CEO agent.
...
/// Title the built-in CEO agent is seeded with.
///
/// Named rather than inlined at the creation site because "reset to default"
/// has to be able to restore exactly what seeding wrote — two copies of the
/// string is two chances for a reset to quietly change the title.
const ceoAgentTitle = 'Chief Executive Officer';

/// Skill slugs that should always be linked to the built-in CEO agent.
const ceoSkillSlugs = [
  'strategy',
  'coordination',
  'decision-making',
...
/// Markdown content used to seed each built-in CEO skill file by slug.
