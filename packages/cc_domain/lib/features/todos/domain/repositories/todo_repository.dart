...
/// isolation boundary) and a `conversationId` (the conversation the list
/// belongs to). Neither is ever optional or implicitly resolved — a foreign
/// row must simply not be found.
