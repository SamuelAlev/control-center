...
/// (assembled from models.dev), provider-governance policy, a small-model
/// router and usage/quota tracking. No `dart:io` / `drift` / `dio` / Flutter —
/// every piece is unit testable in isolation.
library;
