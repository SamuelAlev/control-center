...
/// A recorded snapshot of one limit at one point in time (the time-series).
class UsageHistoryEntry {
  /// Creates a [UsageHistoryEntry].
  ...
  /// Stable credential identity (email / project / key fingerprint).
  final String accountKey;

  /// Which window this snapshot is for.
  ...
  /// Window label, if windowed.
  final String? windowLabel;

  /// Used fraction at snapshot time.
  final double? usedFraction;
