...
enum SkillOrigin {
  ...
  /// Legacy: resolved from the old skills.sh registry. No new install carries
  /// this origin (sources are GitHub now); kept so pre-existing lock files
  /// still parse and display honestly.
  registry;
