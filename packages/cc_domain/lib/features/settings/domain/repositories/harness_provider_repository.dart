...
abstract interface class HarnessProviderRepository {
  ...
  /// Removes the stored credential for [providerId] (or a specific account).
  /// For a custom provider this drops only the key — the provider itself
  /// survives until [removeCustomProvider].
