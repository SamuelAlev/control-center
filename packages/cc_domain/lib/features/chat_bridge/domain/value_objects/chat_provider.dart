...
/// a Slack thread can never resolve a Discord conversation's channel.
///
...
enum ChatProvider {
  ...
  /// The origin a channel bridged from this provider is created with.
  ///
  /// Exhaustive on purpose: a new provider does not compile until it has an
  /// origin, which is what keeps a bridged channel from looking like an ordinary
  /// one to mirroring, badging and retention.
  ChannelOrigin get channelOrigin => switch (this) {
    ChatProvider.slack => ChannelOrigin.slack,
  };
}
