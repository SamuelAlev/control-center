...
/// Persistence for external conversation ↔ Control Center space links.
///
...
/// conversations.
abstract interface class ChatSpaceLinkRepository {
  /// Inserts or updates a link (idempotent on the external tuple).
  Future<void> upsert(ChatSpaceLink link);
  ...
  /// The link whose Control Center space is [ccSpaceId], or null. The
  /// reverse direction: where an agent turn in this space should stream to.
  Future<ChatSpaceLink?> forCcSpace(String workspaceId, String ccSpaceId);
