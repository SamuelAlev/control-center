...
/// Reads a finite number from [args] at [key], or null when missing, not a
/// number, or not finite.
///
/// Separate from [rigOptInt] because a display scale is genuinely fractional
/// (1.5 and 2.75 are both real device pixel ratios), and rounding one to an
/// int is the difference between a sharp guest and a blurry one.
double? rigOptDouble(Map<String, dynamic> args, String key) {
  final v = args[key];
