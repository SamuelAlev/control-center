  ...
  static RigActionParse parse(Map<String, dynamic> args) {
    ...
    switch (verb) {
      ...
      case 'set_viewport':
        ...
        return RigActionParsed(
          BrowserSetViewport(
            size: RigDisplaySize(width, height).clampedForNegotiation(),
...
class BrowserSetViewport extends BrowserAction {
  ...
  const BrowserSetViewport({required this.size, this.mobile = false});
  ...
  @override
  String get summary => 'Set the viewport to $size${mobile ? " (mobile)" : ""}';
}
