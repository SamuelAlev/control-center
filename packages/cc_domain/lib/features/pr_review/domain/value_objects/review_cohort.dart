...
class ReviewCohort {
  ...
  const ReviewCohort({
    ...
    this.layers = const [],
    this.diagrams = const [],
    this.insights = CohortInsights.empty,
    this.headSha,
  ...
  /// The PR (space node) this cohort belongs to.
  ...
  /// Deterministic enrichments computed with this cohort: which symbols the
  /// diff touched and which test files cover them.
  ...
  factory ReviewCohort.fromJson(Map<String, dynamic> json) => ReviewCohort(
    ...
    diagrams: (json['diagrams'] as List? ?? const [])
        ...
        .toList(),
    insights: CohortInsights.fromJson(
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (!insights.isEmpty) 'insights': insights.toJson(),
