...
class PrFile {
  ...
  PrFile({
    ...
    if (filename.isEmpty) {
      throw ArgumentError('PrFile filename must not be empty');
    }
  }
  ...
  /// Whether this file is a Markdown document (eligible for a rendered preview
  /// toggle in the diff). `.mdx` is deliberately excluded.
  bool get isMarkdown {
    final e = extension;
