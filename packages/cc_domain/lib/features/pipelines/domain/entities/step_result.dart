...
class StepResult {
  ...
  factory StepResult.route(
    String nextRouterKey, {
  ...
  factory StepResult.suspendUntilEvent(
    String eventType, {
    Map<String, dynamic>? mutatedState,
  }) => StepResult._(mutatedState: mutatedState, suspendUntilEvent: eventType);

  /// Suspend the step until all listed tasks reach terminal state.
  /// Reserved for Phase 3 (Tasks layer).
  factory StepResult.suspendUntilTasksComplete(
    List<String> taskIds, {
    Map<String, dynamic>? mutatedState,
  }) => StepResult._(mutatedState: mutatedState, suspendUntilTaskIds: taskIds);
