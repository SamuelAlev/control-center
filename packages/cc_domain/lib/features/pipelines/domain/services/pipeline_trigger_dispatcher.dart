  ...
  Future<void> _onEvent(DomainEvent event) async {
    ...
    try {
      ...
      for (final trigger in triggers) {
        ...
        if (run != null) {
          CcDomainLog.info('PipelineTrigger: Started ${trigger.templateId} for $typeName in workspace ${trigger.workspaceId}',
          );
        }
      }
    } on Object catch (e, st) {
      CcDomainLog.error('PipelineTrigger: Failed to dispatch for $typeName', e, st);
    }
  }
}
