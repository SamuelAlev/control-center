...
double relatednessScore(
  ...
  final lexical = _jaccard(
    significantTokens(contentA),
    significantTokens(contentB),
  );
  final entities = entityOverlap(
    extractEntities(contentA),
    extractEntities(contentB),
  );
