...
class MemoryDomain {
  ...
  MemoryDomain({
    ...
    if (workspaceId.isEmpty) {
      throw ArgumentError('MemoryDomain workspaceId must not be empty');
    }
    if (name.isEmpty) {
      throw ArgumentError('MemoryDomain name must not be empty');
    }
  }
  ...
  @override
  int get hashCode =>
      Object.hash(id, workspaceId, name, label, description, createdByRole);
}
