...
class _PadNote {
  ...
  /// note's stereo position, decorrelating the spaces).
...
/// very slow breathing LFO swells the whole pad and a per-space low-pass
...
class PadVoice implements SoundscapeVoice {
  ...
  PadVoice(
    ...
    for (var n = 0; n < _noteCount; n++) {
      ...
      // osc in place, sharp osc right) — different frequencies per space
  ...
  /// Retunes the per-space low-pass corner to [cutoffHz] with [q].
