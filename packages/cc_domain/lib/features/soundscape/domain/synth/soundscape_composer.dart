...
class SoundscapeComposer {
  ...
  SoundscapeComposer._({
    ...
    required this._noise,
    required this._harmony,
    required this._pad,
    required this._sub,
    required this._scheduler,
    required this._motifTimbres,
    required this._motifVoices,
    required this._arpScheduler,
    required this._arpTimbres,
    required this._arpVoices,
    required this._pulseScheduler,
    required this._pulseVoice,
    required this._tickVoice,
    required this._backbeatVoice,
    required this._am,
    required this._mixer,
    required this._padCutoffDrift,
    required this._padGainDrift,
    required this._motifDensityDrift,
    required this._wetDrift,
    required this._arpDrift,
    required this._intensityArc,
