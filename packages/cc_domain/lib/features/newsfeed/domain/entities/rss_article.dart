...
class RssArticle {
  ...
  RssArticle({
    ...
    if (id.isEmpty) {
      throw ArgumentError('Article id must not be empty');
    }
    if (feedId.isEmpty) {
      throw ArgumentError('Article feedId must not be empty');
    }
    if (title.isEmpty) {
      throw ArgumentError('Article title must not be empty');
    }
    if (link.isEmpty) {
      throw ArgumentError('Article link must not be empty');
    }
  }
