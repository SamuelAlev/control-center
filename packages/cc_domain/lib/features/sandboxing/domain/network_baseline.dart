...
const List<String> kBaselineAllowedDomains = [
  ...
  '*.z.ai',
  '*.bigmodel.cn',
  // AWS Bedrock ONLY — the two regional endpoint families, not all of AWS.
  // `*.amazonaws.com` was the single widest grant in this list: it exists to
  // reach Bedrock and admitted every S3 bucket, every API Gateway and every
  // other AWS subdomain in the world along with it. The middle-label wildcard
  // stands for exactly one label, so `bedrock.evil.attacker.amazonaws.com`
  // does not match.
