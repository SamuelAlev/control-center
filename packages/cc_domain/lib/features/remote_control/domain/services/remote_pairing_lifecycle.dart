...
/// re-approved.
///
/// Centralizes the durations so the create path (`pairing.mint` + the QR's
/// `PairingPayload`), the confirm path, and the server connect gates agree on
/// one policy. The point is finding #3: a
