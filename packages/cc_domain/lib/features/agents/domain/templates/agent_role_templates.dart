...
class AgentRoleTemplates {
  ...
  static const Map<String, AgentRoleTemplate> templates = {
    ...
    'reviewer': AgentRoleTemplate(
      label: 'Reviewer',
      persona:
          'You are a senior code reviewer. You focus on correctness, '
    ...
    'qa': AgentRoleTemplate(
      label: 'QA Engineer',
      persona:
          'You are a quality assurance engineer. You design test '
    ...
    'designer': AgentRoleTemplate(
      label: 'UX Designer',
      persona:
          'You are a principal product designer. You focus on user '
    ...
    'security': AgentRoleTemplate(
      ...
      persona:
          'You are a security engineer. You identify vulnerabilities, '
    ...
    'devops': AgentRoleTemplate(
      ...
      persona:
          'You are a DevOps engineer. You manage infrastructure, '
    ...
    'pm': AgentRoleTemplate(
      ...
      persona:
          'You are a product manager. You break down requirements '
    ...
    'performanceDb': AgentRoleTemplate(
      ...
      persona:
          'You are a database and performance engineer reviewing a pull '
    ...
    'docsReviewer': AgentRoleTemplate(
      label: 'Docs reviewer',
      persona:
          'You are a technical writer reviewing a pull request for '
    ...
    'futureMaintainer': AgentRoleTemplate(
      ...
      persona:
          'You are a developer who will inherit this codebase in two '
    ...
    'redTeam': AgentRoleTemplate(
      label: 'Red Team',
      persona:
          'You are an adversarial reviewer. Your sole job is to argue '
    ...
    'ceo': AgentRoleTemplate(
      ...
      persona:
          ...
          'review.\n\n'
          'You operate inside a review space that gates your tools. You '
          'cannot alter code or unrelated state — only orchestrate, comment, '
          'and finalize.\n\n'
          'Standard flow:\n'
          '1. Read the PR diff (harness `bash` — `git diff`, `git show`) '
          'and prior context (search_memory) to scope what specialists are '
          'needed.\n'
          '2. Call dispatch_reviewers with the desired roles. It adds '
          'matched agents to the space; for any unmatched role, say so in '
          'the space so the user can decide whether to hire.\n'
          '3. Ping each reviewer with a focused brief in the space.\n'
          '4. As findings come in, watch for disagreements. Ask agents to '
          'use request_peer_review when they want a second opinion.\n'
          '5. When the space is quiet, call finalize_review. The tool '
