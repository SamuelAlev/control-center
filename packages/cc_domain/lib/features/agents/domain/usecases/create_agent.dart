...
class DuplicateAgentNameException extends ValidationException {
  /// Creates a [DuplicateAgentNameException].
  DuplicateAgentNameException({
    required this.name,
    required this.workspaceId,
  }) : super('An agent named "$name" already exists in this workspace.');
...
class CreateAgentUseCase {
  ...
  String _buildAgentMd(CreateAgentCommand command) {
    ...
    if (command.effort != null) {
      buf.writeln('effort: ${command.effort}');
    }
