...
class IdempotencyKey {
  /// Creates a key for deduplicating a ticket dispatch attempt.
  ...
  /// Ticket identifier included in the deduplication key.
  final String ticketId;

  /// Agent identifier included in the deduplication key.
  final String agentId;

  /// Trigger source included in the deduplication key.
  final String source;

  /// String representation used for equality, hashing and storage.
  String get value => '$ticketId|$agentId|$source';

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is IdempotencyKey && other.value == value;
...
class DispatchDedupGuard {
  /// Creates an in-memory deduplication guard with the given retention [window].
