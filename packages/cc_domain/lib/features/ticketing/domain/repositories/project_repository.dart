...
abstract interface class ProjectRepository {
  ...
  /// Fetches a project by id within [workspaceId], or null. The id resolves
  /// only inside that workspace: a project belonging to another one is not
  /// found rather than returned.
  Future<Project?> getById(String workspaceId, String id);
