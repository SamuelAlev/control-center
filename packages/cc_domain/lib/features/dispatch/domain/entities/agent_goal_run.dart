...
class AgentGoalRun {
  ...
  }) : assert(id != '', 'Goal id must not be empty'),
       assert(workspaceId != '', 'workspaceId must not be empty'),
       assert(userText != '', 'Goal text must not be empty'),
       assert(costCapCents > 0, 'costCapCents must be positive'),
       assert(maxRuns == null || maxRuns > 0, 'maxRuns must be positive'),
       assert(costCents >= 0, 'costCents must not be negative'),
       assert(runCount >= 0, 'runCount must not be negative'),
       assert(
