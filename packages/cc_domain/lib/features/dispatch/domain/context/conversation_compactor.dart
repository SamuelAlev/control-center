...
class CompactionPlan {
  ...
  final List<Message> messagesToCompact;
...
class ConversationCompactor {
  ...
  CompactionPlan? plan({
    ...
    final previousSummary = prevCompactionIndex != null
        ? messages[prevCompactionIndex]
        : null;
    ...
    if (!force && config.auto) {
      final usage =
          estimator.estimateMessages(region) +
  ...
  int _findCutIndex(List<Message> region, CompactionConfig config) {
