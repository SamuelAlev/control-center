...
class AgentRef {
  ...
  AgentRef({
    ...
    if (id.isEmpty) {
      throw ArgumentError('AgentRef.id must not be empty');
    }
    if (displayName.isEmpty) {
      throw ArgumentError('AgentRef.displayName must not be empty');
    }
  ...
  /// Conversation / space this agent is currently working in, if any.
