...
/// the space until the recipient next runs".
///
/// (Formerly `IrcDeliveryOutcome`, in a `domain/irc/` directory left over from
/// the deleted in-memory IRC bus. Agent↔agent messages ride durable spaces
...
enum PeerDeliveryOutcome {
  ...
  /// Live hand-off failed; the message stays in the space for the recipient's
