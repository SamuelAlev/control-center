...
/// speaker. A segment's own [MeetingSegment.speakerNameOverride] takes
/// precedence over both — the name set for that single block. Pure (no I/O) so
/// the recorder controller, the diarization step, and the reconciler can share
...
String formatMeetingTranscript(
  ...
  for (final s in segments) {
    ...
    final override = s.speakerNameOverride;
    final who = (override != null && override.isNotEmpty)
        ? override
        : label != null
