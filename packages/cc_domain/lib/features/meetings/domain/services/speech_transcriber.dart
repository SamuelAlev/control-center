...
abstract class SpeechTranscriber {
  ...
  /// Transcribes a single finished window of mono 16-bit PCM @ 16 kHz and
  /// returns the recognized text (empty when nothing is recognized).
  ///
  /// Unlike [transcribe] this is a one-shot decode with no streaming — it
  /// drives rolling-window meeting transcription, where each cut window is
  /// decoded independently as it completes.
  Future<String> transcribeChunk(Uint8List pcm16);
