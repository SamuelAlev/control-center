...
/// pipeline's task-output channel (`submit_output`). The engine writes that
...
class MeetingOutcome {
  ...
  /// `submit_output` contract. A validator bug surfaces as missing fields,
  /// not silent coercion.
  ...
  /// — so the agent is told the exact keys and `submit_output` enforces them.
  ///
