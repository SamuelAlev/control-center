...
abstract class MessagingRepository {
  ...
  /// Watches the newest [limit] top-level messages (ascending for display),
  /// plus whether older messages exist beyond the window.
  ...
  /// Loads one cursor-based page of top-level history (oldest-first for
  ...
  /// Whether a channel row with [channelId] still exists.
  ...
  /// Gets all (non-reverted) messages for a channel.
