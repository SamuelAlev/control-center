...
/// Exception thrown when a cache read or write fails.
///
/// (The doc used to say "database operation" — copy/paste from a
/// `DatabaseException` that no longer exists. Nothing in a client can reach a
/// database at all.)
