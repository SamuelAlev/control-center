...
abstract final class RpcErrorCodes {
  ...
  /// The server-side handler exceeded its wall-clock budget and the session
  /// answered with this error instead of waiting (the handler may still be
  /// running server-side; the request's concurrency slot is already free).
