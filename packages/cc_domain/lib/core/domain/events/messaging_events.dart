...
/// resolved before deletion", with teardown falling back to a channel-id
...
/// (`deleteChannel(workspaceId, channelId)`; `ctx.workspaceId` in the RPC op),
...
class ChannelCreated implements DomainEvent {
  ...
  /// Owning workspace. Required: a channel is always created inside one, and
