...
class ConnectionDescriptor {
  ...
  /// Whether the server this descriptor names is a PUBLIC DEMO.
  ///
  /// Carried through the descriptor as well as `/healthz` because a redeemed
  /// invite hands the client a descriptor and the client PREFERS it over the
  /// probed URL — so a demo reached through the redeem envelope would
  /// otherwise arrive with the flag lost. Additive and default-false; the key
  /// is omitted entirely for a normal server.
  final bool isDemo;
