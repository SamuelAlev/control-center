...
class WakeContext {
  /// Creates a [WakeContext] identifying the agent, run, workspace and wake reason.
  const WakeContext({
    this.ticketId,
    required this.runId,
  ...
  /// Space where the trigger originated, if any.
  ...
  @override
  /// Human-readable summary of this wake context.
  String toString() =>
