...
abstract class WorkspaceMembershipRepository {
  ...
  /// Assigns a role by its raw WIRE value — a preset name or `custom:<id>`.
  ///
  /// Separate from [setRole] because a custom role has no [WorkspaceRole] to
  /// pass: it resolves to its base preset only after the custom row is read.
  Future<void> setRoleWire(String workspaceId, String userId, String roleWire);
