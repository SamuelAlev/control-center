...
class AgentQuestionRequest {
  ...
  /// Workspace owning [conversationId]. A conversation id is a uuid, not an
  /// access boundary: the workspace selects the database the question message
  /// is written into, so a foreign conversation id resolves to nothing.
