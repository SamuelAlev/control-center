...
class ReviewChannelAssociation {
  ...
  ReviewChannelAssociation markInProgress() =>
      copyWith(status: ReviewChannelStatus.inProgress);

  /// Returns a copy with status set to [ReviewChannelStatus.awaitingApproval].
  ReviewChannelAssociation markAwaitingApproval() =>
      copyWith(status: ReviewChannelStatus.awaitingApproval);

  /// Returns a copy with status set to [ReviewChannelStatus.completed].
  ReviewChannelAssociation markCompleted() =>
      copyWith(status: ReviewChannelStatus.completed);
