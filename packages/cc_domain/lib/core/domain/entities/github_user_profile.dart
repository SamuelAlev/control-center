...
class GitHubContributionDay {
  ...
  bool operator ==(Object other) =>
      ...
      other is GitHubContributionDay &&
          other.contributionCount == contributionCount &&
          other.date == date;

  @override
  int get hashCode => Object.hash(contributionCount, date);
}
...
class GitHubContributionWeek {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is GitHubContributionWeek &&
          _listEquals(other.contributionDays, contributionDays);

  @override
  int get hashCode => Object.hashAll(contributionDays);
}
...
class GitHubContributionCalendar {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is GitHubContributionCalendar &&
          other.totalContributions == totalContributions &&
          other.restrictedContributions == restrictedContributions &&
...
class GitHubOrganization {
  ...
  @override
  int get hashCode => Object.hash(login, name, avatarUrl, url);
}

/// The user's GitHub status.
class GitHubUserStatus {
  /// Creates a [GitHubUserStatus].
  const GitHubUserStatus({required this.isBusy, this.message, this.emoji});
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is GitHubUserStatus &&
          other.isBusy == isBusy &&
          other.message == message &&
          other.emoji == emoji;

  @override
  int get hashCode => Object.hash(isBusy, message, emoji);
}
...
class GitHubUserProfile {
  ...
  factory GitHubUserProfile.fromJson(Map<String, dynamic> json) {
    ...
    return GitHubUserProfile(
      ...
      status: statusJson != null ? GitHubUserStatus.fromJson(statusJson) : null,
      ...
      orgTeams: orgsJson != null
          ? orgsJson
                .whereType<Map<String, dynamic>>()
                .expand<String>((o) {
                  final teamNodes = o['teams'] is Map
                      ? (o['teams'] as Map)['nodes'] as List?
                      : null;
                  return (teamNodes ?? const [])
                      .whereType<Map<String, dynamic>>()
                ...
                .toList(growable: false)
          : const <String>[],
      contributionCalendar: calendarJson is Map<String, dynamic>
  ...
  factory GitHubUserProfile.fromWire(Map<String, dynamic> json) {
    ...
    return GitHubUserProfile(
      ...
      organizations: json['organizations'] is List
          ...
          : const <GitHubOrganization>[],
      orgTeams:
          (json['org_teams'] as List?)?.whereType<String>().toList(
            growable: false,
          ) ??
          const <String>[],
  ...
  bool operator ==(Object other) =>
      ...
      other is GitHubUserProfile &&
          ...
          _listEquals(other.orgTeams, orgTeams) &&
          other.contributionCalendar == contributionCalendar;
