...
class WorkingMemoryItem {
  ...
  WorkingMemoryItem({
    ...
    if (workspaceId.isEmpty) {
      throw ArgumentError('WorkingMemoryItem workspaceId must not be empty');
    }
    if (agentId.isEmpty) {
      throw ArgumentError('WorkingMemoryItem agentId must not be empty');
    }
  }
