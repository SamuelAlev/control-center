...
class MemoryFact {
  ...
  MemoryFact({
    ...
    if (workspaceId.isEmpty) {
      throw ArgumentError('MemoryFact workspaceId must not be empty');
    }
    if (topic.isEmpty) {
      throw ArgumentError('MemoryFact topic must not be empty');
    }
    if (confidence < 0 || confidence > 1) {
      throw ArgumentError('MemoryFact confidence must be 0-1');
    }
  }
