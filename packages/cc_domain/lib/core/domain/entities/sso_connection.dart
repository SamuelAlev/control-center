...
///
/// One connection per [kind] — the SSO settings screen edits one SAML and
/// one OIDC row. Environment variables (`CC_SAML_*` / `CC_OIDC_*`) seed the
/// rows on first boot; after that the database is the source of truth.
class SsoConnection {
