...
class UserDevice {
  ...
  UserDevice({
    ...
    if (id.isEmpty) {
      throw ArgumentError('UserDevice id must not be empty');
    }
    if (userId.isEmpty) {
      throw ArgumentError('UserDevice userId must not be empty');
    }
    if (credentialRef.isEmpty) {
      throw ArgumentError('UserDevice credentialRef must not be empty');
    }
  }
