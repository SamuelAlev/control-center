...
''';
    ...
    // The marker is spelled out in the body, never in the test NAME: package:test's
    // GitHub reporter echoes names verbatim, so a name carrying the literal
    // workflow-command prefix makes Actions annotate every passing run in red.
