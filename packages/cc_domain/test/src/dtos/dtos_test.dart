...
void main() {
  ...
  group('RepoDto', () {
    test('round-trip + defaults', () {
      ...
      expect(dto.githubOwner, 'o');
      final out = dto.toJson();
      expect(out['github_owner'], 'o');
  ...
  group('ChannelParticipantDto', () {
    test('round-trip + defaults', () {
      final dto = ChannelParticipantDto.fromJson({
        'id': 'i',
        'channel_id': 'c',
        'principal_id': 'p',
      ...
      final d2 = ChannelParticipantDto.fromJson({'id': 'i'});
  ...
  group('ChannelReadDto', () {
    test('round-trip', () {
      final dto = ChannelReadDto.fromJson({
        'channel_id': 'c',
        'last_read_at': 'x',
      });
      ...
      final d2 = ChannelReadDto.fromJson({});
      expect(d2.channelId, '');
  ...
  group('ReviewChannelAssociationDto', () {
    test('round-trip', () {
      final dto = ReviewChannelAssociationDto.fromJson({
        'id': 'i',
        'channel_id': 'c',
        'workspace_id': 'w',
        'pr_node_id': 'n',
      ...
      expect(ReviewChannelAssociationDto.fromJson({'id': 'i'}).prNumber, 0);
    });
  });
  ...
  group('toJson populated round-trips', () {
    ...
    test('ReviewChannelAssociationDto emits created_at + updated_at', () {
      final out = ReviewChannelAssociationDto.fromJson(const {
        'id': 'r',
        'channel_id': 'c',
        'workspace_id': 'w',
        'pr_node_id': 'n',
