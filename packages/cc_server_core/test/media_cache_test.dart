...
void main() {
  ...
  tearDown(() async {
    // Best-effort with retries: on Windows the cache's own write can still
    // hold a handle when teardown runs (errno 32), which says nothing about
    // the subject under test. POSIX keeps the strict delete.
