...
void main() {
  group('pairDevice', () {
    ...
    // Best-effort: `pairDevice` closes both database halves, but on Windows the
    // drift isolate can still hold the file for a moment after `close()`
    // returns and an unlink then fails with "used by another process".
