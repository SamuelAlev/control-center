...
/// mid-run injection channel, so `steerRun` returns false and the agent keeps
...
class RigEventListener {
  ...
  static String _describe(Rig? rig, String rigId) => rig == null
      ? 'rig $rigId'
      : 'the ${rig.surface.wire} rig $rigId';
