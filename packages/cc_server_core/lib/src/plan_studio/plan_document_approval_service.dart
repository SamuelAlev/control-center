...
class PlanDocumentApprovalService {
  ...
  /// `channels.mode` and `exit_plan_mode` did not touch the plan's status.
  ...
  Future<Map<String, dynamic>> approve({
    ...
    // permissions are resolved from `channels.mode` at dispatch time. Since
    ...
    // dispatched into a channel still in plan mode, i.e. read-only, so the
