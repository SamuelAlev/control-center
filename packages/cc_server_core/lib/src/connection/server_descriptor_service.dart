...
class ServerDescriptorService {
  ...
  /// Whether this server is a PUBLIC DEMO.
  ///
  /// Stamped onto the descriptor because a redeemed invite hands the client a
  /// descriptor and the client prefers it over the URL it probed — without
  /// this the flag would be lost on exactly the path a demo visitor takes.
  final bool isDemo;
