...
class CcMarkdownStyle {
  ...
  /// Blockquote container decoration + padding.
  final BoxDecoration? blockquoteDecoration;
  final EdgeInsets? blockquotePadding;

  /// Code block container decoration + padding (default code builder only).
  final BoxDecoration? codeblockDecoration;
  final EdgeInsets? codeblockPadding;

  /// Inline-code chip padding + radius (default inline-code builder).
