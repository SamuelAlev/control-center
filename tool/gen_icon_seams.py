...
ROOT_MEMBERS = {
    ...
    'bot', 'box', 'boxes', 'brain', 'browser', 'bug', 'building2',
    'cable', 'calculator', 'calendar', 'calendarBlank', 'calendarClock', 'calendarDays',
    'calendarPlus', 'calendarX', 'caseSensitive', 'chartColumn', 'check', 'checkCheck', 'checkCircle',
...
CCUI_MEMBERS = {
    ...
    'listTodo', 'lock', 'maximize2', 'messageSquare', 'minus', 'palette', 'pencil',
