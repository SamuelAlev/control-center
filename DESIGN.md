...
rounded:
  ...
  lg: '0px'     # large containers / panels / device windows — square, like controls
...
**The Contrast Thresholds.** WCAG minimums are enforced by size: small text (<24px) needs **4.5:1**, large text (≥24px) needs **3:1**, and non-text graphical elements (icons, focus rings, status dots, control borders) need **3:1**. Body and essential text still *target* AAA 7:1 (see the Contrast Rule below); these thresholds are the hard floor no token pairing may cross.
