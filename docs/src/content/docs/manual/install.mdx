...
- **macOS**: Download the `.dmg`, open it, and drag Control Center to Applications. The macOS build is signed with a Developer ID and notarized by Apple, so it opens normally.
