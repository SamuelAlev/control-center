...
Facts are embedded automatically for vector search. Agents retrieve relevant facts based on the channel context, so you don't need to explicitly link facts to agents.
