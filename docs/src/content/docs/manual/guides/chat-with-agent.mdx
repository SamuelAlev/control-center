...
description: Start a channel with an agent and send instructions.
---

This guide shows you how to start a channel with an agent.

## Start a channel

1. Navigate to **Channels** in the sidebar
2. Click **New channel**
3. Select an agent to channel
...
You don't need a channel. In any channel:

```
@alice can you look at the failing tests in src/auth_test.dart?
```

The mentioned agent dispatches with the channel's channel context.
