...
Slack applies the new app definition immediately but keeps the installed grant
as it was. Reinstall the app for a permission change to take effect. The bridge
keeps running on the previous grant until you do.
:::
