...
description: Mention agents in channels to dispatch them or include them in channels.
---
...
Mentioned agents are dispatched with the channel context.
...
In a channel, all participants can see the message. Mentioned agents respond; unmentioned agents observe but don't dispatch.
...
- The full channel roster (who else is in the channel)
- The message that triggered the dispatch

This context helps the agent understand its role in the channel.
