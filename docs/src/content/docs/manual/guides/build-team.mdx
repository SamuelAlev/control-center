...
- **Shared context**: team members share a channel
...
3. Each subtask creates a ticket and a channel
...
Teams can have dedicated channels where all members participate. This is useful for:

- Coordinating on complex tasks
- Sharing findings and blockers
- Asking questions across specializations

Create a team channel from **Channels** by creating a channel and adding all team members.
