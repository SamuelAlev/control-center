...
1. Hover over any line in the diff and a `+` button appears
...
You opened a PR, explored the diff with syntax highlighting, left inline comments, submitted a review, and merged. The entire review workflow happened inside Control Center, with no browser needed.
