...
description: Hire an agent, start a channel, and watch it work.
---
...
- An active channel with the agent
...
3. Choose a role, selecting **Coder**
...
2. Start a new channel with your agent (or type `@alice` in any channel)
...
You hired a coder agent, gave it a task, watched it work in real time, and got a PR back. The agent ran in an isolated worktree and sandbox, so your main checkout was never touched.
