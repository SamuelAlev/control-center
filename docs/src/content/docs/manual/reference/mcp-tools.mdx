---
title: MCP tools
description: Complete catalog of Control Center's 71 MCP server tools.
---
...
| `suggest_tasks` | Suggest follow-up tasks based on context |
...
| `approve_step` | Approve a gated pipeline/ticket step |
| `reject_step` | Reject a gated step |
