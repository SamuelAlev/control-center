    ...
    changes: [
      {
        ...
        items: [
          ...
          "<b>Workspace isolation.</b> Workspaces are hard-boundary tenants that auto-seed a CEO agent plus specialists; GitHub repos provision copy-on-write worktrees per channel via rift FFI (with git-worktree fallback), and every workspace-scoped query is filtered so one tenant's data never surfaces in another.",
