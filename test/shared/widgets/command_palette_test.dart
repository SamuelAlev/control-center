...
void main() {
  ...
  group('showCommandPalette', () {
        ...
        wrap(
          Builder(
            builder: (context) => FButton(
              onPress: () => showCommandPalette(context, _builder(commands)),
    ...
    testWidgets('search filters commands by label', (tester) async {
      ...
      final searchField = find.byType(FTextField);
    ...
    testWidgets('empty commands list shows empty state immediately', (
      ...
      await tester.pumpWidget(
        wrap(
          Builder(
            builder: (context) => FButton(
              onPress: () => showCommandPalette(context, _builder(const [])),
              child: const Text('Open'),
            ),
          ),
        ),
    ...
    testWidgets('dialog has divider separators', (tester) async {
      ...
      expect(find.byType(FDivider), findsWidgets);
    });
