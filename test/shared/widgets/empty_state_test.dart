...
void main() {
  group('EmptyState', () {
    ...
    testWidgets('renders default icon', (tester) async {
      await tester.pumpWidget(_wrap(const EmptyState(message: 'Empty')));
    ...
    testWidgets('renders query when provided', (tester) async {
      await tester.pumpWidget(
        _wrap(
          const EmptyState(message: 'No results found', query: 'search term'),
        ),
      );
    ...
    testWidgets('does not render query when empty', (tester) async {
      await tester.pumpWidget(
        _wrap(const EmptyState(message: 'Empty', query: '')),
      );

      expect(find.text('""'), findsNothing);
    });

    testWidgets('renders action button text when action provided', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('has Center widget', (tester) async {
      await tester.pumpWidget(_wrap(const EmptyState(message: 'Centered')));

      expect(find.byType(Center), findsWidgets);
    });

    testWidgets('has Column widget', (tester) async {
      await tester.pumpWidget(_wrap(const EmptyState(message: 'Column')));
