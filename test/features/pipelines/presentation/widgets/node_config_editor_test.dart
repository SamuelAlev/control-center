...
/// Enters text into an [FTextField] identified by its label text, using the
/// inner [EditableText] so that `enterText` works even for number and
/// multiline variants.
...
void main() {
  group('NodeConfigEditor', () {
    ...
    testWidgets('continueOnFail checkbox renders correctly when true',
      ...
      final cbs = tester.widgetList<FCheckbox>(find.byType(FCheckbox));
