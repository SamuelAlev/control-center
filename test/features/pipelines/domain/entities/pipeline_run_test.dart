...
void main() {
  group('PipelineRun', () {
    ...
    test(
      'state defaults to empty map and is unmodifiable',
    ...
    test(
      'state is unmodifiable copy of provided map',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'isTerminal delegates to status',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'copyWith overrides specified fields',
      timeout: const Timeout.factor(2),
      () {
        final run = run0();
    ...
    test(
      'copyWith preserves fields when not overridden',
      timeout: const Timeout.factor(2),
      () {
        final run = run0(
    ...
    test(
      'equality compares id, templateId, workspaceId, status, finishedAt, errorMessage',
      timeout: const Timeout.factor(2),
      () {
        final a = run0();
        final b = run0();
    ...
    test(
      'equality ignores state and cost differences',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'hashCode is equal for equal runs',
      timeout: const Timeout.factor(2),
      () {
        final a = run0();
        final b = run0();
    ...
    test(
      'hashCode differs when status differs',
      timeout: const Timeout.factor(2),
      () {
        final a = run0();
    ...
    test(
      'hashCode differs when errorMessage differs',
      timeout: const Timeout.factor(2),
      () {
        final a = run0();
    ...
    test(
      'hashCode is unchanged when state differs',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'hashCode is unchanged when cost differs',
      timeout: const Timeout.factor(2),
      () {
