...
void main() {
  group('StepResult', () {
    test(
      'ok creates a normal completion',
    ...
    test(
      'route creates a router completion',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'suspendUntilEvent creates a suspension',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'suspendUntilTasksComplete creates a suspension',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'terminal creates a pipeline-ending result',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'failed creates an error result',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'isFailed is false when no errorMessage',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'isSuspended is false when neither suspend fields set',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'equality compares all fields with deep collection equality',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different mutatedState',
      timeout: const Timeout.factor(2),
      () {
        final a = StepResult.ok(mutatedState: {'a': 1});
    ...
    test(
      'inequality with different router keys',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different error messages',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'different result types are not equal',
      timeout: const Timeout.factor(2),
      () {
