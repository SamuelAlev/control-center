...
void main() {
  group('PipelineDefinition', () {
    ...
    test(
      'constructor requires non-empty templateId, workspaceId, name',
    ...
    test(
      'step() returns matching step or null',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'entryStep returns the trigger step',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'entryStep throws when no trigger step exists',
      timeout: const Timeout.factor(2),
      () {
        final def = PipelineDefinition(
          templateId: 't',
    ...
    test(
      'listenersOf returns steps whose triggers reference the source',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'equality compares templateId, workspaceId, name, steps, inputs, flags',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different inputs',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different steps',
      timeout: const Timeout.factor(2),
      () {
        final a = PipelineDefinition(
          templateId: 't',
