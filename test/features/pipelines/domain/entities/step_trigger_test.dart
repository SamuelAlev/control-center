...
void main() {
  group('StepTrigger', () {
    test(
      'stores sourceStepIds and routeKey',
    ...
    test(
      'equality compares sourceStepIds (deep) and routeKey',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different sourceStepIds',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different routeKey',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with null vs non-null routeKey',
      timeout: const Timeout.factor(2),
      () {
