...
void main() {
  group('PipelineStepDefinition', () {
    test(
      'constructor asserts non-empty id and bodyKey',
    ...
    test('stores all fields', timeout: const Timeout.factor(2), () {
      ...
      expect(step.bodyKey, 'conversation.promptAgent');
    ...
    test(
      'equality compares id, kind, bodyKey, triggers, waitForStepIds, config, x, y',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality with different triggers',
      timeout: const Timeout.factor(2),
      () {
        final a = PipelineStepDefinition(
          id: 's',
    ...
    test(
      'inequality with different config',
      timeout: const Timeout.factor(2),
      () {
        final a = PipelineStepDefinition(
          id: 's',
    ...
    test(
      'inequality with different kind',
      timeout: const Timeout.factor(2),
      () {
        final a = PipelineStepDefinition(
          id: 's',
