...
void main() {
  group('PipelineIssue', () {
    test(
      'isError returns true for error severity',
    ...
    test(
      'isError returns false for warning severity',
      timeout: const Timeout.factor(2),
      () {
        const issue = PipelineIssue(
  ...
  group('PipelineValidator', () {
    ...
    test(
      'flags trigger step with upstream edges',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            PipelineStepDefinition(
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['some_other_step']),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
        ...
        expect(
          issues.any(
            (i) => i.isError && i.message.contains('cannot have upstream'),
          ),
          isTrue,
        );
      },
    ...
    test(
      'flags edge referencing non-existent step',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['ghost']),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
    ...
    test(
      'flags routed edge from non-router step',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['a'], routeKey: 'x'),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
        ...
        expect(
          issues.any((i) => i.isError && i.message.contains('not a router')),
          isTrue,
        );
      },
    );
    ...
    test(
      'flags join waitForStepIds referencing non-existent step',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'flags router with no routed outgoing edges',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
        ...
        expect(
          issues.any(
            (i) => i.isError && i.message.contains('no routed outgoing'),
          ),
          isTrue,
        );
      },
    ...
    test(
      'router with valid routed edges passes router check',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['r'], routeKey: 'yes'),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
    ...
    test(
      'router with fileExists predicate and valid paths passes',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with fileExists predicate and no paths warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with comparison predicate passes with valid fields',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with comparison predicate missing left operand warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with comparison predicate missing operator warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with comparison predicate and unknown operator warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
        ...
        expect(
          issues.any(
            (i) => i.isError && i.message.contains('unknown operator'),
          ),
          isTrue,
        );
      },
    ...
    test(
      'router with comparison predicate exists without right passes',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'router with comparison predicate equals without right warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with and predicate group validates children',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with empty and group warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with or predicate group validates children',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with not predicate validates',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with not predicate and no child warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router with unknown condition type warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
        ...
        expect(
          issues.any(
            (i) => i.isError && i.message.contains('unknown condition type'),
          ),
          isTrue,
        );
      },
    ...
    test(
      'router switch with no cases and no default warns',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              config: const PipelineNodeConfig(
                extras: {'switchKey': 'category', 'cases': <String>[]},
              ),
            ),
            PipelineStepDefinition(
              id: 'a',
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['r'], routeKey: 'a'),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
    ...
    test(
      'router switch with cases passes',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'router switch with default only passes',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              config: const PipelineNodeConfig(
                extras: {'switchKey': 'category', 'default': 'fallback'},
              ),
            ),
            PipelineStepDefinition(
              id: 'a',
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['r'], routeKey: 'fallback'),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
    ...
    test(
      'router with empty string switchKey not treated as switch',
      timeout: const Timeout.factor(2),
      () {
        ...
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              config: const PipelineNodeConfig(extras: {'switchKey': ''}),
            ),
            PipelineStepDefinition(
              id: 'a',
              kind: StepKind.listen,
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['r'], routeKey: 'x'),
              ],
            ),
            PipelineStepDefinition(
              id: 'end',
    ...
    test(
      'warns about duplicate output keys without reducer',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'no warning when duplicate output keys have a reducer',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'no warning for single producer of output key',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
        ...
        expect(issues.any((i) => i.message.contains('Output key')), isFalse);
      },
    );
    ...
    test(
      'warns about consumed keys not produced upstream',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'no warning for trigger-scoped placeholders',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
    ...
    test(
      'warns about prompt placeholders for unproduced keys',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'no warning when consumed key is produced upstream',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              bodyKey: 'b',
              triggers: const [
                StepTrigger(sourceStepIds: ['producer']),
              ],
            ...
            PipelineStepDefinition(
              ...
              bodyKey: '_t',
              triggers: const [
                StepTrigger(sourceStepIds: ['consumer']),
              ],
            ),
          ]),
        );
        expect(issues.any((i) => i.message.contains('my_data')), isFalse);
      },
    );

    test(
      'no warning when consumed key is produced by the step itself',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'flags forEach without iterableKey',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
            ...
            PipelineStepDefinition(
              ...
              bodyKey: '_t',
              triggers: const [
                StepTrigger(sourceStepIds: ['fe']),
              ],
            ),
          ]),
        );
        expect(
          issues.any((i) => i.isError && i.message.contains('iterableKey')),
          isTrue,
        );
      },
    );
    ...
    test(
      'forEach with iterableKey passes',
      timeout: const Timeout.factor(2),
      () {
        final issues = validator.validate(
          _def([
  ...
  group('PipelineValidator — agent steps need a room', () {
    // A room is a repo checkout. An agent step joins one and never opens one,
    // so a template whose agent step names no conversation cannot run — and
    // that is worth saying when it is saved, not halfway through a run that
    // has already dispatched its earlier steps.
    PipelineStepDefinition trigger() => PipelineStepDefinition(
      id: 'trigger',
      kind: StepKind.trigger,
      bodyKey: 'pipeline.trigger',
    );
    PipelineStepDefinition terminal(String source) => PipelineStepDefinition(
      id: 'end',
      kind: StepKind.terminal,
      bodyKey: '_terminal',
      triggers: [
    ...
    PipelineStepDefinition space({String outputKey = 'pipeline_space_id'}) =>
        PipelineStepDefinition(
          id: 'space',
          kind: StepKind.listen,
    ...
    test('accepts an agent step pointed at a space node', () {
      final def = _def([
        trigger(),
        space(),
        agent(room: '{{pipeline_space_id}}'),
        terminal('work'),
      ]);

      expect(errorsFor(def), isEmpty);
    });

    test('rejects an agent step that names no room', () {
      final def = _def([trigger(), space(), agent(), terminal('work')]);

      final errors = errorsFor(def);
      expect(errors, hasLength(1));
      expect(errors.single.stepId, 'work');
      expect(errors.single.message, contains('names no conversation'));
    });

    test('rejects a room reference no step in the pipeline opens', () {
      // The reference resolves to nothing at runtime, so the step would fail
      // mid-run having already burned everything upstream of it.
      final def = _def([
        trigger(),
        space(),
        agent(room: '{{someOtherKey}}'),
        terminal('work'),
      ]);

      final errors = errorsFor(def);
      expect(errors, hasLength(1));
      expect(errors.single.message, contains('no step in this pipeline opens'));
    });

    test('accepts a literal room id', () {
      // A space authored outside this template (an operator's room, a plan's
      // conversation). Whether it still exists is a runtime question.
      final def = _def([
        trigger(),
        space(),
        agent(room: 'space-abc'),
        terminal('work'),
      ]);
    ...
    test('leaves agentless steps alone', () {
      final def = _def([
        trigger(),
        PipelineStepDefinition(
          id: 'work',
          ...
          config: const PipelineNodeConfig(label: 'Script', script: 'echo hi'),
        ),
        terminal('work'),
      ]);
