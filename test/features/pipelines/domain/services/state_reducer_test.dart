...
void main() {
  group('StateReducer', () {
    ...
    test(
      'names contains all known reducers',
    ...
    test(
      'isKnown returns true for valid names',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'isKnown returns true for null and empty',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'isKnown returns false for unknown names',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'first write returns incoming regardless of reducer',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'first write with append wraps scalar into list',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'first write with append passes list through',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'append accumulates scalar to existing list',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'append accumulates list to existing list',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'append wraps existing scalar then appends',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'mergeLists creates flat list from two lists',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'mergeMaps overwrites existing keys',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'sum falls back to incoming when not both num',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'override replaces existing with incoming',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'null reducer behaves as override',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'empty string reducer behaves as override',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'unknown reducer falls back to override',
      timeout: const Timeout.factor(2),
      () {
  ...
  group('StateReducer — edge cases', () {
    ...
    test(
      'mergeMaps with non-map existing keeps only incoming map',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'mergeMaps with non-map incoming keeps only existing map',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'mergeMaps with both non-map returns empty map',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'mergeMaps with null values in maps merges correctly',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'mergeLists with empty source lists',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'sum falls back to incoming when existing is not num',
      timeout: const Timeout.factor(2),
      () {
