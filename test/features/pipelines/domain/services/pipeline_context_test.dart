  ...
  group('PipelineContext', () {
    ...
    group('constructor', () {
      test('stores all fields', () {
        ...
        expect(ctx.triggerPayload, {'issue_id': 42});
    ...
    group('requireString', () {
      ...
      test('throws StateError for missing key', () {
        ...
        expect(() => ctx.requireString('missing'), throwsA(isA<StateError>()));
      });
      ...
      test('throws StateError for empty string', () {
        ...
        expect(() => ctx.requireString('empty'), throwsA(isA<StateError>()));
      });
      ...
      test('throws StateError for bool value', () {
        ...
        expect(() => ctx.requireString('flag'), throwsA(isA<StateError>()));
      });
    ...
    group('requireInt', () {
      ...
      test('throws StateError for missing key', () {
        ...
        expect(() => ctx.requireInt('missing'), throwsA(isA<StateError>()));
      });
      ...
      test('throws StateError for String value', () {
        ...
        expect(() => ctx.requireInt('notAnInt'), throwsA(isA<StateError>()));
      });
    ...
    group('optional', () {
      ...
      test('throws StateError for wrong type cast', () {
        ...
        expect(() => ctx.optional<String>('age'), throwsA(isA<StateError>()));
      });
      ...
      test(
        'returns null when key present only in null triggerPayload is absent',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
    ...
    group('optional<List>', () {
      ...
      test('throws StateError for non-List value (string)', () {
        ...
        expect(() => ctx.optional<List>('items'), throwsA(isA<StateError>()));
      });
    ...
    group('optional<Map>', () {
      ...
      test('throws StateError for non-Map value (string)', () {
        ...
        expect(() => ctx.optional<Map>('config'), throwsA(isA<StateError>()));
      });
    ...
    group('requireString additional', () {
      test(
        'throws StateError when falling back to triggerPayload with empty string',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
          ...
          expect(() => ctx.requireString('key'), throwsA(isA<StateError>()));
        },
      );

      test(
        'throws StateError when falling back to triggerPayload with bool',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
      ...
      test(
        'throws StateError when value is explicitly null in triggerPayload fallback',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
      ...
      test(
        'state takes precedence even when triggerPayload has valid string',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
    ...
    group('requireInt additional', () {
      ...
      test(
        'throws StateError when falling back to triggerPayload with String',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
          ...
          expect(() => ctx.requireInt('count'), throwsA(isA<StateError>()));
        },
      );
    ...
    group('optional additional', () {
      test('throws StateError for wrong type from triggerPayload fallback', () {
        ...
        expect(() => ctx.optional<String>('name'), throwsA(isA<StateError>()));
      });
      ...
      test(
        'returns null when key is explicitly null in both state and triggerPayload',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
      ...
      test(
        'state wins and throws when state has wrong type even though triggerPayload has correct type',
        () {
          const ctx = PipelineContext(
            pipelineRunId: 'run-1',
            templateId: 'tpl-a',
          ...
          expect(() => ctx.optional<String>('key'), throwsA(isA<StateError>()));
        },
      );
    });
