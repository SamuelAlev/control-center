...
void main() {
  group('JsonRpcRequest', () {
    ...
    test('toJson round-trips through fromJson', () {
      final original = JsonRpcRequest(
        method: 'tools/call',
        params: {'name': 'hello', 'arguments': {'text': 'world'}},
        id: 'req-1',
      );
    ...
    test('equality', () {
      final a = JsonRpcRequest(
        method: 'test',
        params: {'x': 1},
        id: 1,
      );
      final b = JsonRpcRequest(
        method: 'test',
        params: {'x': 1},
        id: 1,
      );
      final c = JsonRpcRequest(
        method: 'test',
        params: {'x': 2},
        id: 1,
      );
  ...
  group('JsonRpcNotification', () {
    ...
    test('equality', () {
      final a = JsonRpcNotification(
        method: 'notify',
        params: {'id': 1},
      );
      final b = JsonRpcNotification(
        method: 'notify',
        params: {'id': 1},
      );
      final c = JsonRpcNotification(
        method: 'other',
        params: {'id': 1},
      );
