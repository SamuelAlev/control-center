...
void main() {
  group('DismissReviewNodeTool', () {
    ...
    setUp(() {
      ...
      tool = DismissReviewNodeTool(repository: repository);
    });
    ...
    test('dismisses review node with reason', () async {
      ...
      expect(data['dismissed_by'], 'a-2');
      expect(data['reason'], 'Already fixed');
    });
  });
}
