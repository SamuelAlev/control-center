...
void main() {
  ...
  group('ListAgentsTool call', () {
    ...
    test('returns agents with correct fields', () async {
      ...
      expect(data['count'], 1);
      expect(
        ((data['agents'] as List<dynamic>)[0] as Map<String, dynamic>)['id'],
        'a1',
      );
      expect(
        ((data['agents'] as List<dynamic>)[0] as Map<String, dynamic>)['name'],
        'architect',
      );
      expect(
        ((data['agents'] as List<dynamic>)[0] as Map<String, dynamic>)['title'],
        'Software Architect',
      );
    });
