...
class _TmpFs implements WorkspaceFilesystemPort {
  ...
  @override
  Future<void> deleteSkillDir(String workspaceId, String slug) async {
    final dir = Directory(await skillDir(workspaceId, slug));
    if (dir.existsSync()) {
