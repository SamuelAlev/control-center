...
void main() {
  ...
  group('isStartingSoon', () {
    ...
    test('true inside the window', () {
      expect(
        isStartingSoon(_event(start: now.add(const Duration(minutes: 3))), now),
        isTrue,
      );
    });
    test('true within the grace period after start', () {
      expect(
        isStartingSoon(
          _event(start: now.subtract(const Duration(minutes: 2))),
          now,
        ),
        isTrue,
      );
    ...
    test('false well in the future', () {
      expect(
        isStartingSoon(
          _event(start: now.add(const Duration(minutes: 30))),
          now,
        ),
        isFalse,
      );
    ...
    test('false long after start', () {
      expect(
        isStartingSoon(
          _event(start: now.subtract(const Duration(minutes: 30))),
          now,
        ),
        isFalse,
      );
    ...
    test('false for all-day events', () {
      expect(
        isStartingSoon(
          _event(start: now.add(const Duration(minutes: 3)), isAllDay: true),
          now,
        ),
        isFalse,
      );
