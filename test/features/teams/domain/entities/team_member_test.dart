...
void main() {
  TeamMember createMember({
    ...
    return TeamMember(teamId: teamId, agentId: agentId, role: role);
  }
  ...
  group('TeamMemberRole', () {
    group('fromString', () {
      ...
      test(
        'returns member for unknown values',
    ...
    group('toStorageString', () {
      test(
        'returns correct string for leader',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'returns correct string for member',
        timeout: const Timeout.factor(2),
        () {
  ...
  group('TeamMember', () {
    group('constructor', () {
      test(
        'creates member with required fields',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'creates member with leader role',
        timeout: const Timeout.factor(2),
        () {
    ...
    group('== and hashCode', () {
      test(
        '== returns true for same teamId and agentId',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different teamId',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different agentId',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'hashCode matches for equal members',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'hashCode differs for different members',
        timeout: const Timeout.factor(2),
        () {
