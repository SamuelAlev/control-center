...
void main() {
  ...
  group('classify — auth errors', () {
    test(
      'detects "authentication failed" in stderr',
    ...
    test(
      'detects "invalid api key" case-insensitively',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
    ...
    test(
      'detects auth via lastError field',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — rate limiting', () {
    test(
      'detects "rate limit" as retryable',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — prompt too large', () {
    ...
    test(
      'detects "context_length_exceeded"',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — process killed', () {
    test('null exit code → process lost', timeout: const Timeout.factor(2), () {
      final result = classifier.classify(exitCode: null, stderr: '');
    ...
    test(
      ...
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(exitCode: 143, stderr: '');
        expect(result.family, RunErrorFamily.processLost);
        expect(result.retryable, isFalse);
      },
    );
  ...
  group('classify — empty output', () {
    test(
      'detects "empty response" as retryable',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 0,
  ...
  group('classify — unknown', () {
    test(
      'unknown error when nothing matches',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 42,
    ...
    test(
      'uses lastError in detail for unknown',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — pattern priority', () {
    test(
      'auth takes precedence over rate limit when both present',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'rate limit takes precedence over empty output',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — case insensitivity', () {
    test(
      'matches upper-case AUTHENTICATION FAILED',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — combined text search', () {
    test(
      'pattern split across lastError and stderr',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
    ...
    test(
      'lastError alone triggers match',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — additional rate limit patterns', () {
    ...
    test(
      'detects "rate_limit" with underscore',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — additional budget patterns', () {
    test(
      'detects "limit exceeded" in budget context',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 1,
  ...
  group('classify — priority edge cases', () {
    ...
    test(
      'process killed overrides budget when exit 143',
      timeout: const Timeout.factor(2),
      () {
        final result = classifier.classify(
          exitCode: 143,
  ...
  group('classify — stage assignment', () {
    test(
      'launch stage for auth, prompt-too-large, sandbox, binary-not-found',
      timeout: const Timeout.factor(2),
      () {
        expect(
    ...
    test(
      'execution stage for rate-limit, permission, timeout, model, budget',
      timeout: const Timeout.factor(2),
      () {
        expect(
