...
class _FakeConversationContextUseCase
  ...
  /// workspace the dispatch runs in, not to the channel id alone.
...
void main() {
  ...
  group('conversation context', () {
    ...
    test(
      'injects conversation context when channel and agent are available',
      () async {
        ...
        // The history read is scoped to the dispatching workspace; a channel id
