  ...
  group('buildConversationContextPure', () {
    ...
    test('all three sections appear together', () {
      final result = buildConversationContextPure(
        ...
        selfAgentName: selfName,
        messages: [],
        verbatimWindow: [_msg(id: 'v1', senderId: 'user', content: 'Recent')],
        summaries: [_msg(id: 's1', senderId: 'user', content: 'Summary')],
        semanticHits: [
    ...
    test('messages list is unused but accepted', () {
      final result = buildConversationContextPure(
        ...
        selfAgentId: selfId,
        selfAgentName: selfName,
        messages: [_msg(id: 'm1', senderId: 'user', content: 'raw message')],
        verbatimWindow: [
