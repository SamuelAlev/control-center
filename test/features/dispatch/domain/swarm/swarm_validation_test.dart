...
void main() {
  group('validateSwarmDefinition', () {
    ...
    test('flags targetCount below 1', () {
      final def = _def([_agent('a')], mode: SwarmMode.pipeline, targetCount: 0);
    ...
    test('flags targetCount != 1 outside pipeline mode', () {
      final def = _def([_agent('a')], mode: SwarmMode.parallel, targetCount: 3);
    ...
    test('allows targetCount != 1 in pipeline mode', () {
      final def = _def([_agent('a')], mode: SwarmMode.pipeline, targetCount: 4);
