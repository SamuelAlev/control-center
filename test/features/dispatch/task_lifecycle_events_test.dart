...
void main() {
  ...
  test('every lifecycle event is a TaskLifecycleEvent (sealed base)', () {
    final List<TaskLifecycleEvent> events = [
      TaskQueued(taskId: 't', seq: 0, occurredAt: now),
      TaskDispatched(taskId: 't', seq: 1, occurredAt: now),
      TaskRunning(taskId: 't', seq: 2, occurredAt: now),
      TaskProgress(taskId: 't', seq: 3, occurredAt: now),
      TaskCompleted(taskId: 't', seq: 4, occurredAt: now),
      TaskCancelled(taskId: 't', seq: 5, occurredAt: now),
    ];
