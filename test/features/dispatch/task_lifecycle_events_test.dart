...
void main() {
  ...
  test('every lifecycle event is a TaskLifecycleEvent (sealed base)', () {
    final List<TaskLifecycleEvent> events = [
      TaskDispatched(taskId: 't', workspaceId: 'ws1', seq: 0, occurredAt: now),
      TaskRunning(taskId: 't', workspaceId: 'ws1', seq: 1, occurredAt: now),
      TaskProgress(taskId: 't', workspaceId: 'ws1', seq: 2, occurredAt: now),
      TaskCompleted(taskId: 't', workspaceId: 'ws1', seq: 3, occurredAt: now),
      TaskCancelled(taskId: 't', workspaceId: 'ws1', seq: 4, occurredAt: now),
    ];
