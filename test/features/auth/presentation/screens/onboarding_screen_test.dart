...
void main() {
  ...
  testWidgets('Continue button disabled when not authenticated', (tester) async {
    ...
    final continueButton =
        tester.widget<CcButton>(find.widgetWithText(CcButton, 'Continue'));
  ...
  testWidgets('renders theme toggle button', (tester) async {
    await pumpOnboarding(tester, authenticated: false);
    // Light theme → moon icon (LucideIcons.moon). The toggle is an CcButton.icon
  ...
  testWidgets('Continue button is null onPressed when unauthenticated', (tester) async {
    await pumpOnboarding(tester, authenticated: false);
    final continueButton =
        tester.widget<CcButton>(find.widgetWithText(CcButton, 'Continue'));
    expect(continueButton.onPressed, isNull);
