...
void main() {
  group('DiscoveredAgent', () {
    ...
    test(
      'inequality when agentMdPath differs',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality when reportsTo differs',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality when persona differs',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality when skills length differs',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'equality when skills are in same order',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'inequality when skills are in different order',
      timeout: const Timeout.factor(2),
      () {
        final a = makeAgent(skills: ['a', 'b']);
    ...
    test(
      'not equal to non-DiscoveredAgent',
      timeout: const Timeout.factor(2),
      () {
        final agent = makeAgent();
