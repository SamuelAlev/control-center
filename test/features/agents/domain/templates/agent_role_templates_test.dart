import 'package:cc_domain/features/agents/domain/templates/agent_role_templates.dart';
...
void main() {
  ...
  group('AgentRoleTemplate', () {
    group('constructor', () {
      test('sets all fields', timeout: const Timeout.factor(2), () {
  ...
  group('AgentRoleTemplates', () {
    test('templates map is non-empty', timeout: const Timeout.factor(2), () {
    ...
    test('known role keys present', timeout: const Timeout.factor(2), () {
