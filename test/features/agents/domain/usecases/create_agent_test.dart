...
void main() {
  group('CreateAgentUseCase', () {
    ...
    test('sets agentMdPath from filesystem service', () async {
      ...
      expect(fs.files.containsKey('/fake/ws-1/agents/kilo/AGENTS.md'), isTrue);
    });
    ...
    test('generates valid AGENTS.md content', () async {
      ...
      final content = fs.files['/fake/ws-1/agents/kilo/AGENTS.md']!;
    ...
    test('generates minimal AGENTS.md when no optional fields', () async {
      ...
      await useCase.execute(command);
      final content = fs.files['/fake/ws-1/agents/minimal/AGENTS.md']!;
