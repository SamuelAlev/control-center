...
class FakeTicketLinkRepository implements TicketLinkRepository {
  ...
  final List<
    ({String sourceTicketId, String targetTicketId, TicketLinkType type})
  >
  deletedByEndpoints = [];
...
class FakeTicketRepository implements TicketRepository {
  ...
  @override
  Future<Ticket?> getById(String workspaceId, String id) async => _tickets[id];
...
void main() {
  group('TicketLinkService', () {
    ...
    group('link', () {
      test(
        'rejects self-reference (source == target)',
      ...
      test(
        'rejects when source ticket does not exist',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.link(
      ...
      test(
        'rejects when target ticket does not exist',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.link(
      ...
      test(
        'rejects when source workspaceId mismatches',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.link(
      ...
      test(
        'rejects when target workspaceId mismatches',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.link(
      ...
      test(
        'inserts a TicketLink with correct fields on success',
        timeout: const Timeout.factor(2),
        () async {
          await service.link(
            workspaceId: _ws,
      ...
      test(
        'inserts with relatesTo type correctly',
        timeout: const Timeout.factor(2),
        () async {
          await service.link(
            workspaceId: _ws,
      ...
      test(
        'inserts with duplicateOf type correctly',
        timeout: const Timeout.factor(2),
        () async {
          await service.link(
            workspaceId: _ws,
      ...
      test(
        'is idempotent (does not throw on duplicate)',
        timeout: const Timeout.factor(2),
        () async {
          // First call succeeds.
          await service.link(
      ...
      test(
        'validates both tickets independently (source first)',
        timeout: const Timeout.factor(2),
        () async {
    ...
    group('unlink', () {
      test(
        'delegates to linkRepository.deleteByEndpoints with correct args',
        timeout: const Timeout.factor(2),
        () async {
      ...
      test(
        'unlink with relatesTo delegates correctly',
        timeout: const Timeout.factor(2),
        () async {
          await service.unlink(
            workspaceId: _ws,
      ...
      test(
        'unlink does not validate tickets (just delegates)',
        timeout: const Timeout.factor(2),
        () async {
    ...
    group('addRelation', () {
      test(
        'blocking maps source=subject, target=other, type=blocks',
        timeout: const Timeout.factor(2),
        () async {
      ...
      test(
        'blockedBy maps source=other, target=subject, type=blocks',
        timeout: const Timeout.factor(2),
        () async {
          await service.addRelation(
            workspaceId: _ws,
      ...
      test(
        'relatedTo maps type=relatesTo, source=subject',
        timeout: const Timeout.factor(2),
        () async {
          await service.addRelation(
            workspaceId: _ws,
      ...
      test(
        'duplicateOf maps source=subject, target=other, type=duplicateOf',
        timeout: const Timeout.factor(2),
        () async {
          await service.addRelation(
            workspaceId: _ws,
      ...
      test(
        'duplicatedBy maps source=other, target=subject, type=duplicateOf',
        timeout: const Timeout.factor(2),
        () async {
          await service.addRelation(
            workspaceId: _ws,
      ...
      test(
        'still validates tickets through link()',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.addRelation(
      ...
      test(
        'rejects parentOf with ArgumentError',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.addRelation(
      ...
      test(
        'rejects subIssueOf with ArgumentError',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.addRelation(
      ...
      test(
        'self-reference via addRelation still throws',
        timeout: const Timeout.factor(2),
        () async {
          await expectLater(
            () => service.addRelation(
    ...
    group('removeRelation', () {
      test(
        'blocking delegates unlink with source=subject, target=other',
        timeout: const Timeout.factor(2),
        () async {
      ...
      test(
        'blockedBy delegates unlink with source=other, target=subject',
        timeout: const Timeout.factor(2),
        () async {
          await service.removeRelation(
            workspaceId: _ws,
      ...
      test(
        'relatedTo delegates unlink correctly',
        timeout: const Timeout.factor(2),
        () async {
          await service.removeRelation(
            workspaceId: _ws,
      ...
      test(
        'duplicateOf delegates unlink with source=subject, target=other',
        timeout: const Timeout.factor(2),
        () async {
          await service.removeRelation(
            workspaceId: _ws,
      ...
      test(
        'duplicatedBy delegates unlink with source=other, target=subject',
        timeout: const Timeout.factor(2),
        () async {
          await service.removeRelation(
            workspaceId: _ws,
      ...
      test(
        'does not validate tickets (just delegates to unlink)',
        timeout: const Timeout.factor(2),
        () async {
          await service.removeRelation(
            workspaceId: _ws,
    ...
    group('_assertTicket via link', () {
      test(
        'rejects when ticket is null (not found)',
        timeout: const Timeout.factor(2),
        () async {
    ...
    group('canonical mapping correctness', () {
      test(
        'relatesTo is symmetric (source == subject always)',
        timeout: const Timeout.factor(2),
        () async {
          await service.addRelation(
            workspaceId: _ws,
      ...
      test(
        'blocks canonical source/target respects direction',
        timeout: const Timeout.factor(2),
        () async {
      ...
      test(
        'duplicateOf canonical source/target respects direction',
        timeout: const Timeout.factor(2),
        () async {
      ...
      test(
        'addRelation followed by removeRelation for same kind round-trips',
        timeout: const Timeout.factor(2),
        () async {
