...
void main() {
  ...
  group('TicketCollaboratorRole', () {
    ...
    group('fromStorage', () {
      ...
      test('returns collaborator for unknown', timeout: const Timeout.factor(2), () {
        expect(TicketCollaboratorRole.fromStorage('unknown'), TicketCollaboratorRole.collaborator);
      });
    });
