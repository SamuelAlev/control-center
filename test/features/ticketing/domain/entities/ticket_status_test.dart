...
void main() {
  group('TicketStatus', () {
    group('fromStorage', () {
      ...
      test('maps legacy pending to open', timeout: const Timeout.factor(2), () {
        expect(TicketStatus.fromStorage('pending'), TicketStatus.open);
      });

      test('maps legacy completed to done', timeout: const Timeout.factor(2), () {
      ...
      test('returns open for unknown string', timeout: const Timeout.factor(2), () {
        expect(TicketStatus.fromStorage('unknown'), TicketStatus.open);
