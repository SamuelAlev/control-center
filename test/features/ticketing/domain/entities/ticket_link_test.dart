...
void main() {
  ...
  group('TicketLinkType', () {
    ...
    group('toStorageString', () {
      test(
        'returns snake_case storage form',
  ...
  group('TicketLink', () {
    ...
    group('relationFor', () {
      test(
        'blocks: source sees blocking, target sees blockedBy',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'relatesTo: symmetric from both ends',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'duplicateOf: source sees duplicateOf, target sees duplicatedBy',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'returns null when subject is not an endpoint',
        timeout: const Timeout.factor(2),
        () {
          final link = make();
    ...
    group('equality', () {
      test(
        'equal when id, sourceTicketId, targetTicketId, type match',
        timeout: const Timeout.factor(2),
        () {
          final a = make(
            id: 'l',
