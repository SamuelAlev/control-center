...
void main() {
  ...
  group('TicketLinkService.addRelation', () {
    test(
      '"blocked by" stores a canonical blocks edge from the other ticket',
      () async {
        tickets.seed('a', 'w');
        tickets.seed('b', 'w');
    ...
    test(
      '"blocking" stores a canonical blocks edge from the subject',
      () async {
        tickets.seed('a', 'w');
        tickets.seed('b', 'w');
        await linkService.addRelation(
    ...
    test(
      '"duplicate of" stores canonical duplicateOf edge from subject',
      () async {
        tickets.seed('a', 'w');
        tickets.seed('b', 'w');
        await linkService.addRelation(
    ...
    test(
      '"duplicated by" stores canonical duplicateOf edge from other',
      () async {
        tickets.seed('a', 'w');
        tickets.seed('b', 'w');
        await linkService.addRelation(
    ...
    test(
      'removeRelation for blocking/bockedBy removes the shared edge',
      () async {
        tickets.seed('a', 'w');
        tickets.seed('b', 'w');
        await linkService.addRelation(
    ...
    test(
      'removeRelation for blockedBy (inverse direction) removes the edge',
      () async {
        tickets.seed('a', 'w');
        tickets.seed('b', 'w');
        await linkService.addRelation(
