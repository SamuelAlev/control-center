...
class _FakeProjectRepository implements ProjectRepository {
  ...
  @override
  Future<Project?> getById(String workspaceId, String id) async => null;
...
Widget _wrap(
  ...
  final projectRepository = _FakeProjectRepository(projects);
  return ProviderScope(
    overrides: [
      ...
      // The project menu (rendered whenever a project resolves) reads
      // projectServiceProvider for its archive/complete/edit actions; its
      // real binding watches rpcClientProvider, which is unavailable in a
      // pure widget test. Seam it onto the same fake repository.
      ...
      workspaceAgentsProvider.overrideWith((ref, wsId) => Stream.value(agents)),
    ],
...
void main() {
  ...
  testWidgets('excludes tickets that belong to other projects', (tester) async {
    tester.view.physicalSize = const Size(1200, 800);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
