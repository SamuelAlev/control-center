...
class _FakeTicketRepository implements TicketRepository {
  ...
  @override
  Future<List<Ticket>> forPipelineRun(String ws, String pr) async => [];
  @override
  Future<List<Ticket>> forPipelineStep(String ws, String pr, String ps) async => [];
  @override
  ...
  @override
  Stream<List<Ticket>> watchForPipelineRun(String ws, String pr) => const Stream.empty();
  @override
