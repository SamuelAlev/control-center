...
class _FakeTicketRepository implements TicketRepository {
  ...
  @override
  Future<List<Ticket>> forPipelineRun(String workspaceId, String pipelineRunId) async =>
      [];

  @override
  Future<List<Ticket>> forPipelineStep(
      String workspaceId, String pipelineRunId, String pipelineStepId) async => [];
  ...
  @override
  Stream<List<Ticket>> watchForPipelineRun(String workspaceId, String pipelineRunId) =>
      const Stream.empty();
