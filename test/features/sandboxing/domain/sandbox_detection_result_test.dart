  ...
  group('SandboxDetectionResult', () {
    group('construction', () {
      ...
      test('creates with capabilities that include requiresInstall', () {
        ...
        expect(
          result.capabilities[SandboxBackend.native]!.requiresInstall,
          isTrue,
        );
        expect(
          result.capabilities[SandboxBackend.native]!.installHint,
          'apt-get install bubblewrap socat',
        );
        expect(
          result.capabilities[SandboxBackend.native]!.note,
    ...
    group('field access', () {
      test('platform returns the detected platform name', () {
        const result = SandboxDetectionResult(
          platform: linuxPlatform,
          recommendation: SandboxBackend.native,
          capabilities: {SandboxBackend.native: linuxNativeCaps},
        );
      ...
      test('all three fields are accessible together', () {
        const result = SandboxDetectionResult(
          platform: 'freebsd',
          recommendation: SandboxBackend.none,
          capabilities: {SandboxBackend.none: linuxNoneCaps},
        );
    ...
    group('equality', () {
      ...
      test('different all fields is not equal', () {
        ...
        const b = SandboxDetectionResult(
          platform: macosPlatform,
          recommendation: SandboxBackend.none,
          capabilities: {SandboxBackend.none: macosNoneCaps},
        );
