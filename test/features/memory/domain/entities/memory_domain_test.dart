...
void main() {
  group('MemoryDomain', () {
    ...
    test(
      'throws assertion error when workspaceId is empty',
      timeout: const Timeout.factor(2),
      () {
        expect(
    ...
    test(
      'throws assertion error when name is empty',
      timeout: const Timeout.factor(2),
      () {
        expect(() => createDomain(name: ''), throwsA(isA<AssertionError>()));
      },
    );
    ...
    test(
      'domains with different id are not equal',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'domains with different workspaceId are not equal',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'domains with different name are not equal',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'domains with different label are not equal',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'domains with different description are not equal',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'domain with null description != domain with non-null description',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'domains with different createdByRole are not equal',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'is not equal to non-MemoryDomain objects',
      timeout: const Timeout.factor(2),
      () {
        final domain = createDomain();
