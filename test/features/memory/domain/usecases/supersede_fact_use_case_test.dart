...
void main() {
  group('SupersedeFactUseCase', () {
    ...
    test(
      'persists superseded fact to repository',
      timeout: const Timeout.factor(2),
      () async {
        factRepo.seed([createFact(id: 'f1')]);
    ...
    test(
      'throws ArgumentError when fact not found',
      timeout: const Timeout.factor(2),
      () async {
        // Empty repo
        expect(
    ...
    test(
      'throws ArgumentError when fact belongs to different workspace',
      timeout: const Timeout.factor(2),
      () async {
    ...
    test(
      'preserves other fields when superseding',
      timeout: const Timeout.factor(2),
      () async {
