  ...
  group('MemoryMetaChip', () {
    testWidgets('renders neutral chip with label', (tester) async {
      await tester.pumpWidget(
        testWrap(const MemoryMetaChip(label: 'security')),
      );
    ...
    testWidgets('renders chip with icon', (tester) async {
      await tester.pumpWidget(
        testWrap(
          const MemoryMetaChip(label: 'security', icon: AppIcons.shield),
        ),
      );
    ...
    testWidgets('renders error tone chip', (tester) async {
      await tester.pumpWidget(
        testWrap(
          const MemoryMetaChip(label: 'superseded', tone: MemoryChipTone.error),
        ),
      );
    ...
    testWidgets('renders monospace label', (tester) async {
      await tester.pumpWidget(
        testWrap(const MemoryMetaChip(label: 'abc123def', monospace: true)),
      );
