...
import 'package:control_center/di/server_providers.dart'
    show SnapshotAggregatorNotifier, snapshotAggregatorProvider;
...
class _StubAnalyticsRepository implements AnalyticsRepository {
  ...
  @override
  Future<List<AgentScorecard>> getAllAgentScorecards(String workspaceId) async => const [];
...
class _StubAchievementRepository implements AchievementRepository {
  ...
  @override
  Future<List<Achievement>> getByAgent(String workspaceId, String agentId) async => const [];
  ...
  @override
  Future<bool> isUnlocked(String workspaceId, String agentId, String badgeKey) async => false;
}
...
class _StubStreakRepository implements StreakRepository {
  ...
  @override
  Future<List<Streak>> getByAgent(String workspaceId, String agentId) async => const [];
