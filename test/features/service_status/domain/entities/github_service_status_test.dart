...
void main() {
  group('GitHubStatusIndicator', () {
    group('fromApi', () {
      test('parses none', timeout: const Timeout.factor(2), () {
        expect(
          GitHubStatusIndicator.fromApi('none'),
      ...
      test('parses minor', timeout: const Timeout.factor(2), () {
        expect(
          GitHubStatusIndicator.fromApi('minor'),
      ...
      test('parses major', timeout: const Timeout.factor(2), () {
        expect(
          GitHubStatusIndicator.fromApi('major'),
      ...
      test('parses critical', timeout: const Timeout.factor(2), () {
        expect(
          GitHubStatusIndicator.fromApi('critical'),
      ...
      test('parses maintenance', timeout: const Timeout.factor(2), () {
        expect(
          GitHubStatusIndicator.fromApi('maintenance'),
      ...
      test('returns unknown for null', timeout: const Timeout.factor(2), () {
        expect(
          GitHubStatusIndicator.fromApi(null),
          GitHubStatusIndicator.unknown,
        );
      });
      ...
      test(
        ...
        () {
          expect(
            GitHubStatusIndicator.fromApi('something_else'),
            GitHubStatusIndicator.unknown,
          );
          expect(
            GitHubStatusIndicator.fromApi(''),
            GitHubStatusIndicator.unknown,
          );
        },
      );
  ...
  group('GitHubComponentStatus', () {
    group('fromApi', () {
      ...
      test('returns unknown for null', timeout: const Timeout.factor(2), () {
        expect(
          GitHubComponentStatus.fromApi(null),
          GitHubComponentStatus.unknown,
        );
      });
      ...
      test(
        ...
        () {
          expect(
            GitHubComponentStatus.fromApi('broken'),
            GitHubComponentStatus.unknown,
          );
        },
      );
  ...
  group('GitHubStatusComponent', () {
    ...
    group('== and hashCode', () {
      ...
      test(
        '== returns false for different status',
        timeout: const Timeout.factor(2),
        () {
          const c1 = GitHubStatusComponent(
            id: 'c1',
          ...
          const c2 = GitHubStatusComponent(
            id: 'c1',
            name: 'A',
            status: GitHubComponentStatus.degradedPerformance,
            position: 1,
          );
          expect(c1, isNot(equals(c2)));
        },
      ...
      test(
        'hashCode matches for equal components',
        timeout: const Timeout.factor(2),
        () {
          const c1 = GitHubStatusComponent(
            id: 'c1',
  ...
  group('GitHubServiceStatus', () {
    ...
    test(
      '== returns false for different indicator',
      timeout: const Timeout.factor(2),
      () {
        final s1 = GitHubServiceStatus(
          indicator: GitHubStatusIndicator.none,
    ...
    test(
      '== returns false for different components',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'hashCode matches for equal statuses',
      timeout: const Timeout.factor(2),
      () {
        final s1 = GitHubServiceStatus(
          indicator: GitHubStatusIndicator.none,
