...
void main() {
  ...
  group('BranchTemplateResolver', () {
    group('constructor', () {
      test('holds the template string', timeout: const Timeout.factor(2), () {
    ...
    group('resolve', () {
      ...
      test('empty type defaults to task', timeout: const Timeout.factor(2), () {
      ...
      test(
        ...
        timeout: const Timeout.factor(2),
        () {
          const resolver = BranchTemplateResolver('{type}/{ticket-key}-{slug}');
          final result = resolver.resolve(
            type: 'feature',
            ticketKey: '  ',
            title: 'Hello World',
      ...
      test('null optional params handled', timeout: const Timeout.factor(2), () {
        const resolver = BranchTemplateResolver(
  ...
  group('sanitizeBranchName', () {
    ...
    test(
      ...
      () {
        ...
        expect(sanitizeBranchName('a/b/c'), 'a/b/c');
      },
    );

    test('drops empty segments', timeout: const Timeout.factor(2), () {
