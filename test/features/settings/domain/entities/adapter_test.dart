...
void main() {
  ...
  group('DetectedAdapter', () {
    ...
    test(
      'construction with nullable fields null',
    ...
    test(
      'isResolved is true when notFound',
      timeout: const Timeout.factor(2),
      () {
        const da = DetectedAdapter(
          adapter: baseAdapter,
    ...
    test(
      'isResolved is false when checking',
      timeout: const Timeout.factor(2),
      () {
        const da = DetectedAdapter(
          adapter: baseAdapter,
    ...
    test(
      'isFound is true only when status is found',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'copyWith clearVersion sets version to null',
      timeout: const Timeout.factor(2),
      () {
        const original = DetectedAdapter(
          adapter: baseAdapter,
    ...
    test(
      'copyWith clearPath sets path to null',
      timeout: const Timeout.factor(2),
      () {
        const original = DetectedAdapter(
          adapter: baseAdapter,
    ...
    test(
      'copyWith with no args preserves original',
      timeout: const Timeout.factor(2),
      () {
        const original = DetectedAdapter(
          adapter: baseAdapter,
  ...
  group('predefinedAdapters', () {
    ...
    test(
      'all adapters have non-empty fields',
      timeout: const Timeout.factor(2),
      () {
