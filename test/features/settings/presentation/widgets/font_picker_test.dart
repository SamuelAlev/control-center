...
void main() {
  ...
  testWidgets('showFontPicker opens dialog and renders header', (tester) async {
  ...
  testWidgets(
    'showFontPicker returns null when dialog closed via close button',
    (tester) async {
      tester.view.physicalSize = const Size(1000, 900);
      tester.view.devicePixelRatio = 1.0;
      addTearDown(() {
  ...
  testWidgets('font picker handles system fonts listing with family and path', (
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          ...
          systemFontsProvider.overrideWith(
            (ref) => Future.value(const [
              {'family': 'Cascadia Code', 'path': '/fonts/CascadiaCode.ttf'},
    ...
    expect(find.text('Cascadia Code'), findsOneWidget);
  ...
  testWidgets('search filters fonts by query', (tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          googleFontsProvider.overrideWith(
            (ref) => ['Inter', 'Roboto', 'Poppins'],
          ),
          systemFontsProvider.overrideWith(
            (ref) => Future.value(const <Map<String, String>>[]),
          ),
  ...
  testWidgets('renders google font family names', (tester) async {
    ...
    expect(find.text('Poppins'), findsNWidgets(2));
  });
}
