...
void main() {
  group('ProviderPlanPanel', () {
    ...
    test('only plan providers map to a usage source', () {
      ...
      // Plain `zai` is the metered pay-as-you-go lane: a balance, not a plan,
      // so it has no quota windows to render.
      expect(harnessPlanUsageIds.containsKey('zai'), isFalse);
    });
  });
}
