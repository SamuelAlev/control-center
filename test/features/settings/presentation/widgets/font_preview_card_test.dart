  ...
  group('FontPreviewCard', () {
    testWidgets('renders app font preview', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(const FontPreviewCard(font: font, context: FontContext.app)),
      );
      await tester.pump();
    ...
    testWidgets('renders code font preview', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(const FontPreviewCard(font: font, context: FontContext.code)),
      );
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 200));
    ...
    testWidgets('renders with Google Font source', (tester) async {
      ...
      const font = FontSelection(family: 'Roboto', source: FontSource.google);
      await tester.pumpWidget(
        _wrap(const FontPreviewCard(font: font, context: FontContext.app)),
      );
      await tester.pump();
