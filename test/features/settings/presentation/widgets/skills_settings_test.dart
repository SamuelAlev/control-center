...
void main() {
  ...
  group('SkillsSettings with mocked agents', () {
    ...
    testWidgets('renders editor area when isNew', (tester) async {
      ...
      final newButton = find.widgetWithText(CcButton, 'New');
  ...
  group('SkillsSettings with skill data', () {
    ...
    testWidgets('New button creates editor with cleared form', (tester) async {
      ...
      final newBtn = find.widgetWithText(CcButton, 'New');
      await tester.tap(newBtn);
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 200));
    ...
    testWidgets('save produces success snackbar', (tester) async {
      ...
      // New skill
      await tester.tap(find.widgetWithText(CcButton, 'New'));
      await tester.pump();
      await tester.pump(const Duration(milliseconds: 200));
  ...
  group('SkillsSettings - open folder button', () {
    ...
    testWidgets('open folder button renders for existing skill', (
      tester,
    ) async {
      setView(tester);
      await tester.pumpWidget(
      ...
      expect(find.widgetWithText(CcButton, 'Open folder'), findsOneWidget);
    });
  });
