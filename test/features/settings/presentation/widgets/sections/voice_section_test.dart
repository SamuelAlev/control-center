...
void main() {
  group('VoiceSection', () {
    ...
    group('AudioInputRow', () {
      Widget voiceSectionWithDevices(
        List<InputDevice> devices, {
        String? selectedId,
      }) {
        testControl = _TestVoiceModelControl(
      ...
      testWidgets('shows system default when selected device not in list', (
        ...
        await tester.pumpWidget(
          voiceSectionWithDevices([device], selectedId: 'dev-unknown'),
        );
        await tester.pump();
        await tester.pump();
      ...
      testWidgets('shows recording from device when device selected', (
        ...
        await tester.pumpWidget(
          voiceSectionWithDevices([device], selectedId: 'dev-1'),
        );
        await tester.pump();
        await tester.pump();
