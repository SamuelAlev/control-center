  ...
  group('AppCard', () {
    testWidgets('renders with child', (tester) async {
      await tester.pumpWidget(
        testWrap(const AppCard(child: Text('Card content'))),
      );
    ...
    testWidgets('renders with title', (tester) async {
      await tester.pumpWidget(
        testWrap(const AppCard(title: Text('My Card'), child: Text('Body'))),
      );
    ...
    testWidgets('renders with subtitle', (tester) async {
      await tester.pumpWidget(
        testWrap(
          const AppCard(title: Text('Title'), subtitle: Text('Subtitle text')),
        ),
      );
    ...
    testWidgets('renders raw variant', (tester) async {
      await tester.pumpWidget(
        testWrap(const AppCard(raw: true, child: Text('Raw card'))),
      );
