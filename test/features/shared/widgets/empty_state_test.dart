  ...
  group('EmptyState', () {
    testWidgets('renders message with default icon', (tester) async {
      await tester.pumpWidget(
        testWrap(const EmptyState(message: 'Nothing here yet')),
      );
    ...
    testWidgets('renders with custom icon', (tester) async {
      await tester.pumpWidget(
        testWrap(
          const EmptyState(message: 'No tickets', icon: AppIcons.ticket),
        ),
      );
    ...
    testWidgets('renders with query text', (tester) async {
      await tester.pumpWidget(
        testWrap(const EmptyState(message: 'No results', query: 'search term')),
      );
    ...
    testWidgets('renders with custom icon size', (tester) async {
      await tester.pumpWidget(
        testWrap(const EmptyState(message: 'Empty', iconSize: 64)),
      );
    ...
    testWidgets('renders with all optional fields', (tester) async {
      ...
      expect(
        find.text('Create your first agent to get started.'),
        findsOneWidget,
      );
    ...
    testWidgets('renders with empty description omitted', (tester) async {
      await tester.pumpWidget(
        testWrap(const EmptyState(message: 'Empty', description: '')),
      );
