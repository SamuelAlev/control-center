...
PrInlineCommentsController _createController() {
  final container = ProviderContainer(
    overrides: [
      activeRepoProvider.overrideWith((ref) => null),
      activeWorkspaceProvider.overrideWith((ref) => null),
      // No RPC server here: keep the viewer identity unresolved so creating
      // a comment does not arm the identity retry timer past teardown.
