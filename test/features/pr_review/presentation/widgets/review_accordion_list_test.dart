...
Widget _buildTestApp(
  ...
  return ProviderScope(
    overrides: [
      ...
      channelMessagesProvider.overrideWith((ref, channelId) => streamOverride),
    ],
    child: MaterialApp(
...
ReviewAccordionList _buildWidget({String channelId = 'ch-1', PullRequest? pr}) {
  return ReviewAccordionList(channelId: channelId, pr: pr ?? _pr());
}
