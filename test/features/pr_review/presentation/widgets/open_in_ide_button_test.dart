...
void main() {
  ...
  group('rendering', () {
    testWidgets('renders nothing when no editors are installed', (
      tester,
    ) async {
    ...
    testWidgets('renders split button when editors are installed', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrapWithEditors(
    ...
    testWidgets('shows fallback icon when no bundled logos are loaded', (
      ...
      // back to AppIcons.code for VS Code.
  ...
  group('tap', () {
    testWidgets('tapping main button opens worktree then launches editor', (
      ...
      // is the main button area. The logo falls back to an AppIcons glyph.
  ...
  group('chevrondown icon', () {
    testWidgets('split button renders logo area for installed editor', (
      ...
      // falls back to the AppIcons.code glyph.
      expect(find.byIcon(AppIcons.code), findsOneWidget);
    });
  });
