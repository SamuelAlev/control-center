...
void main() {
  group('ReviewOverlayButton', () {
    testWidgets('renders Review Changes button', (tester) async {
      final pr = _pr();
    ...
    testWidgets('tooltips on action buttons', (tester) async {
      ...
      expect(find.byTooltip('Add GIF'), findsOneWidget);
    });
    ...
    testWidgets('correct tooltip for Write vs Preview button', (tester) async {
      ...
      expect(find.byTooltip('Write'), findsOneWidget);
      expect(find.byTooltip('Preview'), findsNothing);
    });

    testWidgets('overlay title is Approve changes', (tester) async {
      final pr = _pr();
