...
void main() {
  group('ReviewOverlayButton', () {
    ...
    testWidgets('button is an CcButton', (tester) async {
      final pr = _pr();
    ...
    testWidgets('tooltips on action buttons', (tester) async {
      ...
      expect(find.byType(CcTooltip), findsAtLeast(3));
    });
    ...
    testWidgets('CcButton with checkCircle icon in button', (tester) async {
      final pr = _pr();
