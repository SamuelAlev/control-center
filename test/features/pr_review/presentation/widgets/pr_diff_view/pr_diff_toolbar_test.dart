...
void main() {
  group('PrDiffToolbar', () {
    ...
    testWidgets('renders view mode toggle when onSplitViewChanged provided', (tester) async {
      ...
      await tester.pumpAndSettle(const Duration(seconds: 5));
      expect(
        find.byIcon(LucideIcons.alignJustify),
        findsOneWidget,
      );
      expect(
        find.byIcon(LucideIcons.columns),
        findsOneWidget,
      );
    });
    ...
    testWidgets('view mode toggle calls onSplitViewChanged', (tester) async {
      ...
      final splitButton = find.byIcon(LucideIcons.columns);
    ...
    testWidgets('view mode toggle switches back to unified', (tester) async {
      ...
      await tester.tap(find.byIcon(LucideIcons.alignJustify));
