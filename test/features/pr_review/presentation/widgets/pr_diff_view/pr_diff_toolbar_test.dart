  ...
  group('PrDiffToolbar', () {
    ...
    testWidgets('renders toolbar with selected commits', (tester) async {
      final commits = [
        ...
        _commit(
          sha: 'ccc33333333333333333333333333333333333333',
          message: 'Third',
        ),
      ];
    ...
    testWidgets('renders toolbar with inline comments controller', (
      ...
      final controller = PrInlineCommentsController((workspaceId: 'ws', repoFullName: 'owner/repo', number: 1));
    ...
    testWidgets('renders view mode toggle when onSplitViewChanged provided', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
      ...
      await tester.pumpAndSettle(const Duration(seconds: 5));
      expect(find.byIcon(AppIcons.alignJustify), findsOneWidget);
    ...
    testWidgets('view mode toggle calls onSplitViewChanged', (tester) async {
      ...
      final splitButton = find.byIcon(AppIcons.columns);
    ...
    testWidgets('toolbar without commits does not show commit selector', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('renders commit selector tooltip text', (tester) async {
      ...
      // The commit selector has an CcTooltip (not Material Tooltip).
