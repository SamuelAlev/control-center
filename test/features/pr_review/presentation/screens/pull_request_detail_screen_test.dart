...
void main() {
  ...
  group('PullRequestDetailScreen', () {
        ...
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              ...
              child: const PullRequestDetailScreen(prNumber: 42),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 99),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 999),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...baseOverrides(),
              prDetailProvider(42).overrideWithValue(
                AsyncValue.error(Exception('rate limit exceeded'), StackTrace.empty),
              ),
          ],
          child: _wrap(
            CcTheme(
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 55),
            ),
          ),
        ),
      );
    ...
    testWidgets('renders merged PR without crashing', (tester) async {
      ...
      final pr = _makePr(number: 77, title: 'Merged PR', state: PrState.merged, mergedAt: DateTime(2024, 5, 1));
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 77),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 88),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 555),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 404),
            ),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: _wrap(
            CcTheme(
              data: CcThemeData.light(),
              child: const PullRequestDetailScreen(prNumber: 7),
            ),
          ),
        ),
      );
