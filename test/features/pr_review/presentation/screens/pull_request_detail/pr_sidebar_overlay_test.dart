...
Widget _wrap(Widget child) {
  return ProviderScope(
    overrides: [
      ...
      prReviewsProvider(42).overrideWith((ref) => Stream.value(const <PrReviewSubmission>[])),
      prCheckRunsProvider(42).overrideWith((ref) => Stream.value(const <CheckRun>[])),
      shipShowAskProvider(42).overrideWith((ref) => const AsyncValue.data(null)),
    ],
    child: MaterialApp(
