...
void main() {
  group('ReviewDisagreement', () {
    ...
    test(
      'equality based on nodeA, nodeB, description',
      timeout: const Timeout.factor(2),
      () {
        final nodeA = _makeReviewNode(
          senderId: 'a',
          metadata: {'nodeType': 'bug', 'priority': 'p0', 'confidence': 0.9},
        );
        final nodeB = _makeReviewNode(
          senderId: 'b',
          metadata: {
        ...
        final d1 = ReviewDisagreement(
          nodeA: nodeA,
          nodeB: nodeB,
          description: 'desc',
        );
        final d2 = ReviewDisagreement(
          nodeA: nodeA,
          nodeB: nodeB,
          description: 'desc',
        );
    ...
    test(
      'not equal when description differs',
      timeout: const Timeout.factor(2),
      () {
        final nodeA = _makeReviewNode(
          senderId: 'a',
    ...
    group('anchor getter', () {
      test(
        'returns file:line when both present',
        timeout: const Timeout.factor(2),
        () {
          final nodeA = _makeReviewNode(
            senderId: 'a',
      ...
      test(
        'returns file only when no line',
        timeout: const Timeout.factor(2),
        () {
          final nodeA = _makeReviewNode(
            senderId: 'a',
      ...
      test(
        'returns "general finding" when no anchor',
        timeout: const Timeout.factor(2),
        () {
          final nodeA = _makeReviewNode(
            senderId: 'a',
      ...
      test(
        'returns "general finding" when anchor has no filePath',
        timeout: const Timeout.factor(2),
        () {
          final nodeA = _makeReviewNode(
            senderId: 'a',
  ...
  group('detectDisagreements', () {
    test(
      'detects priority gap >= 2 on same file+line from different agents',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'detects bug vs suggestion conflict on same anchor',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'ignores non-reviewNode messages',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          Message(
    ...
    test(
      'ignores findings with no anchor',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'ignores same priority + same kind (no conflict)',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'priority gap of exactly 1 does not trigger',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'overlapping line ranges are treated as same anchor',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'handles multiple disagreements',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
    ...
    test(
      'ignores payloads with invalid priority',
      timeout: const Timeout.factor(2),
      () {
        final messages = [
          _makeReviewNode(
