...
void main() {
  ...
  group('ReviewVerdict == and hashCode', () {
    ...
    test(
      'not equal when overall differs',
      timeout: const Timeout.factor(2),
      () {
        const b = ReviewVerdict(
    ...
    test(
      'not equal when confidence differs',
      timeout: const Timeout.factor(2),
      () {
        const b = ReviewVerdict(
          overall: ReviewVerdictOverall.ship,
    ...
    test(
      'not equal when explanation differs',
      timeout: const Timeout.factor(2),
      () {
        const b = ReviewVerdict(
          overall: ReviewVerdictOverall.ship,
  ...
  group('ReviewVerdict.fromMetadata', () {
    ...
    test(
      'returns null when verdict key is missing',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'returns null for unrecognized verdict string',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'returns null for non-string verdict',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'defaults confidence to 1.0 when missing or invalid',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'defaults confidence to 1.0 when out of range',
      timeout: const Timeout.factor(2),
      () {
        final verdict = ReviewVerdict.fromMetadata({
          'verdict': 'ship',
    ...
    test(
      'defaults confidence to 1.0 when negative',
      timeout: const Timeout.factor(2),
      () {
        final verdict = ReviewVerdict.fromMetadata({
          'verdict': 'ship',
    ...
    test(
      'defaults explanation to empty string when missing',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'defaults counts to all zeros when missing',
      timeout: const Timeout.factor(2),
      () {
        final verdict = ReviewVerdict.fromMetadata({'verdict': 'ship'})!;
        expect(verdict.p0Count, 0);
    ...
    test(
      'handles partial priorityCounts',
      timeout: const Timeout.factor(2),
      () {
        final verdict = ReviewVerdict.fromMetadata({
          'verdict': 'ship',
  ...
  group('ReviewVerdict round-trip', () {
    test(
      'toMetadata → fromMetadata preserves verdict',
      timeout: const Timeout.factor(2),
      () {
        const original = ReviewVerdict(
          ...
          counts: {
            ReviewNodePriority.p0: 0,
            ReviewNodePriority.p1: 1,
            ReviewNodePriority.p2: 3,
            ReviewNodePriority.p3: 5,
          },
        );
