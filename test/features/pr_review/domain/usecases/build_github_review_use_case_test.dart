...
void main() {
  ...
  group('anchoring', () {
    test('finding with file + line becomes a single-line inline comment', () {
      ...
      // The published review names severities, not the app's internal P0-P3
      // scale — p1 renders as Major.
      expect(c.body, contains('Major'));
    ...
    test('body always carries the verdict banner', () {
      ...
      // Same counts, named for the surface that reads them.
      expect(plan.body, contains('Critical: 2'));
    });
  });
