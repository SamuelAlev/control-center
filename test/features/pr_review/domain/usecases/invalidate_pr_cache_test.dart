...
import 'package:control_center/features/pr_review/domain/usecases/invalidate_pr_cache.dart';
...
void main() {
  group('InvalidatePrCacheUseCase', () {
    ...
    test('delegates to repository.invalidatePullRequest with correct PR number',
        () async {
