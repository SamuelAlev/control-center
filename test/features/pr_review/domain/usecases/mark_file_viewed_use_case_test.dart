...
class FakePrReviewRepository implements PrReviewRepository {
  ...
  Stream<List<PrTimelineEvent>> watchTimelineEvents(int prNumber) =>
      throw UnimplementedError('watchTimelineEvents');
  ...
  Future<JobRunDetail?> getJobRunDetail(int jobId) =>
      throw UnimplementedError('getJobRunDetail');

  @override
  Future<WorkflowGraph?> getWorkflowGraph(int workflowRunId) =>
      throw UnimplementedError('getWorkflowGraph');
  ...
  Future<void> toggleReviewReaction({
    ...
    required bool add,
    String? currentUserLogin,
  }) => throw UnimplementedError('toggleReviewReaction');
  ...
  }) => throw UnimplementedError('setReviewThreadResolved');
  ...
  Future<List<PrUser>> listSuggestedReviewers(int prNumber) =>
      throw UnimplementedError('listSuggestedReviewers');
}
...
void main() {
  group('MarkFileViewedUseCase', () {
    ...
    test(
      'delegates to repository.markFileAsViewed with correct params',
      () async {
        ...
        expect(repo.markFileViewedCalls.first['externalId'], 'node-abc');
