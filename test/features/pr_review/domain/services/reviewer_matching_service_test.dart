...
void main() {
  group('ReviewerMatchingService', () {
    ...
    test(
      'matches agent by skill (highest weight)',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
    ...
    test(
      'matches agent by title (weight 2)',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
    ...
    test(
      'matches agent by name (weight 1)',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
    ...
    test(
      'role matching is case-insensitive on input',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
    ...
    test(
      'returns highest scoring agent among multiple',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
          _makeAgent(
    ...
    test(
      'accumulates multiple skill matches',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
          _makeAgent(
            ...
            name: 'X',
            title: 'Generic',
            skills: ['flutter-ui', 'flutter-state'],
          ),
    ...
    test(
      'returns first agent when scores are equal',
      timeout: const Timeout.factor(2),
      () {
        final candidates = [
