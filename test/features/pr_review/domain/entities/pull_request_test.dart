...
void main() {
  ...
  group('PullRequest constructor', () {
    ...
    test('throws ArgumentError for number <= 0', () {
      expect(
        () => PullRequest(
          id: 1,
          number: 0,
  ...
  group('PullRequest computed properties', () {
    ...
    test('isPriority returns true when only a team is requested', () {
      final pr = createPr(requestedTeamSlugs: const ['frontend-platform']);
      expect(pr.isPriority, isTrue);
    });
  });
