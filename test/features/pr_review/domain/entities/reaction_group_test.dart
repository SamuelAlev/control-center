...
void main() {
  group('ReactionGroup constructor', () {
    ...
    test(
      'usernames defaults to empty list',
  ...
  group('ReactionGroup.emojiForContent', () {
    test(
      'returns emoji for known content',
      timeout: const Timeout.factor(2),
      () {
    ...
    test(
      'returns empty string for unknown content',
      timeout: const Timeout.factor(2),
      () {
  ...
  group('ReactionGroup.supportedReactions', () {
    ...
    test(
      'each reaction has content and emoji',
      timeout: const Timeout.factor(2),
      () {
  ...
  group('ReactionGroup == and hashCode', () {
    ...
    test(
      'not equal when content differs',
      timeout: const Timeout.factor(2),
      () {
        const b = ReactionGroup(
          content: '-1',
    ...
    test(
      'not equal when userReacted differs',
      timeout: const Timeout.factor(2),
      () {
        const b = ReactionGroup(
          content: '+1',
    ...
    test(
      'not equal when usernames differ',
      timeout: const Timeout.factor(2),
      () {
        const b = ReactionGroup(
          content: '+1',
    ...
    test(
      'not equal when usernames order differs',
      timeout: const Timeout.factor(2),
      () {
        const b = ReactionGroup(
          content: '+1',
