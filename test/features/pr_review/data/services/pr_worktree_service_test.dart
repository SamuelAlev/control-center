...
class _FakeFs extends Fake implements WorkspaceFilesystemPort {
  ...
  final String root;
  @override
  Future<String> workspaceDir(String workspaceId) async => '$root/$workspaceId';
}
...
void main() {
  group('PrWorktreeService', () {
    ...
    test('provisions a CoW worktree at the PR head and registers it', () async {
      ...
      expect(registry.rows.single.spaceId, 'pr:octocat/hello#42');
    ...
    test(
      'falls back to pr-<n> as the branch when the head ref is empty',
      () async {
    ...
    test(
      'reuses an existing on-disk worktree without re-provisioning',
      () async {
