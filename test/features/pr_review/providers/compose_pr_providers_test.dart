...
/// Records the arguments passed to [publishToForge] so the test can assert the
...
void main() {
  ...
  test(
    'submit forwards branches, assignees and reviewers, draft=false',
    () async {
      ...
      notifier.setAssignees(const [PrUser(login: 'alice', avatarUrl: '')]);
