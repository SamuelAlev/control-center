...
void main() {
  ...
  SpaceParticipant createParticipant({
    String id = 'cp-1',
    String spaceId = 'ch-1',
  ...
  group('SpaceParticipant constructor', () {
    ...
    test('throws ArgumentError for empty principalId', () {
      expect(
        () => SpaceParticipant(
          id: '1',
          spaceId: 'ch-1',
  ...
  group('SpaceParticipant computed properties', () {
  ...
  group('SpaceParticipant == and hashCode', () {
    ...
    test('different spaceId makes unequal', () {
      final a = createParticipant(spaceId: 'ch-1');
      final b = createParticipant(spaceId: 'ch-2');
      expect(a, isNot(equals(b)));
    });
  ...
  group('SpaceParticipant copyWith', () {
