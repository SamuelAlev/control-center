...
void main() {
  ...
  group('BuildAgentPromptUseCase', () {
    ...
    test(
      'wraps prompt in context when agent has no systemPrompt or persona',
      () {
    ...
    test('prompt appears at the end when sections are present', () {
      ...
      expect(
        result.indexOf('Do this') > result.indexOf('You are helpful.'),
        isTrue,
      );
    });
