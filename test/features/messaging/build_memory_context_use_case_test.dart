...
void main() {
  group('BuildMemoryContextUseCase', () {
    ...
    test(
      'does not eagerly inject durable facts (lazy via search_memory)',
      () async {
        final useCase = BuildMemoryContextUseCase(
          policyRepository: _FakePolicyRepository(),
          workingMemoryRepository: _FakeWorkingMemoryRepository(_notes('note')),
        );
