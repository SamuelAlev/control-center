...
void main() {
  ...
  test(
    ...
    () async {
      ...
      final sub = watchChannelTurnFrames(registry, 'c1').listen(frames.add);
      await settle();
      ...
      final sub2 = watchChannelTurnFrames(registry, 'c1').listen(frames2.add);
      await settle();
  ...
  test(
    ...
    () async {
      ...
      final frames = <Map<String, dynamic>>[];
      final sub = watchChannelTurnFrames(
        registry,
        'c1',
