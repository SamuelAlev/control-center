...
void main() {
  ...
  testWidgets('renders transcript timeline summary when segments present',
      (tester) async {
        ...
        'segments': [
          {
            ...
            'ts': DateTime(2026).millisecondsSinceEpoch,
            'durationMs': 4000,
          },
          {
            'type': 'tool',
            ...
            'toolCallId': 't1',
            'status': 'ok',
            'ts': DateTime(2026).add(const Duration(seconds: 4)).millisecondsSinceEpoch,
            'durationMs': 2000,
          },
        ],
      },
  ...
  testWidgets('renders agent turn with no process segments', (tester) async {
