...
void main() {
  ...
  group('overflow', () {
    testWidgets('folds the trailing cells away when the sidebar narrows', (
      ...
      // 200px is the sidebar's minimum: 30px of caret leaves room for five
      // 34px cells, so the sixth view has to fold.
    ...
    testWidgets('keeps the active view visible even past the fold', (
      ...
      await pump(tester, width: 200, selected: IdeSidebarView.artifacts);
