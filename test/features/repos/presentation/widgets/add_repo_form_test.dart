        ...
        ProviderScope(
          ...
          child: CcTheme(
            ...
            child: MaterialApp(
              ...
              home: Scaffold(
                body: AddRepoForm(workspaceId: 'ws-1', onCreated: (_) {}),
              ),
            ),
          ),
        ),
        ...
        ProviderScope(
          ...
          child: CcTheme(
            ...
            child: MaterialApp(
                localizationsDelegates: AppLocalizations.localizationsDelegates,
                supportedLocales: AppLocalizations.supportedLocales,
              home: Scaffold(body: AddRepoForm(workspaceId: 'ws-1', onCreated: (_) {})),
            ),
          ),
        ),
      );
              ...
              home: Scaffold(
                body: Consumer(
                  builder: (context, ref, _) => CcButton(
                    onPressed: () => showAddRepoDialog(context, ref, 'ws-1'),
            ...
            child: MaterialApp(
              ...
              home: Scaffold(
                body: Consumer(
                  builder: (context, ref, _) => CcButton(
                    onPressed: () async {
                      result = await showAddRepoDialog(context, ref, 'ws-1');
                    },
                    child: const Text('Open dialog'),
                  ),
                ),
