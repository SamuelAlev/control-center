...
void main() {
  ...
  group('CodeEdge', () {
    group('constructor', () {
      test(
        'creates edge with resolved target',
      ...
      test(
        'creates edge with targetName only',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'asserts sourceSymbolId is not empty',
        timeout: const Timeout.factor(2),
        () {
          expect(
            () => CodeEdge(
      ...
      test(
        'asserts either targetSymbolId or targetName is provided',
        timeout: const Timeout.factor(2),
        () {
          expect(
            () => CodeEdge(
    ...
    group('isResolved', () {
      test(
        'returns true when targetSymbolId is set',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'returns false when targetSymbolId is null',
        timeout: const Timeout.factor(2),
        () {
    ...
    group('== and hashCode', () {
      ...
      test(
        '== returns false for different targetSymbolId',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different metadata',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'hashCode matches for equal edges',
        timeout: const Timeout.factor(2),
        () {
          final e1 = createEdge();
          final e2 = createEdge();
      ...
      test(
        'hashCode differs for different edges',
        timeout: const Timeout.factor(2),
        () {
          final e1 = createEdge(id: 'e1');
          final e2 = createEdge(id: 'e2');
