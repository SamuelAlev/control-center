...
void main() {
  ...
  group('CodeSubgraph', () {
    group('constructor', () {
      test(
        'creates subgraph with all fields',
      ...
      test(
        'creates subgraph with null root',
        timeout: const Timeout.factor(2),
        () {
    ...
    group('isEmpty', () {
      ...
      test(
        'returns false when nodes is non-empty',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'empty constructor yields isEmpty true',
        timeout: const Timeout.factor(2),
        () {
          const sg = CodeSubgraph.empty();
          expect(sg.isEmpty, isTrue);
    ...
    group('== and hashCode', () {
      ...
      test(
        '== returns false for different root',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different depthById',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'hashCode matches for equal subgraphs',
        timeout: const Timeout.factor(2),
        () {
          final sg1 = CodeSubgraph(
            root: root,
