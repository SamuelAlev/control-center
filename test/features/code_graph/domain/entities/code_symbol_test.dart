...
void main() {
  ...
  group('CodeSymbol', () {
    group('constructor', () {
      test(
        'creates symbol with all fields',
      ...
      test(
        'creates symbol with optional fields',
        timeout: const Timeout.factor(2),
        () {
          final s = createSymbol(
      ...
      test('rejects an empty id', timeout: const Timeout.factor(2), () {
        expect(() => createSymbol(id: ''), throwsA(isA<ArgumentError>()));
      });

      test(
        'asserts workspaceId is not empty',
        timeout: const Timeout.factor(2),
        () {
          expect(
      ...
      test('rejects an empty repoId', timeout: const Timeout.factor(2), () {
        expect(() => createSymbol(repoId: ''), throwsA(isA<ArgumentError>()));
      });

      test(
        'asserts qualifiedName is not empty',
        timeout: const Timeout.factor(2),
        () {
          expect(
    ...
    group('copyWith', () {
      test(
        'returns identical symbol with no arguments',
        timeout: const Timeout.factor(2),
        () {
          final s = createSymbol();
      ...
      test(
        'updates docstring and parentName',
        timeout: const Timeout.factor(2),
        () {
          final s = createSymbol();
    ...
    group('== and hashCode', () {
      ...
      test(
        '== returns false for different kind',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different name',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different docstring',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        '== returns false for different parentName',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'hashCode matches for equal symbols',
        timeout: const Timeout.factor(2),
        () {
          final s1 = createSymbol();
          final s2 = createSymbol();
      ...
      test(
        'hashCode differs for different symbols',
        timeout: const Timeout.factor(2),
        () {
          final s1 = createSymbol(id: 'sym-1');
          final s2 = createSymbol(id: 'sym-2');
