  ...
  group('MeetingLevelMeter', () {
    testWidgets('renders when active', (tester) async {
      await tester.pumpWidget(
        testWrap(const MeetingLevelMeter(active: true, color: Colors.orange)),
      );
    ...
    testWidgets('renders when inactive', (tester) async {
      await tester.pumpWidget(
        testWrap(const MeetingLevelMeter(active: false, color: Colors.blue)),
      );
    ...
    testWidgets('renders custom bar count', (tester) async {
      await tester.pumpWidget(
        testWrap(
          const MeetingLevelMeter(active: true, color: Colors.red, barCount: 3),
        ),
      );
