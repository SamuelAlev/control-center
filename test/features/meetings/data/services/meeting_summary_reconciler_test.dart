...
void main() {
  ...
  group('_onEvent filtering', () {
    ...
    test('ignores events for wrong templateId', () async {
      ...
      runRepo.addRun(_pipelineRun(triggerPayload: {'meetingId': meeting.id}));
    ...
    test('ignores events where triggerPayload has no meetingId', () async {
      runRepo.addRun(_pipelineRun(triggerPayload: {'otherKey': 'otherValue'}));
    ...
    test('ignores events where meeting not found', () async {
      ...
      runRepo.addRun(
        _pipelineRun(triggerPayload: {'meetingId': 'nonexistent'}),
      );
