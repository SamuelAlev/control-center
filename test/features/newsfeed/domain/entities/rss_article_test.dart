...
void main() {
  ...
  group('RssArticle', () {
    group('constructor', () {
      test(
        'creates article with all fields',
      ...
      test(
        'creates article with publishedAt',
        timeout: const Timeout.factor(2),
        () {
      ...
      test(
        'defaults summary, imageUrl and author to empty strings',
        timeout: const Timeout.factor(2),
        () {
          final a = RssArticle(
            id: 'a',
      ...
      test('rejects an empty feedId', timeout: const Timeout.factor(2), () {
        expect(
          () => RssArticle(
            id: 'a',
            feedId: '',
      ...
      test('rejects an empty title', timeout: const Timeout.factor(2), () {
        expect(
          () => RssArticle(
            id: 'a',
            feedId: 'f',
      ...
      test('rejects an empty link', timeout: const Timeout.factor(2), () {
        expect(
          () => RssArticle(
            id: 'a',
            feedId: 'f',
    ...
    group('effectivePublishedAt', () {
      ...
      test(
        'returns createdAt when publishedAt is null',
        timeout: const Timeout.factor(2),
        () {
          final a = createArticle();
    ...
    group('== and hashCode', () {
      ...
      test(
        'hashCode matches for equal articles',
        timeout: const Timeout.factor(2),
        () {
          final a1 = createArticle();
      ...
      test(
        'hashCode differs for different articles',
        timeout: const Timeout.factor(2),
        () {
          final a1 = createArticle(id: 'art-1');
          final a2 = createArticle(id: 'art-2');
