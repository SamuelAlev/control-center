...
void main() {
  group('FilterListUpdateState', () {
    ...
    group('copyWith', () {
      ...
      test('overrides individual fields', timeout: const Timeout.factor(2), () {
        final state = FilterListUpdateState(
          lastCheck: now,
          lastSuccess: later,
          isUpdating: true,
      ...
      test('overrides multiple fields', timeout: const Timeout.factor(2), () {
        final state = FilterListUpdateState(
          lastCheck: now,
          lastSuccess: later,
          isUpdating: true,
    ...
    group('equality', () {
      test('same values are equal', timeout: const Timeout.factor(2), () {
