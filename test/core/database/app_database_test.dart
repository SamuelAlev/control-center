...
void main() {
  group('AppDatabase.forTesting', () {
    ...
    test(
        'schema version is 10 (baseline + meetings + calendar + diarization + '
        'calendar reauth flag + orchestration/enterprise migration + '
        'meeting title-is-custom + manual action items/decisions)', () {
      final db = createTestDatabase();
