...
void main() {
  // Relative to the package root (the test cwd): where build_aec.sh installs it.
  const candidates = [
    'macos/Frameworks/libaec_ffi.dylib',
    'build/natives/libaec_ffi.dylib',
    'macos/Frameworks/libaec_ffi.so',
    'build/natives/libaec_ffi.so',
  ];
