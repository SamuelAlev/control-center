...
void main() {
  group('SystemFontService', () {
    ...
    test(
      'getInstalledFonts returns empty list when channel returns null',
      () async {
        TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
            .setMockMethodCallHandler(channel, (MethodCall call) async {
              if (call.method == 'getSystemFonts') {
    ...
    test(
      'getInstalledFonts returns empty list when channel returns empty',
      () async {
        TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
            .setMockMethodCallHandler(channel, (MethodCall call) async {
              if (call.method == 'getSystemFonts') {
    ...
    test(
      'getInstalledFonts handles MissingPluginException gracefully',
      () async {
        TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
            .setMockMethodCallHandler(channel, (MethodCall call) async {
    ...
    test(
      'getInstalledFonts handles entries with missing family/path',
      () async {
        TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
            .setMockMethodCallHandler(channel, (MethodCall call) async {
              if (call.method == 'getSystemFonts') {
