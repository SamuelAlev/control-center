...
void main() {
  ...
  group('FontSettings', () {
    test('creates with defaults', () {
      ...
      expect(settings.appFontSelection.family, 'Manrope');
      expect(settings.codeFontSelection.family, 'JetBrains Mono');
    });
    ...
    test('copyWith modifies app font', () {
      ...
      expect(modified.codeFontSelection.family, 'JetBrains Mono');
    });
    ...
    test('copyWith modifies code font', () {
      ...
      expect(modified.appFontSelection.family, 'Manrope');
