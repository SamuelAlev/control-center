...
void main() {
  ...
  group('fromName', () {
    test('returns correct sound for "ping"', () {
      expect(
        NotificationSound.fromName('ping'),
        equals(NotificationSound.ping),
      );
    });

    test('returns correct sound for "chime"', () {
      expect(
        NotificationSound.fromName('chime'),
        equals(NotificationSound.chime),
      );
    });

    test('returns correct sound for "none"', () {
      expect(
        NotificationSound.fromName('none'),
        equals(NotificationSound.none),
      );
    });

    test('returns correct sound for "migros-soft"', () {
      expect(
        NotificationSound.fromName('migros-soft'),
        equals(NotificationSound.migrosSoft),
      );
    });
    ...
    test('returns correct sound for "post"', () {
      expect(
        NotificationSound.fromName('post'),
        equals(NotificationSound.post),
      );
    });
    ...
    test('returns ping for unknown name', () {
      expect(
        NotificationSound.fromName('unknown-sound'),
        equals(NotificationSound.ping),
      );
    });
