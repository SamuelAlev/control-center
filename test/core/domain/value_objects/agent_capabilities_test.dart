  ...
  group('AgentCapabilities', () {
    ...
    group('fromJson', () {
      ...
      test('reads legacy canCallLinear key for canCallTicketing', () {
        final caps = AgentCapabilities.fromJson(const {'canCallLinear': true});
    ...
    group('fromJsonString', () {
      test('parses valid JSON', () {
        const raw =
            '{"canPushToRepo":true,"canCallGitHubApi":false,'
    ...
    test('toJsonString round-trips through fromJsonString', () {
      ...
      final roundTripped = AgentCapabilities.fromJsonString(
        caps.toJsonString(),
      );
      expect(roundTripped, caps);
    });
