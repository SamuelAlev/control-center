  ...
  group('WakeContext', () {
    ...
    group('toEnvironment', () {
      ...
      test('omits null optional fields from map', () {
        ...
        expect(env.containsKey('CC_SPACE_ID'), isFalse);
    ...
    group('== and hashCode', () {
      ...
      test('not equal when spaceId differs', () {
        final a = makeSubject(spaceId: 'c1');
        final b = makeSubject(spaceId: null);
