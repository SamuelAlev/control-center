...
void main() {
  ...
  group('SandboxSpec', () {
    test(
      'defaults: networkEnabled=true, egressAllowlist=[], mode=chat, agentId=null, guestWorkdir=null',
      () {
