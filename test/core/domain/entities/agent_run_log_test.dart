...
void main() {
  ...
  group('AgentRunLog', () {
    group('constructor', () {
      ...
      test('constructor rejects agentId is not empty', () {
        expect(
          () => AgentRunLog(
            id: 'log-x',
            agentId: '',
    ...
    group('== and hashCode', () {
      ...
      test('== returns false for different id', () {
        expect(createLog(id: 'a') == createLog(id: 'b'), isFalse);
      });

      test('== returns false for different agentId', () {
        expect(createLog(agentId: 'a') == createLog(agentId: 'b'), isFalse);
      });
      ...
      test('== returns false for different completedAt', () {
        expect(
          createLog(completedAt: null) ==
              createLog(completedAt: testCompletedAt),
          isFalse,
        );
      });
      ...
      test('== returns false for different summary', () {
        expect(createLog(summary: 'a') == createLog(summary: 'b'), isFalse);
      });

      test('== returns false for different adapter', () {
        expect(createLog(adapter: 'a') == createLog(adapter: 'b'), isFalse);
      });

      test('== returns false for different pid', () {
        expect(createLog(pid: 1234) == createLog(pid: 5678), isFalse);
      });
