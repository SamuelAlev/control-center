...
void main() {
  ...
  group('MemoryFact', () {
    ...
    test('constructor rejects workspaceId not empty', () {
      expect(
        () => MemoryFact(
          id: 'f-1',
          workspaceId: '',
    ...
    test('constructor rejects topic not empty', () {
      expect(
        () => MemoryFact(
          id: 'f-1',
          workspaceId: 'ws-1',
    ...
    test('constructor rejects confidence range', () {
      expect(
        () => MemoryFact(
          id: 'f-1',
          workspaceId: 'ws-1',
    ...
    test('copyWith replaces fields', () {
      ...
      final updated = fact.copyWith(content: 'new', supersededBy: 'f-2');
