  ...
  group('IsolatedRepo', () {
    ...
    group('== and hashCode', () {
      ...
      test('== returns false for different spaceId', () {
        final a = createRepo(spaceId: 'ch-1');
        final b = createRepo(spaceId: 'ch-2');
        expect(a, isNot(equals(b)));
      });
    ...
    group('copyWith', () {
      ...
      test('updates spaceId', () {
        final repo = createRepo();
        final copy = repo.copyWith(spaceId: 'ch-2');
        expect(copy.spaceId, 'ch-2');
      });
