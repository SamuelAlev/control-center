...
void main() {
  ...
  group('Agent', () {
    group('constructor', () {
      ...
      test('constructor rejects title is not empty', () {
        expect(
          () => Agent(
            id: 'a',
            name: 'test',
    ...
    group('getters', () {
      ...
      test('hasSkill delegates to skills.hasSkill', () {
        final agent = createAgent(skills: AgentSkills(['coding', 'testing']));
      ...
      test('hasSkill is case-insensitive', () {
        final agent = createAgent(skills: AgentSkills(['CodeReview']));
    ...
    group('== and hashCode', () {
      ...
      test('== returns false for different id', () {
        expect(createAgent(id: 'a') == createAgent(id: 'b'), isFalse);
      });

      test('== returns false for different name', () {
        expect(createAgent(name: 'a') == createAgent(name: 'b'), isFalse);
      });

      test('== returns false for different title', () {
        expect(createAgent(title: 'A') == createAgent(title: 'B'), isFalse);
      });

      test('== returns false for different agentMdPath', () {
        expect(
          createAgent(agentMdPath: '/a.md') ==
              createAgent(agentMdPath: '/b.md'),
          isFalse,
        );
      });
      ...
      test('== returns false for different persona', () {
        expect(createAgent(persona: 'a') == createAgent(persona: 'b'), isFalse);
      });
      ...
      test('== returns false for different modelId', () {
        expect(createAgent(modelId: 'a') == createAgent(modelId: 'b'), isFalse);
      });
