...
void main() {
  ...
  group('WhenClause operators', () {
    ...
    test('equality with quoted value', () {
      expect(eval("route == '/inbox'", {'route': '/inbox'}), isTrue);
      expect(eval("route == '/inbox'", {'route': '/inbox/1'}), isFalse);
      expect(eval("route == '/inbox'", const {}), isFalse);
    });
  ...
  group('WhenClause precedence & grouping', () {
    ...
    test('parentheses override precedence', () {
      expect(
        eval('(a || b) && c', {'a': true, 'b': false, 'c': false}),
        isFalse,
      );
