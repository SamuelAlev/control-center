...
void main() {
  ...
  group('registry dead-on-web bindings are the known set', () {
    ...
    final expected = <String>{
      // ⌘1–⌘9 primary navigation.
      'nav.inbox', 'nav.tickets', 'nav.pull-requests', 'nav.pipelines',
      'nav.agents', 'nav.memory', 'nav.newsfeed',
      'nav.meetings',
      ...
      // ⌘N new channel, ⌘T IDE new tab, ⌘W IDE close tab.
      'msg.new-channel', 'msg.ide-new-tab', 'msg.ide-close-tab',
