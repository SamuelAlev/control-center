...
void main() {
  group('GitHubReactionSummary', () {
    ...
    test('fromJson handles null values', timeout: const Timeout.factor(2), () {
      final json = <String, dynamic>{
        'total_count': null,
        '+1': null,
        '-1': null,
  ...
  group('GitHubReaction', () {
    ...
    test('fromJson handles null user', timeout: const Timeout.factor(2), () {
      final json = <String, dynamic>{'id': 10, 'content': '+1', 'user': null};
      final reaction = GitHubReaction.fromJson(json);
    ...
    test('holds all valid content types', timeout: const Timeout.factor(2), () {
      const contents = [
        '+1',
        '-1',
        'laugh',
