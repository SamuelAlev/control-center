...
void main() {
  group('GitHubPullRequest', () {
    final baseJson = <String, dynamic>{
      ...
      'external_id': 'PR_kw123',
      'created_at': '2024-01-15T10:00:00Z',
      'updated_at': '2024-01-16T12:00:00Z',
      'merged_at': null,
      'head': <String, dynamic>{'sha': 'abc123def456', 'ref': 'feature/x'},
      'base': <String, dynamic>{'ref': 'main', 'sha': 'base789sha'},
    ...
    test('toJson round-trip with all fields', () {
      ...
      expect(restored.externalId, pr.externalId);
