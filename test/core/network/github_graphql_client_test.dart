...
void main() {
    ...
    test('wraps other DioExceptions', () async {
      fakeDio.onPost =
          <T>(
            ...
            onSendProgress,
            onReceiveProgress,
          }) => throw DioException(requestOptions: ro(), message: '500');
  ...
  group('searchReviewedByPullRequests', () {
    test(
      'builds a reviewed-by search and returns (repo, number) pairs',
      () async {
