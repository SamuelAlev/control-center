...
void main() {
  ...
  group('app_router route paths', () {
    ...
    test('channelsRoute is /workspaces/w1/channels', () {
      expect(channelsRoute('w1'), '/workspaces/w1/channels');
    });

    test('channelRoute is /workspaces/w1/channels/c1', () {
      expect(channelRoute('w1', 'c1'), '/workspaces/w1/channels/c1');
    });
