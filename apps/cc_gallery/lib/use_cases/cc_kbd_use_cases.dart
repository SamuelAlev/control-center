...
@widgetbook.UseCase(name: 'Group & shortcut hint', type: CcKbd, path: _path)
Widget ccKbdGroupUseCase(BuildContext context) {
  return const Center(
    child: Column(
...
Widget ccKbdPlaygroundUseCase(BuildContext context) {
  final label = context.knobs.string(label: 'Key label', initialValue: '⌘K');
