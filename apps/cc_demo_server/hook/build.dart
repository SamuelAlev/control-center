...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    if (emitted == 0) {
      ...
      stdout.writeln(
        'cc_demo_server hook: bundling $emitted native libraries from '
        '${stagingDir.path}',
      );
    }
  });
...
void _reportMissing(String repoRoot, String what) {
  ...
  if (_allowMissing(repoRoot)) {
    stderr.writeln('cc_demo_server hook: $what — $remedy');
    return;
  }
  throw StateError('cc_demo_server hook: $what — $remedy');
}
